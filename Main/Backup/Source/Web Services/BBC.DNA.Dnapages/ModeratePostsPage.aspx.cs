...
public partial class ModeratePostsPage : BBC.Dna.Page.DnaWebPage
{
    /// <summary>
    /// Constructor for the Search For Users Page
    /// </summary>
    public ModeratePostsPage()
    {
    }
    ...
    public override void OnPageLoad()
    {
        ...
        AddComponent(new ModeratePosts(_basePage));

        AddComponent(new RefereeList(_basePage));

        AddComponent(new ModerationClasses(_basePage));

        AddComponent(new ModerationUserStatuses(_basePage));

        //AddComponent(new ModerationReasons(_basePage));

        //AddComponent(new ModerationDistressMessages(_basePage));
