...
options.header =
	...
	'{\n' +
	indents(1) + '[TestClass]\n' +
	indents(1) + 'public class ${className}: SeleniumTestHarness\n' +
	indents(1) + '{\n' +
	...
	indents(2) + '{\n' +
	indents(3) + 'base.StartServer();\n' +
	indents(3) + '${receiver} = new DefaultSelenium("${rcHost}", ${rcPort}, "${environment}", ConfigurationManager.AppSettings["baseUrl"]);\n' +
