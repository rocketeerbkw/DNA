<%@ Page language="c#" Inherits="DynamicListAdmin" Codebehind="DynamicListAdmin.aspx.cs" %>
...
<HTML>
  <HEAD>
	...
	<body>
		<form id="Form1" method="post" runat="server">&nbsp;<asp:label id="lblTitle" style="Z-INDEX: 100; LEFT: 24px; POSITION: absolute; TOP: 72px" runat="server"
