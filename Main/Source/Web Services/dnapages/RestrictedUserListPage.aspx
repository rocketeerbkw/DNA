<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RestrictedUserListPage.aspx.cs" Inherits="RestrictedUserListPage" %>
            ...
            <table style="width: 853px">
                <tr>
                    <td style="width: 366px; height: 49px">
                        <asp:Label ID="Site" runat="server" Text="Site :" Width="85px" Font-Bold="True" Font-Names="Times New Roman" Font-Size="XX-Large"></asp:Label>
                        <asp:DropDownList
