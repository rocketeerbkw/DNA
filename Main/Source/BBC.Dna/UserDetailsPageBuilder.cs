    ...
    public class UserDetailsPageBuilder : DnaInputComponent
    {
        ...
        private bool UpdateUserDetails(ref string statusMessage, ref string statusType)
        {
            ...
            */
            ...
            string siteSuffix = string.Empty;
            if (InputContext.GetSiteOptionValueString("User", "AutoGeneratedNames") == string.Empty
                && InputContext.GetSiteOptionValueBool("User", "UseSiteSuffix")
                && !InputContext.GetSiteOptionValueBool("General", "IsKidsSite"))
            {
                siteSuffix = InputContext.GetParamStringOrEmpty("SiteSuffix", "Users SiteSuffix");
            }
