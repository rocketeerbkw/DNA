...
namespace BBC.Dna
{
    ...
    public class TimestampTextWriterTraceListener : TextWriterTraceListener
    {
        ...
        public static void CreateListener(string rootPath)
        {
            _rootPath = rootPath;
            ...
            System.Diagnostics.TextWriterTraceListener TextListener = new BBC.Dna.TimestampTextWriterTraceListener(logFile);
            TextListener.Name = "dnalogger";
