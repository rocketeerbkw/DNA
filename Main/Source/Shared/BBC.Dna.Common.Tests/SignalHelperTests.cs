...
namespace BBC.Dna.Common.Tests
{
    ...
    public class SignalHelperTests
    {
        ...
        public void GetStatus_ValidObjects_ReturnsCorrectStatObject()
        {
            ...
            Assert.IsNotNull(xml.SelectSingleNode("/SIGNALSTATUS/SIGNALSTATUSMEMBER[NAME = 'BBC.Dna.Moderation.BannedEmailsList, BBC.Dna.Moderation, Version=1.0.0.1, Culture=neutral, PublicKeyToken=c2c5f2d0ba0d9887']/NAME"));
            Assert.IsNotNull(xml.SelectSingleNode("/SIGNALSTATUS/SIGNALSTATUSMEMBER[NAME = 'BBC.Dna.Moderation.Utils.ProfanityCache, BBC.DNA.Moderation.Utils, Version=1.0.0.0, Culture=neutral, PublicKeyToken=c2c5f2d0ba0d9887']/NAME"));
        }
