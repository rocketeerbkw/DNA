CREATE PROCEDURE updatetextboxelement	@textboxelementid int, @topicid int = NULL, @templatetype int = NULL, @textboxtype int = NULL,
...
SELECT @ElementID = ElementID FROM dbo.TextBoxElements WHERE TextBoxElementID = @textboxelementid
