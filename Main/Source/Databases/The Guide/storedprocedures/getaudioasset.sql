/*********************************************************************************
	...
	create procedure getaudioasset @mediaassetid int as
...
CREATE PROCEDURE getaudioasset @mediaassetid int AS
	...
	FROM dbo.AudioAssets AS A WITH(NOLOCK) 
	INNER JOIN dbo.MediaAsset AS M WITH(NOLOCK) ON A.MediaAssetID = M.ID
