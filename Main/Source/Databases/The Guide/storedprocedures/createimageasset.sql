/*********************************************************************************
	...
	create procedure createimageasset	@siteid int = 1, 
	...
	Purpose:	Create a new Media Asset and an entry in the Image Asset table
...
BEGIN TRANSACTION
	...
	INSERT INTO dbo.ImageAsset (MediaAssetID) VALUES (@MediaAssetID)
