CREATE   PROCEDURE threadlistpostheaders @threadid int, @userid int = NULL, @ignorebozos int = 0, @showmax int = 0
AS
declare @select varchar(4096)

declare @numposts int
SELECT @numposts = COUNT(*) FROM ThreadEntries WHERE ThreadID = @threadid
