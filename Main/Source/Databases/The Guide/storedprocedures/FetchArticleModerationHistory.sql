...
as
select AM.*, AM.NewArticle as NewItem, G.Subject, ip.IPAddress, ip.BBCUID,
	U1.UserId, U1.UserName, U1.FirstNames,U1.LastName, U1.Status, U1.TaxonomyNode,
	...
	U4.UserId as ComplainantUserId, U4.UserName as ComplainantUserName, U4.FirstNames as ComplainantFirstNames, U4.Lastname as ComplainantLastName, U4.Email as ComplainantEmail, U4.Status as complainantstatus, U4.TaxonomyNode as complainanttaxonomynode
from ArticleMod AM
