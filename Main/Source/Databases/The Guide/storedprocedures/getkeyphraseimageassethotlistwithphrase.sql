Create Procedure getkeyphraseimageassethotlistwithphrase @siteid int, @keyphraselist VARCHAR(500), @skip int = 0, @show int = 500, @sortbyphrase bit = null
AS
...
INNER JOIN dbo.AssetKeyPhrases akp2 WITH (NOLOCK) ON akp2.AssetId = akp.AssetId
INNER JOIN dbo.KeyPhrases kp2 WITH (NOLOCK) ON kp2.PhraseId = akp2.PhraseId
