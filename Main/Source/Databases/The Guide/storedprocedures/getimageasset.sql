/*********************************************************************************
	...
	create procedure getimageasset @mediaassetid int as
...
CREATE PROCEDURE getimageasset @mediaassetid int AS
	...
	FROM dbo.ImageAssets AS I WITH(NOLOCK) 
	INNER JOIN dbo.MediaAsset AS M WITH(NOLOCK) ON I.MediaAssetID = M.ID
