...
select TM.*, TM.NewPost as NewItem, TE.Subject, IP.IPAddress, IP.BBCUID,
	...
	U4.UserId as ComplainantUserId, U4.UserName as ComplainantUserName, U4.FirstNames as ComplainantFirstNames, U4.LastName as ComplainantLastName, U4.Status as ComplainantStatus, U4.TaxonomyNode as ComplainantTaxonomyNode, U4.Email as ComplainantEmail
from ThreadMod TM
