...
SELECT @ieventtype = CASE 
	...
	WHEN (@eventtype = 'ET_MODERATIONDECISION_ARTICLE')		THEN 22
	WHEN (@eventtype = 'ET_MODERATIONDECISION_POST')		THEN 23
	WHEN (@eventtype = 'ET_USERMODERATION')					THEN 24
	WHEN (@eventtype = 'ET_NEWUSERTOSITE')					THEN 25
	WHEN (@eventtype = 'ET_COMPLAINTRECIEVED')				THEN 26
