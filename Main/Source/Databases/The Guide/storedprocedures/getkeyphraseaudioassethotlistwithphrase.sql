Create Procedure getkeyphraseaudioassethotlistwithphrase @siteid int, @keyphraselist VARCHAR(500), @skip int = 0, @show int = 500, @sortbyphrase bit = null
AS
...
INSERT @AssociatedPhrases select distinct  kp2.PhraseId, kp2.Phrase FROM dbo.AssetKeyPhrases akp
