...
namespace TheGuide.Database.UnitTests
{
    ...
    /// </summary>
    [TestClass]
    public class GetModerationPostsFastModFastModFirstTests
    {
        ...
        public GetModerationPostsFastModFastModFirstTests()
        {
        ...
        [TestMethod]
        public void GetModerationPostsFastMod_NoItemsLocked_LocksItemsUnderUser()
        {
            using (new TransactionScope())
            {
                ...
                var reader = GetModerationPostsFastModItems(_userId, null, null, null, null, null, null, null, null, null);
        ...
        [TestMethod]
        public void GetModerationPostsFastMod_AsSuperUser_LocksItemsUnderUser()
        {
            using (new TransactionScope())
            {
                ClearQueue();
                ...
                var reader = GetModerationPostsFastModItems(TestUserAccounts.GetSuperUserAccount.UserID, null, null, null, null, true, null, null, null, null);
                Assert.IsTrue(reader.HasRows);
                var items = 0;
                while (reader.Read())
                {
        ...
        [TestMethod]
        public void GetModerationPostsFastMod_AsNonModerator_NoLocksItemsUnderUser()
        {
            using (new TransactionScope())
            {
                ClearQueue();
                ...
                var reader = GetModerationPostsFastModItems(TestUserAccounts.GetNormalUserAccount.UserID, null, null, null, null, null, null, null, null, null);
                Assert.IsFalse(reader.HasRows);
            }
        }

        [TestMethod]
        public void GetModerationPostsFastMod_ByModerationId_LocksItemsUnderUser()
        {
            using (new TransactionScope())
            {
                ClearQueue();
                ...
                var reader = GetModerationPostsFastModItems(_userId, null, null, null, null, null, _modClassId, null, null, null);
                Assert.IsTrue(reader.HasRows);
                var items = 0;
                while (reader.Read())
                {
        ...
        [TestMethod]
        public void GetModerationPostsFastMod_ByPostId_ReturnsLockedItemsOnly()
        {
            using (new TransactionScope())
            {
                ClearQueue();
                ...
                var reader = GetModerationPostsFastModItems(_userId, null, null, null, null, null, null, 58, null, null);
                Assert.IsTrue(reader.HasRows);
                var items = 0;
                while (reader.Read())
                {
        ...
        [TestMethod]
        public void GetModerationPostsFastMod_ByLockedBy_ReturnsLockedItemsOnly()
        {
            using (new TransactionScope())
            {
                ClearQueue();
                ...
                reader = GetModerationPostsFastModItems(_userId, null, null, 1, null, null, null, null, null, null);
                Assert.IsTrue(reader.HasRows);
                items = 0;
                while (reader.Read())
                {
        ...
        [TestMethod]
        public void GetModerationPostsFastMod_ByComplaints_ReturnsComplaintItemsOnly()
        {
            using (new TransactionScope())
            {
                ClearQueue();
                ...
                var reader = GetModerationPostsFastModItems(_userId, null, 1, null, null, null, null, null, null, null);
                Assert.IsTrue(reader.HasRows);
                var items = 0;
                while (reader.Read())
                {
        ...
        [TestMethod]
        public void GetModerationPostsFastMod_ByStatus_ReturnsStatusItemsOnly()
        {
            using (new TransactionScope())
            {
                ClearQueue();
                ...
                var reader = GetModerationPostsFastModItems(_userId, 2, null, null, null, null, null, null, null, null);
                Assert.IsTrue(reader.HasRows);
                var items = 0;
                while (reader.Read())
                {
        ...
        [TestMethod]
        public void GetModerationPostsFastMod_ByFastMod_ReturnsFastModItemsOnly()
        {
            using (new TransactionScope())
            {
                ClearQueue();
                ...
                var reader = GetModerationPostsFastModItems(_userId, null, null, null, 1, null, null, null, null, null);
                Assert.IsTrue(reader.HasRows);
                var items = 0;
                while (reader.Read())
                {
        ...
        [TestMethod]
        public void GetModerationPostsFastMod_ByDuplicates_ReturnsDuplicateItemsOnly()
        {
            using (new TransactionScope())
            {
                ClearQueue();
                ...
                var reader = GetModerationPostsFastModItems(_userId, null, 1, null, null, null, null, null, true, null);
                Assert.IsTrue(reader.HasRows);
                var items = 0;
                while (reader.Read())
                {
        ...
        [TestMethod]
        public void GetModerationPostsFastMod_WithShow_ShownLocksItemsUnderUser()
        {
            using (new TransactionScope())
            {
                ClearQueue();
                ...
                var reader = GetModerationPostsFastModItems(_userId, null, null, null, null, null, null, null, null, 1);
                Assert.IsTrue(reader.HasRows);
                var items = 0;
                while (reader.Read())
                {
        ...
        [TestMethod]
        public void GetModerationPostsFastMod_AddedOutOfOrder_LocksItemsInOrder()
        {
            using (new TransactionScope())
            {
                ClearQueue();
                ...
                var reader = GetModerationPostsFastModItems(_userId, null, 1, null, null, null, 3, null, null, null);
                Assert.IsTrue(reader.HasRows);
                var items = 0;
                while (reader.Read())
                {
        ...
        [TestMethod]
        public void GetModerationPostsFastMod_AddedOutOfOrderWithFastMod_LocksItemsInOrder()
        {
            using (new TransactionScope())
            {
                ClearQueue();
                ...
                Assert.AreEqual(4, items); //should only return one item as other one in other mod class
            }
        }
        ...
        private IDnaDataReader GetModerationPostsFastModItems(int userId, int? status, int? alerts, int? lockedItems,
            int? fastMod, bool? isSuperUser, int? modClassId, int? postId, bool? duplicatecomplaints, int? show)
        {
            //GetModerationPostsFastMod @userid int, @status int = 0, @alerts int = 0,  @lockeditems int = 0, @fastmod int = 0, 
            //@issuperuser bit = 0, @modclassid int = NULL, @postid int = NULL, @duplicatecomplaints bit = 0, 
            //@show int = 10

            IDnaDataReader reader = StoredProcedureReader.Create("getmoderationpostsfastmodfirst", _connectionDetails);
