...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:local="#local-functions" xmlns:s="urn:schemas-microsoft-com:xml-data" xmlns:dt="urn:schemas-microsoft-com:datatypes" exclude-result-prefixes="msxsl local s dt">
	...
	<xsl:choose>
		...
		<p><b>NOTE: EDITORS ONLY CAN VIEW THIS PAGE, BRITISH FILM HAS NO USERPAGES.<BR/><BR/>STANDARD USERS ARE REDIRECTED TO HOMEPAGE</b></p>
			<xsl:choose>
	...
	<xsl:if test="/H2G2/@TYPE='USERPAGE'">
		<div class="mbx">			
			<div class="flemail">
				 <div class="email"><a onClick="popmailwin('/cgi-bin/navigation/mailto.pl?GO=1','Mailer')" href="/cgi-bin/navigation/mailto.pl?GO=1" target="Mailer">send to a friend</a></div>
			</div>
...
<a href="{$root}inspectuser?userid={/H2G2/ARTICLE/ARTICLEINFO/PAGEAUTHOR/EDITOR/USER/USERID}">inspectuser: U<xsl:value-of select="/H2G2/ARTICLE/ARTICLEINFO/PAGEAUTHOR/EDITOR/USER/USERID"/></a>
	...
	<div class="additionsec">	
		...
		<div class="badges">	
			...
			<div class="clear"></div>
			<p class="arrowlink"><a href="http://www.bbc.co.uk/britishfilm/2/popups/badges.shtml" target="badges" onClick="popupwindow(this.href,this.target,'width=623, height=502, resizable=yes, scrollbars=yes');return false;">What do these badges mean?</a></p>
		...
		<div class="hintbox">	
			...
			<p>You must fill in this information to finish your registration and become a full member of British Film</p>
		...
		<xsl:variable name="no_context_text">
			...
			<div class="mainbodysec">
				...
				<div class="stepsheadbox">
					<h3>MY COMMENTS</h3> <p class="links"><a href="#intro">intro</a>  |  <a href="#articles">articles</a> | <a href="#reports">reports</a> | <a href="#profiles">profiles</a></p>
				</div> 			
