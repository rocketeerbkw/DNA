...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:local="#local-functions" xmlns:s="urn:schemas-microsoft-com:xml-data" xmlns:dt="urn:schemas-microsoft-com:datatypes" exclude-result-prefixes="msxsl local s dt">
							...
							<table width="100%" cellpadding="0" cellspacing="0">
								...
								<tr>
									...
									<td colspan="6">
										...
										<font size="3">
											Your <strong>nickname</strong> has been <strong>saved</strong>
										</font>
										<br/>&nbsp;</td>
								</tr>
								<!--Top corners-->
							...
							<table width="100%" cellpadding="0" cellspacing="0">
								...
								<tr>
									...
									<td colspan="6">
										...
										<img src="{$sso_assets}/images/other/icon_add-details.gif" width="33" height="34" alt=""/>
										<font size="3">
											<strong>Change Your Nickname</strong>
										</font>
										<br/>&nbsp;</td>
								</tr>
								<!--Top corners-->
	...
	<xsl:template match="USER-DETAILS-FORM" mode="normal_registered">
		...
		<tr class="ssoFormbox">
			...
			<td valign="top">
				<div id="ln_txt">
					<font size="-2">This is the name that will appear on the message boards.</font>
				</div>
			</td>
			<td/>
		</tr>
	...
	<xsl:attribute-set name="mUSER-DETAILS-FORM_c_registered_prefskin">
		<xsl:attribute name="value">boards</xsl:attribute>
	</xsl:attribute-set>
	<!-- 
