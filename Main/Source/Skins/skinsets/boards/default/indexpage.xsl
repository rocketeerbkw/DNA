...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:local="#local-functions" xmlns:s="urn:schemas-microsoft-com:xml-data" xmlns:dt="urn:schemas-microsoft-com:datatypes" exclude-result-prefixes="msxsl local s dt">
	...
	<xsl:template name="INDEX_MAINBODY">
		<xsl:if test="$test_IsEditor = 1">
			<h2>Topic Area Configuration</h2>
			<!--<xsl:call-template name="topNav"/>-->
			<table width="200" cellpadding="0" cellspacing="5" border="0">
				<tr>
					<td valign="top">
						<p align="center" class="button">
							<a href="{$root}TypedArticle?acreate=new&amp;_msxml={$articlefields}&amp;type=1">Create a new topic area</a>
						</p>
					</td>
				</tr>
			</table>
	...
	<xsl:template match="INDEX" mode="r_index">
		...
		<br/>
		<br/>-->
		<h3>List of Topic areas</h3>
		<table width="500" cellspacing="0" cellpadding="8" border="0">
	...
	<xsl:template match="INDEXENTRY" mode="approved_index">
		<tr valign="top">
			...
			<td>
				<font size="2">
					<a href="{$root}Typedarticle?aedit=new&amp;h2g2id={H2G2ID}">
						Edit topic area settings
					</a>
				</font>
			</td>
		</tr>
	...
	<xsl:template match="INDEXENTRY" mode="unapproved_index">
		<tr valign="top">
			...
			<td width="250" valign="middle" class="divider">
				<p>
					<xsl:apply-templates select="SUBJECT" mode="t_index"/>
				</p>
			</td>
			<td width="150" class="divider">
				<p align="center" class="button">
					<a href="{$root}Typedarticle?aedit=new&amp;h2g2id={H2G2ID}">Edit topic area settings</a>
				</p>
			</td>
		</tr>
	</xsl:template>
