...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:doc="http://www.bbc.co.uk/dna/documentation"  exclude-result-prefixes="doc">
    ...
    <xsl:template match="/H2G2[@TYPE = 'NOTFOUND']" mode="page">        
        ...
        <p>Alternatively, you can view the <a href="/dna/mbiplayer">iPlayer messageboard topics</a> or go to the <a href="/iplayer">iPlayer Homepage</a>.</p>
        
    </xsl:template>
    
    <xsl:template match="/H2G2[@TYPE = 'NOTFOUND']" mode="breadcrumbs">
        <li class="current">
            <a href="{$root}">iPlayer message boards</a>
        </li>
    </xsl:template>
