...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:doc="http://www.bbc.co.uk/dna/documentation"  exclude-result-prefixes="doc">
    ...
    <xsl:template match="/H2G2[@TYPE = 'ADDTHREAD']" mode="breadcrumbs">
        ...
        <li>
            <a href="F{FORUMSOURCE/ARTICLE/ARTICLEINFO/FORUMID}">
                <xsl:value-of select="FORUMSOURCE/ARTICLE/SUBJECT" />
            </a>
        </li>
        <li class="current">
            <a href="AddThread?forum={FORUMSOURCE/ARTICLE/ARTICLEINFO/FORUMID}&amp;article={FORUMSOURCE/ARTICLE/ARTICLEINFO/H2G2ID}" class="startanewdiscussion">
