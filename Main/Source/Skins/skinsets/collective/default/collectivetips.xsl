...
<xsl:stylesheet exclude-result-prefixes="msxsl local s dt" version="1.0" xmlns:dt="urn:schemas-microsoft-com:datatypes" xmlns:local="#local-functions" xmlns:msxsl="urn:schemas-microsoft-com:xslt"
        ...
        <xsl:variable name="tips_newusers">
                ...
                <div class="myspace-t">try suggesting collective features or reviews they'll be interested in</div>
        ...
        <xsl:variable name="tips_infopage_articles">
                <div class="myspace-t">this is a list of all reviews and other pages that have been published on collective, with the most recent first</div>
        ...
        <xsl:variable name="tips_infopage_conversations">
                <div class="myspace-t">this is a list of all the conversations on collective, listed in chronological order with the most recently updated displayed first</div>
                <div class="myspace-t">if you add a comment to a conversation it automatically moves to the top of the list<br/><br/><a href="{$root}houserules"><img alt="houserules" border="0"
                                        height="9" src="{$imagesource}icons/house_rules.gif" width="8"/> house rules</a></div>
        </xsl:variable>
        ...
        <xsl:variable name="tips_memberpage">
                <div class="write-review-hint">You can use this area to create pages that are a bit more involved than a review. For example, people have created things like: <br/> &nbsp;- Buyers'
                        guides<br/> &nbsp;- Guides to towns/cities<br/> &nbsp;- Opinion pieces<br/> &nbsp;- Art projects<br/>
                </div>
                <div class="write-review-hint">Be creative and think about ideas where you can get other members involved. It's a good idea to encourage support for your project on the noticeboard
        ...
        <xsl:variable name="tips_editintro">
                <div class="write-review-hint">your introduction appears in your personal space ("my space")</div>
        ...
        <xsl:variable name="tips_note">
                <div class="write-review-hint">note: please be very careful if you post an email address or instant messaging details, as you may receive lots of emails or messages. See the House
                        Rules for more information. Remember, when you contribute to the site you are giving the BBC permission to use your contribution in a variety of ways. See the Terms Of Use for
