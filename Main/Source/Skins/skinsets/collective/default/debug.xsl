...
<div id="debuggingInfo">
	...
	<xsl:apply-templates select="/H2G2/HIERARCHYDETAILS" mode="debug"/>
...
<!-- HIERARCHYDETAILS -->
<xsl:template match="/H2G2/HIERARCHYDETAILS" mode="debug">
	<div class="debug">
	<h2>/H2G2/HIERARCHYDETAILS</h2>
	@NODEID = <xsl:value-of select="/H2G2/HIERARCHYDETAILS/@NODEID" /><br />
	@ISROOT = <xsl:value-of select="/H2G2/HIERARCHYDETAILS/@ISROOT" /><br />
	@USERADD = <xsl:value-of select="/H2G2/HIERARCHYDETAILS/@USERADD" /><br />
	@TYPE = <xsl:value-of select="/H2G2/HIERARCHYDETAILS/@TYPE" /><br />
	
	<br />
	DISPLAYNAME = <xsl:value-of select="/H2G2/HIERARCHYDETAILS/DISPLAYNAME" /><br />
	H2G2ID = <xsl:value-of select="/H2G2/HIERARCHYDETAILS/H2G2ID" /><br />
	<br />
	
	ANCESTRY/ANCESTOR<br />
	<table cellpadding="0" cellspacing="0" border="1" style="font-size:100%;">
	<tr>
		<th>NODEID</th>
		<th>TYPE</th>
	...
	<xsl:for-each select="ANCESTRY/ANCESTOR">
	<tr>
		<td><xsl:value-of select="NODEID"/></td>
		<td><xsl:value-of select="TYPE"/></td>
		<td><xsl:value-of select="NAME"/></td>
		<td><xsl:value-of select="TREELEVEL"/></td>
	</tr>
	</xsl:for-each>
	</table>
	<br />
	MEMBERS/SUBJECTMEMBER<br />
	<table cellpadding="0" cellspacing="0" border="1" style="font-size:100%;">
		<tr>
		<th>@SORTORDER</th>
		<th>NAME</th>
		...
		<tr>
		<td><xsl:value-of select="@SORTORDER"/></td>
		<td><a href="{$root}C{NODEID}"><xsl:value-of select="NAME"/></a></td>
		<td><xsl:value-of select="NODEID"/></td>
		<td><xsl:value-of select="TYPE"/></td>
		<td><xsl:value-of select="NODECOUNT"/></td>
		<td><xsl:value-of select="ARTICLECOUNT"/></td>
		<td><xsl:value-of select="ALIASCOUNT"/></td>
		<td>
			<table cellpadding="0" cellspacing="0" border="1" style="font-size:100%;">
			<tr>
				<th>@ID</th>
			...
			<tr>
				<td><xsl:value-of select="@ID"/></td>
				<td><xsl:value-of select="@TYPE"/></td>
				<td><a href="{$root}C{NODEID}"><xsl:value-of select="text()"/></a></td>
			</tr>
			</xsl:for-each>
			</table>
		</td>
	...
	<table cellpadding="0" cellspacing="0" border="1" style="font-size:100%;">
		...
		<xsl:for-each select="CLOSEMEMBERS/ARTICLEMEMBER">
		<tr>
		<td><xsl:value-of select="position()"/></td>
		<td><a href="{$root}A{H2G2ID}"><xsl:value-of select="NAME" /></a></td>
		<td><xsl:value-of select="EXTRAINFO/TYPE/@ID" /></td>
		<td><xsl:value-of select="STATUS/@TYPE" /></td>
		<td><xsl:value-of select="DATECREATED/DATE/@DAY" />&nbsp;<xsl:value-of select="DATECREATED/DATE/@MONTHNAME" />&nbsp;<xsl:value-of select="DATECREATED/DATE/@YEAR" /><xsl:text> </xsl:text><xsl:value-of select="DATECREATED/DATE/@HOURS" />:<xsl:value-of select="DATECREATED/DATE/@MINUTES" />:<xsl:value-of select="DATEPOSTED/DATE/@SECONDS" /></td>
		<td><xsl:value-of select="LASTUPDATED/DATE/@DAY" />&nbsp;<xsl:value-of select="LASTUPDATED/DATE/@MONTHNAME" />&nbsp;<xsl:value-of select="LASTUPDATED/DATE/@YEAR" /><xsl:text> </xsl:text><xsl:value-of select="LASTUPDATED/DATE/@HOURS" />:<xsl:value-of select="LASTUPDATED/DATE/@MINUTES" />:<xsl:value-of select="LASTUPDATED/DATE/@SECONDS" /></td>
		<th><a href="{EDITOR/USER/USERID}"><xsl:value-of select="EDITOR/USER/USERNAME" /></a></th>
		<th>
			<xsl:if test="EDITOR/USER/GROUPS/EDITOR">GROUPS/EDITOR</xsl:if>
		</th>
		</tr>
		</xsl:for-each>
	</table>
	...
	<div class="debug">
		...
		<xsl:for-each select="TOP-FIVE">
			<div style="border:1px solid #999;padding:10px;margin:10px 0;"><strong>LIST  <xsl:value-of select="position()"/></strong><br />
				...
				<xsl:choose>
					<xsl:when test="@NAME='MostRecentConversations'">
						<table cellpadding="1" cellspacing="0" border="1" style="font-size:100%;">
						<tr>
						<th>position</th>
						<th>SUBJECT</th>
						...
						<xsl:for-each select="TOP-FIVE-FORUM">
						<tr>
						<td><xsl:value-of select="position()"/></td>
						<td><xsl:value-of select="SUBJECT"/></td>
						<td><a href="{$root}F{FORUMID}"><xsl:value-of select="FORUMID"/></a></td>
						<td><a href="{$root}F{FORUMID}?thread={THREADID}"><xsl:value-of select="THREADID"/></a></td>
						</tr>
						</xsl:for-each>		
						</table>
					</xsl:when>
					<xsl:otherwise>
						...
						<tr>
						<td><xsl:value-of select="position()"/></td>
						<td><a href="{$root}A{H2G2ID}"><xsl:value-of select="SUBJECT"/></a></td>
