...
<xsl:variable name="icon.hints.black"><img src="{$imagesource}icons/hints_tips_000.gif" width="20" height="20" alt="light bulb" border="0" />&nbsp;</xsl:variable>
	...
	<xsl:variable name="arrow.right"><img src="{$imagesource}icons/arrow_right.gif" width="9" height="7" alt="" border="0" /></xsl:variable>
	<xsl:variable name="arrow.left"><img src="{$imagesource}icons/arrow_left.gif" width="9" height="7" alt="" border="0" /></xsl:variable>
