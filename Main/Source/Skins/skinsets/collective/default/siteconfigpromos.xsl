...
<xsl:stylesheet exclude-result-prefixes="msxsl local s dt" version="1.0"
        ...
        <xsl:template name="SITECONFIGPROMOS">
                <xsl:choose>
                        ...
                        <xsl:when
                                test="$article_type_name='editor_interview_music' or $article_type_name='editor_feature_music'">
                                <div class="siteConfigPromo">
                                        <xsl:apply-templates select="/H2G2/SITECONFIG/PROMO1"/>
                                </div>
                                <div class="siteConfigPromo">
                                        <xsl:apply-templates select="/H2G2/SITECONFIG/PROMO2"/>
                                </div>
                                <xsl:apply-templates select="/H2G2/SITECONFIG/ALBUMWEEK"/>
                        </xsl:when>
                        <!-- film interview or film feature -->
                        <xsl:when
                                test="$article_type_name='editor_interview_film' or $article_type_name='editor_feature_film'">
                                <div class="siteConfigPromo">
                                        <xsl:apply-templates select="/H2G2/SITECONFIG/PROMO2"/>
                                </div>
                                <div class="siteConfigPromo">
                        ...
                        <xsl:when
                                test="$article_type_name='editor_review_film' or $article_type_name='editor_review_dvd'">
                        ...
                        <xsl:when
                                test="$article_type_name='editor_review_art' or $article_type_name='editor_review_book' or $article_type_name='editor_review_game' or $article_type_name='editor_review_tv' or $article_type_name='editor_review_comedy'">
                        ...
                        <xsl:when
                                test="$article_type_name='editor_column_game' or $article_type_name='editor_column_tv'">
                                <div class="siteConfigPromo">
                                        <xsl:apply-templates select="/H2G2/SITECONFIG/PROMO2"/>
                                </div>
                                <div class="siteConfigPromo">
                        ...
                        <xsl:when
                                test="$article_type_name='_article_review' or $article_type_name='editor_article_page'">
