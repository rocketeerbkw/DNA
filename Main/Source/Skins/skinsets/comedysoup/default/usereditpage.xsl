...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:local="#local-functions" xmlns:s="urn:schemas-microsoft-com:xml-data" xmlns:dt="urn:schemas-microsoft-com:datatypes" exclude-result-prefixes="msxsl local s dt">
	...
	<xsl:template match="ARTICLE-EDIT-FORM" mode="r_form">
			...
			<div><xsl:apply-templates select="." mode="c_premodmessage"/></div>
			 <div class="dynamicKeyPhraseBox">
			 <strong><xsl:copy-of select="$m_fsubject"/></strong><br/>
		...
		<!-- <font xsl:use-attribute-sets="mainfont">
			...
			<div class="dynamicKeyPhraseBox">
			<strong><xsl:copy-of select="$m_content"/></strong><br />
			...
			<div class="dynamicKeyPhraseBox">
			<xsl:apply-templates select="FORMAT" mode="c_guidemlorother"/><br /><br />
			<xsl:apply-templates select="." mode="c_makearchive"/>
			</div>
			
			<div class="dynamicKeyPhraseBox">
			<a name="editusers" id="editusers"></a>
			...
			<strong><xsl:copy-of select="$m_mustsavefirstmessage"/></strong><br />
	...
	<div class="dynamicKeyPhraseBox"><xsl:copy-of select="$m_deletethisentry"/><br />
	...
	<xsl:template match="USER-LIST" mode="r_researchers">
		...
		<strong>Users who own this article:</strong><br />
	...
	<strong>Add or remove ownership of this article:</strong><br />
	<xsl:apply-templates select="." mode="t_setresearcherscontent"/>
	<br/>
	
	<xsl:apply-templates select="." mode="t_submitsetresearchers"/>
	<br /><br />
		You will need the userid of the user that you want to attribute the article to. Paste or remove and remember to click 'update article' to make your change.
