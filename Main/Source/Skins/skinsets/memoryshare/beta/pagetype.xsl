...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:local="#local-functions" xmlns:s="urn:schemas-microsoft-com:xml-data" xmlns:dt="urn:schemas-microsoft-com:datatypes" exclude-result-prefixes="msxsl local s dt">
		...
		<xsl:choose>
			...
			<xsl:when test="/H2G2/@TYPE='ARTICLE'">
				<xsl:choose>
					...
					<xsl:when test="$content = 'RSS2'">
						<xsl:call-template name="ARTICLE_RSS2">
							<xsl:with-param name="mod" select="$mod"/>
						</xsl:call-template>
					</xsl:when>
				</xsl:choose>
			...
			<xsl:when test="/H2G2/@TYPE='ARTICLESEARCHPHRASE'">
				<xsl:choose>
					...
					<xsl:when test="$content = 'RSS2'">
						<xsl:call-template name="ARTICLESEARCHPHRASE_RSS2">
							<xsl:with-param name="mod" select="$mod"/>
						</xsl:call-template>
					</xsl:when>
				</xsl:choose>
			</xsl:when>
			<!--[FIXME: change to base]-->
			<xsl:when test="/H2G2/@TYPE='ARTICLESEARCH'">
				<xsl:choose>
					...
					<xsl:when test="$content = 'RSS2'">
						<xsl:call-template name="ARTICLESEARCH_RSS2">
							<xsl:with-param name="mod" select="$mod"/>
						</xsl:call-template>
					</xsl:when>
					<xsl:when test="$content = 'FLASHXML'">
						<xsl:call-template name="ARTICLESEARCH_FLASHXML">
							<xsl:with-param name="mod" select="$mod"/>
						</xsl:call-template>
					</xsl:when>
				</xsl:choose>
			...
			<xsl:when test="/H2G2/@TYPE='CATEGORY'">
				<xsl:choose>
					...
					<xsl:when test="$content = 'RSS2'">
						<xsl:call-template name="CATEGORY_RSS2">
							<xsl:with-param name="mod" select="$mod"/>
						</xsl:call-template>
					</xsl:when>
				</xsl:choose>
			...
			<xsl:when test="/H2G2/@TYPE='CLUB'">
				<xsl:choose>
					...
					<xsl:when test="$content = 'RSS2'">
						<xsl:call-template name="CLUB_RSS2">
							<xsl:with-param name="mod" select="$mod"/>
						</xsl:call-template>
					</xsl:when>
				</xsl:choose>
			...
			<xsl:when test="/H2G2/@TYPE='FRONTPAGE'">
				<xsl:choose>
					...
					<xsl:when test="$content = 'RSS2'">
						<xsl:call-template name="FRONTPAGE_RSS2">
							<xsl:with-param name="mod" select="$mod"/>
						</xsl:call-template>
					</xsl:when>
			...
			<xsl:when test="/H2G2/@TYPE='INDEX'">
				<xsl:choose>
					...
					<xsl:when test="$content = 'RSS2'">
						<xsl:call-template name="INDEX_RSS2">
							<xsl:with-param name="mod" select="$mod"/>
						</xsl:call-template>
					</xsl:when>					
				</xsl:choose>
			...
			<xsl:when test="/H2G2/@TYPE='INFO'">
				<xsl:choose>
					...
					<xsl:when test="$content = 'RSS2'">
						<xsl:call-template name="INFO_RSS2">
							<xsl:with-param name="mod" select="$mod"/>
						</xsl:call-template>
					</xsl:when>
				</xsl:choose>
			...
			<xsl:when test="/H2G2/@TYPE='MOREPAGES'">
				<xsl:choose>
					...
					<xsl:when test="$content = 'RSS2'">
						<xsl:call-template name="MOREPAGES_RSS2">
							<xsl:with-param name="mod" select="$mod"/>
						</xsl:call-template>
					</xsl:when>
				</xsl:choose>
				...
				<xsl:choose>
					...
					<xsl:otherwise>
						<xsl:choose>
							...
							<xsl:when test="$content = 'RSS2'">
								<xsl:call-template name="MOREPOSTS_RSS2">
									<xsl:with-param name="mod" select="$mod"/>
								</xsl:call-template>
							</xsl:when>
						</xsl:choose>
			...
			<xsl:when test="/H2G2/@TYPE='MULTIPOSTS'">
				<xsl:choose>
					...
					<xsl:when test="$content = 'RSS2'">
						<xsl:call-template name="MULTIPOSTS_RSS2">
							<xsl:with-param name="mod" select="$mod"/>
						</xsl:call-template>
					</xsl:when>
				</xsl:choose>
			...
			<xsl:when test="/H2G2/@TYPE='NEWUSERS'">
				<xsl:choose>
					...
					<xsl:when test="$content = 'RSS2'">
						<xsl:call-template name="NEWUSERS_RSS2">
							<xsl:with-param name="mod" select="$mod"/>
						</xsl:call-template>
					</xsl:when>
				</xsl:choose>
			...
			<xsl:when test="/H2G2/@TYPE='REVIEWFORUM'">
				<xsl:choose>
					...
					<xsl:when test="$content = 'RSS2'">
						<xsl:call-template name="REVIEWFORUM_RSS2">
							<xsl:with-param name="mod" select="$mod"/>
						</xsl:call-template>
					</xsl:when>
				</xsl:choose>
			...
			<xsl:when test="/H2G2/@TYPE='SEARCH'">
				<xsl:choose>
					...
					<xsl:when test="$content = 'RSS1'">
						<xsl:call-template name="SEARCH_RSS1">
							<xsl:with-param name="mod" select="$mod"/>
						</xsl:call-template>
					</xsl:when>
					<xsl:when test="$content = 'RSS2'">
						<xsl:call-template name="SEARCH_RSS2">
							<xsl:with-param name="mod" select="$mod"/>
						</xsl:call-template>
					</xsl:when>
					<xsl:when test="$content = 'FLASHXML'">
						<xsl:call-template name="SEARCH_FLASHXML">
							<xsl:with-param name="mod" select="$mod"/>
						</xsl:call-template>
					</xsl:when>
				</xsl:choose>
			...
			<xsl:when test="/H2G2/@TYPE='THREADS'">
				<xsl:choose>
					...
					<xsl:when test="$content = 'RSS2'">
						<xsl:call-template name="THREADS_RSS2">
							<xsl:with-param name="mod" select="$mod"/>
						</xsl:call-template>
					</xsl:when>
				</xsl:choose>
			...
			<xsl:when test="/H2G2/@TYPE='USERPAGE'">
				<xsl:choose>
					...
					<xsl:when test="$content = 'RSS2'">
						<xsl:call-template name="USERPAGE_RSS2">
							<xsl:with-param name="mod" select="$mod"/>
						</xsl:call-template>
					</xsl:when>
				</xsl:choose>
    ...
    <xsl:template name="ARTICLE_RSS2"/>
    ...
    <xsl:template name="ARTICLESEARCHPHRASE_RSS2"/>
    <xsl:template name="CATEGORY_RSS2"/>
    <xsl:template name="CLUB_RSS2"/>
    <xsl:template name="FRONTPAGE_XHTML"/>
    <xsl:template name="FRONTPAGE_RSS2"/>
	<xsl:template name="INDEX_RSS2"/>
    <xsl:template name="INFO_RSS2"/>
    <xsl:template name="MOREPAGES_RSS1"/>
    <xsl:template name="MOREPAGES_RSS2"/>
    <xsl:template name="MOREPOSTS_RSS2"/>
    <xsl:template name="MULTIPOSTS_RSS2"/>
    <xsl:template name="NEWUSERS_RSS2"/>
    <xsl:template name="REVIEWFORUM_RSS2"/>
    <xsl:template name="SEARCH_RSS1"/>
    <xsl:template name="SEARCH_RSS2"/>
    <xsl:template name="SEARCH_FLASHXML"/>
    <xsl:template name="THREADS_RSS2"/>
    <xsl:template name="USERPAGE_RSS2"/>
</xsl:stylesheet>
