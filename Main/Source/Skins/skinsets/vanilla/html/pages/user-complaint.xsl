...
<xsl:stylesheet 
    ...
    />
    -->
    <xsl:template match="/H2G2[@TYPE = 'USER-COMPLAINT']" mode="page">
        <xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"></xsl:text>
        <html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en-GB" lang="en-GB">
            <head profile="http://dublincore.org/documents/dcq-html/">
                
                <title>BBC - Complaints</title>
            ...
            <body>
                ...
                <div id="blq-container">
                    <div id="blq-main">
                        ...
                        <h1>BBC Complaints
                            <span>regarding user generated content.</span>
                        </h1>
                        
                        <xsl:apply-templates select="USER-COMPLAINT-FORM" mode="input_user-complaint-form" />
