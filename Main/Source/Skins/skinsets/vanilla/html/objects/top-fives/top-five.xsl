...
<xsl:stylesheet 
    ...
    <xsl:template match="TOP-FIVE" mode="object_top-fives_top-five">
        ...
        <div class="hpData topfive">
            <h3><xsl:value-of select="TITLE"/></h3>
        	<xsl:call-template name="library_userstate_editor">
        		<xsl:with-param name="loggedin">
        			<p class="addremove">
	        			<a href="#" class="add">
	        				<span class="hide">Add a Story to this feed</span>
	        			</a> 
	        			<a class="remove" href="#">
	        				<span class="hide">Remove a story from this feed</span>
	        			</a>
	        		</p>
        		</xsl:with-param>
            ...
            <ul class="{translate( string(count(preceding-sibling::*) + 1), '1234', 'abcd')} {translate(@NAME, $ABC, $abc)}">
