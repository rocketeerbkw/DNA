		...
		<div class="full">
			...
			<div class="mbpreview">
				<div id="mbpreview-header">
					<p>
						<xsl:choose>
							<xsl:when test="SITECONFIG/BLQ-NAV-COLOR">Header colour is <xsl:value-of select="SITECONFIG/BLQ-NAV-COLOR"/>.</xsl:when>
					...
					<div id="mbpreview-left">
						...
						<div id="mbpreview-topics" class="solidborder">
							...
							<xsl:choose>
								...
								<!--<xsl:when test="SITECONFIG/TOPICLAYOUT">-->
				...
				<div id="mbpreview-footer">
					<p>
						<xsl:choose>
							<xsl:when test="SITECONFIG/BLQ-FOOTER-COLOR">Footer colour is <xsl:value-of select="SITECONFIG/BLQ-FOOTER-COLOR"/>.</xsl:when>
