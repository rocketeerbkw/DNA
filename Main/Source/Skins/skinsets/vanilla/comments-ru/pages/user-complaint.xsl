    ...
    <xsl:template match="/H2G2[@TYPE = 'USER-COMPLAINT'] | /H2G2[@TYPE = 'USERCOMPLAINTPAGE']" mode="page">
        ...
        <html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ru" lang="ru">
            <head profile="http://dublincore.org/documents/dcq-html/">
                ...
                <title>Русская служба Би-би-си - Жалобы</title>
				...
				<link rel="stylesheet" href="/worldservice/comments/ru_complaints.css" type="text/css" />
            ...
            <body>
                ...
                <div id="blq-container">
                    <div id="blq-main">
                        ...
                        <h1>Русская служба Би-би-си - Жалобы</h1>
