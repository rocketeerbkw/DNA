...
<xsl:template name="VARIABLEDUMP">
	...
	<div class="variable">edit preview mode:<br/> 
	<b><xsl:value-of select="/H2G2/MULTI-STAGE/@TYPE" /></b></div>
	
	<div class="variable">Stage:<br/> 
	<b><xsl:value-of select="/H2G2/MULTI-STAGE/@STAGE" /></b></div>
	
	<div class="variable">Status:<br/> 
...
<div id="debuggingInfo">
	...
	<xsl:apply-templates select="/H2G2/ALERTACTION" mode="debug"/>
	<xsl:apply-templates select="/H2G2/ALERTGROUPS" mode="debug"/>
	...
	$magazinePage: <xsl:value-of select="$magazinePage" /><br />
	/H2G2/HIERARCHYDETAILS/ANCESTRY/ANCESTOR[2]/NODEID: <xsl:value-of select="/H2G2/HIERARCHYDETAILS/ANCESTRY/ANCESTOR[2]/NODEID" /><br />
	$diplaytype: <xsl:value-of select="$diplaytype" /><br />
	<br />
	$name: <xsl:value-of select="$name" /><br />
	$server: <xsl:value-of select="$server" /><br />
	$test_IsDev: <xsl:value-of select="$test_IsDev" /><br />
	$test_IsStage: <xsl:value-of select="$test_IsStage" /><br />
	$filmIndexPage: <xsl:value-of select="$filmIndexPage" /><br />
...
<!-- ALERTACTION
used on: emailalertgroupspage.xsl -->
<xsl:template match="/H2G2/ALERTACTION" mode="debug">
	<div class="debug">
		/H2G2/ALERTACTION<br />
...
<!-- ALERTGROUPS
used on: emailalertgroupspage.xsl -->
<xsl:template match="/H2G2/ALERTGROUPS" mode="debug">
	<div class="debug">
		/H2G2/ALERTGROUPS<br />
		<xsl:call-template name="tablex3"/>
	</div>
...
-->
	...
	<form method="post" action="http://www.bbc.co.uk/cgi-bin/cgiemail/filmnetwork/includes/error_form.txt" name="debugform">
	<input type="hidden" name="success" value="http://www.bbc.co.uk/filmnetwork/thanks.shtml"/>
		<table width="635" cellpadding="10">
		<tr><td colspan="2" bgcolor="#EEEFF0"><div class="textmedium"><h3>REPORT A BUG</h3></div></td></tr>
		<tr><td bgcolor="#EEEFF0"><span class="textmedium">From:</span></td><td bgcolor="#EEEFF0"><input type="text" name="from" /></td></tr>
		<tr><td bgcolor="#EEEFF0"><span class="textmedium">Subject:</span></td><td bgcolor="#EEEFF0"><input type="text" name="subject" /></td></tr>
		<tr><td bgcolor="#EEEFF0"><span class="textmedium">Error Class:</span></td><td bgcolor="#EEEFF0"><select name="class" size="4" multiple="multiple">
				<option></option>
				<option value="design">Design</option>
				<option value="functionality">Functionality</option>
				<option value="content">Content</option>
				</select></td></tr>
		<tr><td bgcolor="#EEEFF0"><span class="textmedium">Error description:</span></td><td bgcolor="#EEEFF0"><textarea cols="25" rows="8" name="description"></textarea></td></tr>
		<tr><td bgcolor="#EEEFF0"><span class="textmedium">URL</span></td><td bgcolor="#EEEFF0"><input type="text" name="url" value="" /></td></tr>
		<tr><td bgcolor="#EEEFF0"><span class="textmedium">DNA UID</span></td><td bgcolor="#EEEFF0"><input type="text" name="dnaid" value="{/H2G2/VIEWING-USER/USER/USERID}" /></td></tr>
		<tr><td bgcolor="#EEEFF0"><span class="textmedium">Browser O/S</span></td><td bgcolor="#EEEFF0"><input type="text" name="browseros" value="" /></td></tr>
		<tr><td bgcolor="#EEEFF0"><span class="textmedium">Date</span></td><td bgcolor="#EEEFF0"><input type="text" name="date" value="{/H2G2/DATE/@DAY} {/H2G2/DATE/@MONTHNAME} {/H2G2/DATE/@YEAR}" /></td></tr>
		<tr><td bgcolor="#EEEFF0"></td><td bgcolor="#EEEFF0"><input type="submit" name="submit" /></td></tr>
		</table>		
