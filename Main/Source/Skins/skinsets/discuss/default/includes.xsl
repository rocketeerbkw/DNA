...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:msxsl="urn:schemas-microsoft-com:xslt"  xmlns:doc="http://www.bbc.co.uk/dna/documentation" exclude-result-prefixes="msxsl doc">
    ...
    <xsl:include href="pages/frontpage-editor.xsl" />
    ...
    <xsl:include href="pages/useredit.xsl" />
    <xsl:include href="pages/user-complaint.xsl" />
    <xsl:include href="pages/keyarticle-editor.xsl" />
    
    <xsl:include href="pages/uitemplatedefinition.xsl" />
    
    <!--   ============================================================= Inputs  ===                      -->
    
    <xsl:include href="inputs/article-edit-form.xsl" />
    <xsl:include href="inputs/frontpage-edit-form.xsl" />
    <xsl:include href="inputs/user-complaint-form.xsl" />
    <xsl:include href="inputs/commentbox.xsl" />
    <xsl:include href="inputs/closedate.xsl" />
    <xsl:include href="inputs/modstatus.xsl" />
    <xsl:include href="inputs/canwrite.xsl" />
    <xsl:include href="inputs/keyarticleform.xsl" />
    <xsl:include href="inputs/keyarticlelist.xsl" />
    ...
    <xsl:include href="objects/article/frontpage.xsl" />
    <xsl:include href="objects/article/generic.xsl" />
    <xsl:include href="objects/article/incomplete.xsl" />
    <xsl:include href="objects/article/keyarticlelist.xsl" />
    ...
    <xsl:include href="objects/commentforum/quicklist.xsl" />
    ...
    <xsl:include href="objects/editor-site-list.xsl" />
    <xsl:include href="objects/site/option.xsl" />
