...
namespace FunctionalTests.Services.Forums
{
    ...
    public class ForumThreadPosts_V1
    {
        ...
        public void GetThreadPostXml_WithValidID_ReturnsDeserializableObject()
        {
            ...
            Assert.AreEqual(@"Dough.. the $tuff that buys me beer,<BR />Ray.. the guy who sells me beer, *<BR />Me.. the guy who drinks the beer,<BR />Fa(r).. the distance to my beer,<BR />So.. I think I'll have a beer,<BR />La.. la la la la la beer,<BR />Tea.. no thanks I'm drinking beer!<BR /><BR />That will bring us back to .... [looks at empty glass] d'oh! <BR /><BR />&lt;kiss&gt;&lt;kiss&gt;", threadPost.Text);
