...
namespace FunctionalTests
{
    ...
    public class UserDetailsTests
    {
        ...
        /// </summary>
        [TestMethod]
        public void UserDetailsBuilder_SetSiteSuffixOnKids_ExpectsSiteSuffixNotSet()
        {
            try
            {
                Console.WriteLine("Before UserDetailsTests - UserDetailsBuilder_SetSiteSuffixOnKids_ExpectsSiteSuffixNotSet");
                RevertSiteSpecificDisplayNameToBlank();
                SignalAndWaitforSiteOptionToBeSet("h2g2", 1, "General", "IsKidsSite", "1");
                SignalAndWaitforSiteOptionToBeSet("h2g2", 1, "User", "AutoGeneratedNames", "http://bbc.co.uk");
                ...
                Assert.IsNotNull(xml.SelectSingleNode("/H2G2/USER-DETAILS-FORM/PREFERENCES/SITESUFFIX"), "Failed to find SiteSuffix in xml");
                Assert.AreEqual("", xml.SelectSingleNode("/H2G2/USER-DETAILS-FORM/PREFERENCES/SITESUFFIX").InnerText, "SiteSuffix should not have been changed!");

                RevertSiteSpecificDisplayNameToBlank();


                Console.WriteLine("After UserDetailsTests - UserDetailsBuilder_SetSiteSuffixOnKids_ExpectsSiteSuffixNotSet");
            }
            finally
            {
                SignalAndWaitforSiteOptionToBeSet("h2g2", 1, "General", "IsKidsSite", "0");
                SignalAndWaitforSiteOptionToBeSet("h2g2", 1, "User", "AutoGeneratedNames", "");
            }
        }
