...
namespace FunctionalTests.Services.Articles
{
    ...
    <BODY>Sample Article Content</BODY>
        ...
        [TestMethod]
        public void UpdateArticleWithHTML()
        {
            string h2g2id = "559";
            string style = "GuideML";
            string subject = "Test Subject";
...
<text>{3}</text>
        ...
        [TestMethod, Ignore]
        public void CreateArticle_With_EmptyGuideML()
        {
            DnaTestURLRequest request = new DnaTestURLRequest(_sitename);
            request.AssertWebRequestFailure = false;
            request.SetCurrentUserNormal();
...
<text>{3}</text>
        ...
        /// <summary>
        /// Test SubmitArticle method from service
        /// </summary>
        [TestMethod]
        public void SubmitArticle()
        {
            Console.WriteLine("Before SubmitArticle");
            ...
            Console.WriteLine("After SubmitArticle");
        }
        ...
        /// </summary>
        [TestMethod]
        public void SubmitArticleWithNoComments()
        {
            Console.WriteLine("Before SubmitArticleWithNoComments");
            ...
            Console.WriteLine("After SubmitArticleWithNoComments");
        }
