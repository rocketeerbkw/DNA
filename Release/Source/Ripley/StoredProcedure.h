...
public:
	...
	bool GetPostContents(int iReplyTo, int iUserID, int* iForumID, int* iThreadID, CTDVString* sUsername, CTDVString* sBody, CTDVString* pSubject, bool* oCanRead, bool* oCanWrite, int* oPostStyle, int* oPostIndex, int* oUserID);
	...
	bool SynchroniseUserWithProfile(CTDVString* pFirstNames, CTDVString* pLastName, int iUserID, 
		const TDVCHAR* sEmail, const TDVCHAR* sLoginName, int iSiteID, CTDVString* pDisplayName, BOOL bIdentitySite);
