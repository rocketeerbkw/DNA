...
<xsl:variable name="thisserver"><xsl:value-of select="$baseurl" /></xsl:variable>
<!-- <xsl:variable name="thisserver">http://local.bbc.co.uk</xsl:variable> -->
<xsl:variable name="foreignserver"><xsl:value-of select="$baseurl" /></xsl:variable>
...
<xsl:variable name="sso_redirectserver"><xsl:value-of select="$baseurl" /></xsl:variable>
