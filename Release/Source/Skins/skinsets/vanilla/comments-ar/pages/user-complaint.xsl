    ...
    <xsl:template match="/H2G2[@TYPE = 'USER-COMPLAINT'] | /H2G2[@TYPE = 'USERCOMPLAINTPAGE']" mode="page">
        ...
        <html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en-GB" lang="en-GB">
            <head profile="http://dublincore.org/documents/dcq-html/">
              ...
              <title>الشكاوى بي بي سي</title>
                ...
                <style type="text/css">
                  ...
                  .rtl #blq-main {margin: 0 auto;padding: 0 14px 14px 0;}
                  .rtl h1 {padding: 10px 8px 0 14px;}
            ...
            <body>
                ...
                <div id="blq-container" class="rtl">
                    <div id="blq-main"  dir="rtl">

                      <h1 >الشكاوى بي بي سي</h1>
