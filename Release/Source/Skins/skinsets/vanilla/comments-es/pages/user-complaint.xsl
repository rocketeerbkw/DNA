...
<xsl:stylesheet 
    ...
    <xsl:template match="/H2G2[@TYPE = 'USER-COMPLAINT'] | /H2G2[@TYPE = 'USERCOMPLAINTPAGE']" mode="page">
        ...
        <html xmlns="http://www.w3.org/1999/xhtml" xml:lang="bn-BD" lang="bn-BD">
            <head profile="http://dublincore.org/documents/dcq-html/">
                
                <title>BBC Bangla - অভিযোগ</title>
				...
				<link rel="stylesheet" href="/worldservice/comments/bn_complaints.css" type="text/css" />
