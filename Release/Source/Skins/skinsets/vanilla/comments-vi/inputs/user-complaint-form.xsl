    ...
    <xsl:template match="USER-COMPLAINT-FORM[/H2G2/PARAMS/PARAM[NAME = 's_start'][VALUE = 2]] | USERCOMPLAINT[/H2G2/PARAMS/PARAM[NAME = 's_start'][VALUE = 2]]" mode="input_user-complaint-form">
        <form action="UserComplaintPage" method="post" id="complaintForm"> 
            ...
            <div class="content">
              ...
              <p>
                Tôi tin rằng <xsl:call-template name="item_name"/> đã vi phạm một trong điều <a href="{$houserulespopupurl}">Quy định nội bộ</a> bởi vì nó đã
              </p>
            ...
            <div class="content">
              <xsl:choose>
                ...
                <p class="action">
                    ...
                    <input type="hidden" name="action" value="Gửi"/>
