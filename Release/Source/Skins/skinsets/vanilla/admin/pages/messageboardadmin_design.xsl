        ...
        <div class="dna-box-border">
          ...
          <p>
            <xsl:choose>
              ...
              <xsl:otherwise>
                <strong>Header colour by default </strong> blue.
              </xsl:otherwise>
            </xsl:choose>
          </p>
            ...
            <div class="dna-box-border">
              ...
              <xsl:choose>
                <xsl:when test="SITECONFIGPREVIEW/SITECONFIG/V2_BOARDS/LEFT_NAV_SSI">
                  <p>
                    <strong>Left navigation included: </strong>
                  </p>
                      ...
                      <xsl:choose>
                        <xsl:when test="/H2G2/SITECONFIGPREVIEW/SITECONFIG/V2_BOARDS/TOPICLAYOUT = '2col'">
                          <ul class="dna-list-topic-col1">
                            <xsl:apply-templates select="/H2G2/TOPIC_PAGE/TOPICLIST[@STATUS='Preview']/TOPIC[position() mod 2 = 1]" mode="object_topiclist_elements" />
                          </ul>
                          <ul class="dna-list-topic-col2">
                            <xsl:apply-templates select="/H2G2/TOPIC_PAGE/TOPICLIST[@STATUS='Preview']/TOPIC[position() mod 2 = 0]" mode="object_topiclist_elements" />
                          </ul>
                        </xsl:when>
                        <xsl:otherwise>
