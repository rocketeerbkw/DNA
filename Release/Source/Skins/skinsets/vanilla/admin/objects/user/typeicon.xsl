...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:doc="http://www.bbc.co.uk/dna/documentation"  exclude-result-prefixes="doc">
  ...
  <xsl:template match="TYPE | USERSTATUSDESCRIPTION" mode="objects_user_typeicon" >
      <xsl:choose>
        ...
        <xsl:when test="text() = 'UserModeratedPremod' or (text() = 'Premoderate' and parent::USERACCOUNT/ACTIVE = '1')">
        ...
        <xsl:when test="text() = 'UserModeratedPostMod' or (text() = 'Postmoderate' and parent::USERACCOUNT/ACTIVE = '1')">
        ...
        <xsl:when test="text() = 'UserModeratedBanned' or (text() = 'Banned' and parent::USERACCOUNT/ACTIVE = '1')">
        ...
        <xsl:otherwise>
          ...
          <xsl:if test="/H2G2/@TYPE = 'USERLIST' and parent::USERACCOUNT/ACTIVE = '0'"><img src="/dnaimages/dna_messageboard/img/icons/deactivated_user.png" width="30" height="30" alt="deactivated user" title="deactivated user" /></xsl:if>
        </xsl:otherwise>
