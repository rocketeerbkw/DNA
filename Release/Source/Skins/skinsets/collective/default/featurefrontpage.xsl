...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:local="#local-functions" xmlns:s="urn:schemas-microsoft-com:xml-data" xmlns:dt="urn:schemas-microsoft-com:datatypes" exclude-result-prefixes="msxsl local s dt">
	...
	++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	-->
	<xsl:template name="FEATURE_MAINBODY">
	
	<!-- DEBUG -->
	<xsl:call-template name="TRACE">
	<xsl:with-param name="message">FEATURE_MAINBODY test variable = <xsl:value-of select="$current_article_type" /></xsl:with-param>
	<xsl:with-param name="pagename">featurefrontpage.xsl</xsl:with-param>
	</xsl:call-template>
	<!-- DEBUG -->
	...
	<p>
	<table width="70%" border="0" cellspacing="0" cellpadding="0" class="generic-n">
	<tr>
...
<table width="590" border="0" cellspacing="0" cellpadding="0"><tr>
	...
	<div class="rssImage">
	<xsl:element name="A">
<xsl:attribute name="HREF"><xsl:value-of select="$root" />xml/features?s_xml=rss</xsl:attribute>
