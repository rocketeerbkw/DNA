...
namespace DnaIdentityWebServiceProxy
{
    ...
    public partial class ProfileAPI : IDnaIdentityWebServiceProxy, IDisposable
    {
        ...
        public string GetAppNameSpacedAttribute(string cookie, string appNameSpace, string attributeName) { return ""; }
        ...
        public bool DoesAppNameSpacedAttributeExist(string cookie, string appNameSpace, string attributeName) { return false; }
    }
}
