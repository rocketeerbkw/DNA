namespace BBC.Dna.Services
{
    ...
    public class DnaWebServiceHost : WebServiceHost
    {
        Collection<RequestInterceptor> interceptors = new Collection<RequestInterceptor>();

        public DnaWebServiceHost(object singletonInstance, params Uri[] baseAddresses)
        ...
        public DnaWebServiceHost(Type serviceType, bool dummy, params Uri[] baseAddresses)
        ...
        protected override void OnOpening()
        {
            ...
            foreach (var ep in this.Description.Endpoints)
            {
                if (ep.Behaviors.Find<WebHttpBehavior>() != null)
                {
                    ...
                    ep.Behaviors.Add(new DnaWebHttpBehavior() { EnableAspNetCustomErrors = this.EnableAspNetCustomErrors, EnableAutomaticHelpPage = this.EnableAutomaticHelpPage, HelpPageLink = this.HelpPageLink });
                }
