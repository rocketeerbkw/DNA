CREATE PROCEDURE getnumberofusersubmittednotices @siteid INT, @startdate datetime, @enddate datetime
AS
	/* Returns the number of user submitted notices that were submitted within a date range. */
