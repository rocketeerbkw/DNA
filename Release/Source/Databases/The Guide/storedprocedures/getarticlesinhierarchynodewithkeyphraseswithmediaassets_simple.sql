...
*/
CREATE PROCEDURE getarticlesinhierarchynodewithkeyphraseswithmediaassets_simple @nodeid INT, @maxresults INT = 500, 
	@currentsiteid int = 0
AS
BEGIN
...
--			LEFT JOIN dbo.KeyPhrases kp ON akp.PhraseID = kp.PhraseID 		
