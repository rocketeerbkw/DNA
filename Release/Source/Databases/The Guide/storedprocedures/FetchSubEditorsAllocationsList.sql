/*
	Returns a list of entries allocated to this sub editor with details of
	of the entry, its recommendation, and its subbing.
*/

create procedure fetchsubeditorsallocationslist
	@subid int,
	@unittype varchar(50),
	@numberofunits int,
	@siteid int = 0
...
inner join Users U3 on U3.UserID = AR.SubEditorID
...
where AR.SubEditorID = @subid and SR.DateRecommended > @Date
