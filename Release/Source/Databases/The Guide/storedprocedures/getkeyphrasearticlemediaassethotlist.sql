/*********************************************************************************
	...
	create procedure getkeyphrasearticlemediaassethotlist @keyphraselist VARCHAR(8000), @siteid int, @firstindex int, @lastindex int as
	...
	Outputs:	
	Purpose:	Get a tag cloud based on the provided site and phrases filter for articles
				that have media assets
	
*********************************************************************************/
CREATE PROCEDURE getkeyphrasearticlemediaassethotlist @siteid int, @skip int = 0, @show int = 500, @sortbyphrase bit = null
AS
	...
	create table #temphotlist (id int NOT NULL IDENTITY(0,1)PRIMARY KEY, Phrase varchar(100) NOT NULL, PhraseCount FLOAT NOT NULL)
