...
namespace FunctionalTests
{
    ...
    public class mimeType
    {
        ...
        /// </summary>
        [Ignore]
        // it actually return UnsupportedMediaType
        public void MimeType_none()
        {
            ...
            Console.WriteLine("After mimeType - MimeType_none");
        }
        ...
        /// <summary>
        /// application/json, format is specified
        /// </summary> 
        [Ignore]
        // it may be that the post data is malformed, or it may be that the code is not yet written?
        public void MimeType_jsApplic()
        {
            Console.WriteLine("Before mimeType - MimeType_jsApplic");

            // test variants
            string mimeType = "application/json";
            HttpStatusCode expectedCode = HttpStatusCode.OK;
            string fileName = "create.htm"; // used on the HTML-form thing
            string formatFrag = "XML";
            ...
            Assert.IsNotNull(returnedRating.User);
            Assert.IsTrue(returnedRating.User.UserId == myRequest.CurrentUserID);
            Console.WriteLine("After mimeType - MimeType_jsApplic");
        }

        /// <summary>
        /// application/json, but the input is actually XML - should fail???
        /// </summary> 
        [Ignore]
        //
        public void MimeType_inconsistent()
        {
            Console.WriteLine("Before mimeType - MimeType_inconsistent");
            ...
            Assert.IsNotNull(returnedRating.User);
            Assert.IsTrue(returnedRating.User.UserId == myRequest.CurrentUserID);
            Console.WriteLine("After mimeType - MimeType_inconsistent");
        }
