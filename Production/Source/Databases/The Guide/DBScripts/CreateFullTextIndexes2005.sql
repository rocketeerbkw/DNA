/*
-- Run these lines as part of the release process:

-- Recreate full text indexes on any indexed views, as they get destroyed after the "views-Script.sql" is run
...
-- Take a release as an opportunity to rebuild the active catalogues
