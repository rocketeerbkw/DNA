/*********************************************************************************
	...
	create procedure getkeyphrasearticlemediaassethotlistwithphrase @keyphraselist VARCHAR(8000), @siteid int, @firstindex int, @lastindex int as
	...
	Outputs:	
	Purpose:	Get a tag cloud based on the provided site and phrases filter for
				articles that have a meduia asset attached.
	
*********************************************************************************/
Create Procedure getkeyphrasearticlemediaassethotlistwithphrase @siteid int, @keyphraselist VARCHAR(500), @skip int = 0, @show int = 500, @sortbyphrase bit = null
AS
...
SELECT CAST(@count AS INT) 'count', Rank, Phrase, PhraseId, SortByPhrase FROM @temphotphrases
