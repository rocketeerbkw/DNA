/*********************************************************************************
	...
	create procedure getkeyphrasearticleaudioassethotlist @keyphraselist VARCHAR(8000), @siteid int, @firstindex int, @lastindex int as
	...
	Outputs:	
	Purpose:	Get an articles with audio assets tag cloud based on the provided site and phrases filter.
	
*********************************************************************************/
CREATE PROCEDURE getkeyphrasearticleaudioassethotlist @siteid int, @skip int = 0, @show int = 500, @sortbyphrase bit = null
AS
