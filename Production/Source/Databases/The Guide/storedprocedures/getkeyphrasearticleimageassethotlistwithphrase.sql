/*********************************************************************************
	...
	create procedure getkeyphrasearticleimageassethotlistwithphrase @keyphraselist VARCHAR(8000), @siteid int, @firstindex int, @lastindex int as
	...
	Outputs:	
	Purpose:	Get an article with image asset tag cloud based on the provided site and phrases filter.
	
*********************************************************************************/
Create Procedure getkeyphrasearticleimageassethotlistwithphrase @siteid int, @keyphraselist VARCHAR(500), @skip int = 0, @show int = 500, @sortbyphrase bit = null
AS
