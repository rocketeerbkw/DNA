...
namespace BBC.Dna
{
    ...
    public class User : DnaInputComponent, IUser
    {
        ...
        {
            bool isKidsSite = InputContext.GetSiteOptionValueBool("General", "IsKidsSite");
            if (isKidsSite && InputContext.GetSiteOptionValueBool("CommentForum", "UseIDv4"))
            {
                _siteSuffix = _userName;
                UpdateUserSiteSuffix(_siteSuffix);
            }
            else
            {
                ...
                if (autoGenURL.Length > 0)
                {
                    ...
                    if (InputContext.GetCurrentSignInObject.DoesAppNameSpacedAttributeExist(InputContext.GetCookie("IDENTITY").Value, attribNameSpace, attribName))
                    {
                        ...
                        {
                            UpdateUserSiteSuffix(siteSuffix);
        ...
        private void UpdateUserSiteSuffix(string siteSuffix)
        {
