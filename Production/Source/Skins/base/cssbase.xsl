...
<xsl:variable name="showtreegadget"><xsl:choose><xsl:when test="number(/H2G2/VIEWING-USER/USER/USER-MODE) = 1">1</xsl:when><xsl:otherwise>0</xsl:otherwise></xsl:choose></xsl:variable>
...
<xsl:variable name="viewerid"><xsl:value-of select="/H2G2/VIEWING-USER/USER/USERID"/></xsl:variable>
...
<xsl:variable name="h2g2graphics"><xsl:value-of select="$foreignserver"/>/h2g2/blobs/</xsl:variable>
<xsl:variable name="smileysource"><xsl:value-of select="$imagesource"/></xsl:variable>
...
<GROUPBADGE NAME="SUBS">
	<a href="{$root}SubEditors"><xsl:value-of select="$m_subgroup"/></a>
</GROUPBADGE>
<GROUPBADGE NAME="ACES">
	<a href="{$root}Aces"><xsl:value-of select="$m_acesgroup"/></a>
</GROUPBADGE>
<GROUPBADGE NAME="FIELDRESEARCHERS">
	<a href="{$root}University"><xsl:value-of select="$m_researchersgroup"/></a>
</GROUPBADGE>
<GROUPBADGE NAME="SECTIONHEADS">
	<a href="{$root}SectionHeads"><xsl:value-of select="$m_sectionheadgroup"/></a>
</GROUPBADGE>
<GROUPBADGE NAME="GURUS">
	<a href="{$root}Gurus"><xsl:value-of select="$m_GurusGroup"/></a>
</GROUPBADGE>
<GROUPBADGE NAME="SCOUTS">
	<a href="{$root}Scouts"><xsl:value-of select="$m_ScoutsGroup"/></a>
</GROUPBADGE>
...
<table vspace="0" hspace="0" border="0" cellpadding="0" cellspacing="0">
  <tr><td colspan="3" bgcolor="{$buttonbarbgcolour}" align="left" valign="top"><xsl:call-template name="buttons"/></td></tr>
  <tr>
  ...
  <td valign="top">
	...
	<xsl:comment><xsl:value-of select="SERVERNAME"/></xsl:comment>
...
<xsl:template match="H2G2[@TYPE='STATUSPAGE']">
	<html>
		<head><title>Ripley Status Report</title></head>
		<body>
			<h1>Status: <xsl:value-of select="/H2G2/STATUS-REPORT/STATUS"/></h1>
			<b>
...
<html>
<head>
<meta><xsl:attribute name="content">0;url=<xsl:value-of select="REDIRECT-TO"/></xsl:attribute>
<xsl:attribute name="http-equiv">REFRESH</xsl:attribute></meta>
</head>
...
<span xsl:use-attribute-sets="catfontheader"><B><xsl:value-of select="HIERARCHYDETAILS/DISPLAYNAME"/></B></span>
<A><xsl:attribute name="HREF"><xsl:value-of select="$root"/>editcategory?action=renamesubject&amp;nodeid=<xsl:value-of select="HIERARCHYDETAILS/@NODEID"/></xsl:attribute><br/><xsl:call-template name="m_EditCatRenameSubjectButton"/></A>
<br/>
...
<A><xsl:attribute name="HREF"><xsl:value-of select="$root"/>editcategory?action=addsubject&amp;nodeid=<xsl:value-of select="HIERARCHYDETAILS/@NODEID"/></xsl:attribute><xsl:call-template name="m_EditCatAddSubjectButton"/></A>
<br/>
<xsl:choose>
<xsl:when test="ACTIVENODE/@TYPE='article'">
<A><xsl:attribute name="HREF"><xsl:value-of select="$root"/>editcategory?action=storearticle&amp;nodeid=<xsl:value-of select="HIERARCHYDETAILS/@NODEID"/>&amp;activenode=<xsl:value-of select="ACTIVENODE/@ACTIVEID"/>&amp;delnode=<xsl:value-of select="ACTIVENODE/@DELNODE"/></xsl:attribute><xsl:attribute name="onclick">return window.confirm('You are about to store the article here');</xsl:attribute>Store the article "<xsl:value-of select="ACTIVENODE"/>" here</A>
</xsl:when>
<xsl:when test="ACTIVENODE/@TYPE='alias'">
<A><xsl:attribute name="HREF"><xsl:value-of select="$root"/>editcategory?action=storealias&amp;nodeid=<xsl:value-of select="HIERARCHYDETAILS/@NODEID"/>&amp;activenode=<xsl:value-of select="ACTIVENODE/@ACTIVEID"/>&amp;delnode=<xsl:value-of select="ACTIVENODE/@DELNODE"/></xsl:attribute><xsl:attribute name="onclick">return window.confirm('You are about to store the link here');</xsl:attribute>Move the link "<xsl:value-of select="ACTIVENODE"/>" here</A>
</xsl:when>
<xsl:when test="ACTIVENODE/@TYPE='subject'">
<A><xsl:attribute name="HREF"><xsl:value-of select="$root"/>editcategory?action=storesubject&amp;nodeid=<xsl:value-of select="HIERARCHYDETAILS/@NODEID"/>&amp;activenode=<xsl:value-of select="ACTIVENODE/@ACTIVEID"/></xsl:attribute><xsl:attribute name="onclick">return window.confirm('You are about to store the subject here');</xsl:attribute>Store the subject "<xsl:value-of select="ACTIVENODE"/>" here</A>
<br/>
<A><xsl:attribute name="HREF"><xsl:value-of select="$root"/>editcategory?action=doaddalias&amp;nodeid=<xsl:value-of select="HIERARCHYDETAILS/@NODEID"/>&amp;activenode=<xsl:value-of select="ACTIVENODE/@ACTIVEID"/></xsl:attribute><xsl:attribute name="onclick">return window.confirm('You are about to store the link here');</xsl:attribute>Store the link "<xsl:value-of select="ACTIVENODE"/>" here</A>
</xsl:when>
</xsl:choose>
...
New Name: <INPUT name="subject" type="TEXT"><xsl:attribute name="value"><xsl:value-of select="$displayname"/></xsl:attribute></INPUT>
<INPUT type="SUBMIT" value="Rename"/><BR/>
<INPUT name="action" type="HIDDEN" value="dorenamesubject"/>
<INPUT name="nodeid" type="HIDDEN"><xsl:attribute name="value"><xsl:value-of select="$nodeid"/></xsl:attribute></INPUT>
</FORM>
</xsl:when>
  ...
  <xsl:when test="USER-LIST/USER">
   ...
   <xsl:choose>
    <xsl:when test="USER-LIST/@SKIP &gt; 0 or USER-LIST/@SKIPTO &gt; 0">
     <a href="{$root}NewUsers?unittype={@UNITTYPE}&amp;timeunits={@TIMEUNITS}&amp;skip={number((USER-LIST/@SKIP|USER-LIST/@SKIPTO)[1]) - number(USER-LIST/@SHOW)}{$thissiteflag}&amp;{$filter}"><xsl:value-of select="$m_OlderRegistrations"/></a>
    </xsl:when>
    <xsl:otherwise><xsl:value-of select="$m_NoOlderRegistrations"/></xsl:otherwise>
   </xsl:choose>
   <xsl:value-of select="$m_RegistrationsSeparater"/>
   <xsl:choose>
    <xsl:when test="USER-LIST/@MORE=1">
     <a href="{$root}NewUsers?unittype={@UNITTYPE}&amp;timeunits={@TIMEUNITS}&amp;skip={number((USER-LIST/@SKIP|USER-LIST/@SKIPTO)[1]) + number(USER-LIST/@SHOW)}{$thissiteflag}&amp;{$filter}"><xsl:value-of select="$m_NewerRegistrations"/></a>
    </xsl:when>
    <xsl:otherwise><xsl:value-of select="$m_NoNewerRegistrations"/></xsl:otherwise>
   </xsl:choose>
   <br/><br/>
   <table border="0" cellspacing="2" cellpadding="0">
    <tr>
     <td align="right"><xsl:value-of select="$m_userhasmastheadflag"/></td>
     <td align="left"><xsl:value-of select="$m_userhasmastheadfootnote"/></td>
    </tr>
    <tr>
     <td align="right"><xsl:value-of select="$m_userhasmastheadflag"/><xsl:value-of select="$m_usersintropostedtoflag"/></td>
     <td align="left"><xsl:value-of select="$m_usersintropostedtofootnote"/></td>
    </tr>
   </table>
  </xsl:when>
  <!-- otherwise display a message saying no users have registered in that
time -->
  <xsl:otherwise><xsl:call-template name="m_NewUsersListingEmpty"/></xsl:otherwise>
 </xsl:choose>
</xsl:template>
...
<xsl:template match="NEWUSERS-LISTINGggg">
	...
	<xsl:choose>
		...
		<xsl:when test="USER-LIST/USER">
			...
			<xsl:choose>
				<xsl:when test="USER-LIST/@SKIP &gt; 0 or USER-LIST/@SKIPTO &gt; 0">
					<a><xsl:attribute name="HREF"><xsl:value-of select="$root"/>NewUsers?unittype=<xsl:value-of select="@UNITTYPE"/>&amp;timeunits=<xsl:value-of select="@TIMEUNITS"/>&amp;skip=<xsl:value-of select="number((USER-LIST/@SKIP|USER-LIST/@SKIPTO)[1]) - number(USER-LIST/@SHOW)"/>&amp;OnlyIntros=<xsl:value-of select="$OnlyIntrosFlag"/></xsl:attribute><xsl:value-of select="$m_NewerRegistrations"/></a>
				</xsl:when>
				<xsl:otherwise><xsl:value-of select="$m_NoNewerRegistrations"/></xsl:otherwise>
			</xsl:choose>
			<xsl:value-of select="$m_RegistrationsSeparater"/>
			<xsl:choose>
				<xsl:when test="USER-LIST/@MORE=1">
					<a><xsl:attribute name="HREF"><xsl:value-of select="$root"/>NewUsers?unittype=<xsl:value-of select="@UNITTYPE"/>&amp;timeunits=<xsl:value-of select="@TIMEUNITS"/>&amp;skip=<xsl:value-of select="number((USER-LIST/@SKIP|USER-LIST/@SKIPTO)[1]) + number(USER-LIST/@SHOW)"/>&amp;OnlyIntros=<xsl:value-of select="$OnlyIntrosFlag"/></xsl:attribute><xsl:value-of select="$m_OlderRegistrations"/></a>
				</xsl:when>
				<xsl:otherwise><xsl:value-of select="$m_NoOlderRegistrations"/></xsl:otherwise>
			</xsl:choose>
			<br/><br/>
	...
	<xsl:choose>
		<xsl:when test="ERROR">
			<xsl:choose>
				...
				<xsl:otherwise>
						<xsl:value-of select="$m_RecommendEntryUnspecifiedError"/><br/><br/>
						<xsl:apply-templates select="ERROR"/>
				</xsl:otherwise>
			</xsl:choose>
		</xsl:when>
		<xsl:otherwise>
			...
			<form name="RecommendEntryForm" method="post" action="{$root}RecommendEntry">
				...
				<xsl:if test="number(H2G2ID) != 0">
						<a target="_blank"><xsl:attribute name="HREF"><xsl:value-of select="$root"/>A<xsl:value-of select="H2G2ID"/></xsl:attribute>A<xsl:value-of select="H2G2ID"/></a>
						<xsl:text> : </xsl:text><b><xsl:value-of select="SUBJECT"/></b>
						<xsl:text> by </xsl:text><xsl:apply-templates select="EDITOR/USER"/>
					<br/><br/>
				</xsl:if>
				<xsl:if test="FUNCTIONS/RECOMMEND-ENTRY">
					...
					<br/><br/><br/>
						...
						</input>				<xsl:if test="FUNCTIONS/FETCH-ENTRY">
	...
	<xsl:choose>
		<xsl:when test="ERROR">
			<xsl:choose>
				...
				<xsl:otherwise>
						<xsl:value-of select="$m_SubbedEntryUnspecifiedError"/><br/><br/>
						<xsl:apply-templates select="ERROR"/>
				</xsl:otherwise>
			</xsl:choose>
		</xsl:when>
...
<div align="center">
<b><xsl:value-of select="$m_otherconv"/></b>
</div>
...
<xsl:when test="FORUMTHREADS">
						...
						<div align="center">
						<b><xsl:value-of select="$m_currentconv"/></b>
						</div>
...
<xsl:param name="more">0</xsl:param>
	...
	<span xsl:use-attribute-sets="navbuttons">
		<xsl:apply-templates select="FORUMTHREADPOSTS/@SKIPTO" mode="navbuttons">
			...
			<xsl:with-param name="navbuttonsspacer"><xsl:text> | </xsl:text></xsl:with-param>
...
<a target="_top" href="{$root}FSB{FORUMTHREADHEADERS/@FORUMID}?thread={FORUMTHREADHEADERS/@THREADID}&amp;skip={FORUMTHREADHEADERS/@SKIPTO}&amp;show={FORUMTHREADHEADERS/@COUNT}&amp;cmd=unsubscribethread&amp;page=normal&amp;desc={$alt_subreturntoconv}&amp;return=F{FORUMTHREADHEADERS/@FORUMID}%3Fthread={FORUMTHREADHEADERS/@THREADID}%26amp;skip={FORUMTHREADHEADERS/@SKIPTO}%26amp;show={FORUMTHREADHEADERS/@COUNT}"><xsl:value-of select="$m_clickunsubscribe"/></a>
</xsl:when>
<xsl:otherwise>
<a target="_top" href="{$root}FSB{FORUMTHREADHEADERS/@FORUMID}?thread={FORUMTHREADHEADERS/@THREADID}&amp;skip={FORUMTHREADHEADERS/@SKIPTO}&amp;show={FORUMTHREADHEADERS/@COUNT}&amp;cmd=subscribethread&amp;page=normal&amp;desc={$alt_subreturntoconv}&amp;return=F{FORUMTHREADHEADERS/@FORUMID}%3Fthread={FORUMTHREADHEADERS/@THREADID}%26amp;skip={FORUMTHREADHEADERS/@SKIPTO}%26amp;show={FORUMTHREADHEADERS/@COUNT}"><xsl:value-of select="$m_clicksubscribe"/></a>
</xsl:otherwise>
</xsl:choose>
</xsl:if>
</xsl:template>
...
<a target="_top" href="{$root}FSB{FORUMTHREADHEADERS/@FORUMID}?thread={FORUMTHREADHEADERS/@THREADID}&amp;skip={FORUMTHREADHEADERS/@SKIPTO}&amp;show={FORUMTHREADHEADERS/@COUNT}&amp;cmd=unsubscribeforum&amp;page=normal&amp;desc={$alt_subreturntoconv}&amp;return=F{FORUMTHREADHEADERS/@FORUMID}%3Fthread={FORUMTHREADHEADERS/@THREADID}%26amp;skip={FORUMTHREADHEADERS/@SKIPTO}%26amp;show={FORUMTHREADHEADERS/@COUNT}"><xsl:value-of select="$m_clickunsubforum"/></a>
</xsl:when>
<xsl:otherwise>
<a target="_top" href="{$root}FSB{FORUMTHREADHEADERS/@FORUMID}?thread={FORUMTHREADHEADERS/@THREADID}&amp;skip={FORUMTHREADHEADERS/@SKIPTO}&amp;show={FORUMTHREADHEADERS/@COUNT}&amp;cmd=subscribeforum&amp;page=normal&amp;desc={$alt_subreturntoconv}&amp;return=F{FORUMTHREADHEADERS/@FORUMID}%3Fthread={FORUMTHREADHEADERS/@THREADID}%26amp;skip={FORUMTHREADHEADERS/@SKIPTO}%26amp;show={FORUMTHREADHEADERS/@COUNT}"><xsl:value-of select="$m_clicksubforum"/></a>
</xsl:otherwise>
</xsl:choose>
<br/><br/>
</xsl:if>
...
<xsl:param name="DeNotify"><xsl:value-of select="$m_clickstopnotifynewconv"/></xsl:param>
<xsl:if test="$registered=1">
<a target="_top">
<xsl:attribute name="HREF"><xsl:value-of select="$root"/>FSB<xsl:value-of select="$ForumID"/>?cmd=subscribeforum&amp;page=normal&amp;desc=<xsl:value-of select="$Desc"/>&amp;return=<xsl:value-of select="$URL"/><xsl:value-of select="$ID"/></xsl:attribute><xsl:value-of select="$Notify"/>
</a>
<br/>
<a target="_top">
<xsl:attribute name="HREF"><xsl:value-of select="$root"/>FSB<xsl:value-of select="$ForumID"/>?cmd=unsubscribeforum&amp;page=normal&amp;desc=<xsl:value-of select="$Desc"/>&amp;return=<xsl:value-of select="$URL"/><xsl:value-of select="$ID"/></xsl:attribute><xsl:value-of select="$DeNotify"/>
</a>
<br/>
</xsl:if>
</xsl:template>
...
<xsl:template name="RECOMMEND-ENTRY-POPUP">
	<html>
		<head>
			<META NAME="robots" CONTENT="{$robotsetting}"/>
			<title><xsl:value-of select="$m_RecommendEntryPageTitle"/></title>
		</head>
		<body xsl:use-attribute-sets="body">
...
<xsl:template name="SUBMIT-SUBBED-ENTRY">
	<html>
		<head>
			<META NAME="robots" CONTENT="{$robotsetting}"/>
			<title><xsl:value-of select="$m_SubbedEntryPageTitle"/></title>
		</head>
		<body xsl:use-attribute-sets="body">
...
<xsl:template match="ONLINEUSERS">
	<HTML>
		<HEAD>
			<TITLE><xsl:value-of select="$m_onlinetitle"/></TITLE>
		...
		<body>
			<table border="0" cellspacing="0" cellpadding="0">
				<form name="WhosOnlineForm" method="get" action="{$root}Online" title="{$alt_onlineform}">
					<tr>
						<td><span xsl:use-attribute-sets="onlinefont"><xsl:value-of select="$m_onlineorderby"/></span></td>
						<td>
							<input type="radio" name="orderby" value="id" onclick="document.WhosOnlineForm.submit()" title="{$alt_onlineorderbyid}">
								<xsl:if test="@ORDER-BY='id'"><xsl:attribute name="checked">checked</xsl:attribute></xsl:if>
							</input>
						</td>
						<td><span xsl:use-attribute-sets="onlinefont"><xsl:value-of select="$m_onlineidradiolabel"/></span></td>
						<td>
							<input type="radio" name="orderby" value="name" onclick="document.WhosOnlineForm.submit()" title="{$alt_onlineorderbyname}">
								<xsl:if test="@ORDER-BY='name'"><xsl:attribute name="checked">checked</xsl:attribute></xsl:if>
							</input>
						</td>
						<td><span xsl:use-attribute-sets="onlinefont"><xsl:value-of select="$m_onlinenameradiolabel"/></span></td>
					</tr>
				</form>
			</table>
			<span xsl:use-attribute-sets="onlinefont">
				<xsl:choose>
					<xsl:when test="count(ONLINEUSER)=1">
						<xsl:value-of select="count(ONLINEUSER)"/><xsl:value-of select="$m_useronline"/><br/>
					</xsl:when>
					<xsl:otherwise>
						<xsl:value-of select="count(ONLINEUSER)"/><xsl:value-of select="$m_usersonline"/><br/>
					</xsl:otherwise>
				</xsl:choose>
				<xsl:choose>
...
<xsl:with-param name="text"><xsl:value-of select="$m_totalregusers"/></xsl:with-param>
</xsl:call-template>
<blockquote>
<xsl:value-of select="TOTALREGUSERS"/><xsl:value-of select="$m_usershaveregistered"/><br/>
<br/>
</blockquote>
...
-->
<xsl:call-template name="HEADER">
<xsl:with-param name="text"><xsl:value-of select="$m_editedentries"/></xsl:with-param>
</xsl:call-template>
<blockquote>
<xsl:value-of select="$m_therearecurrently"/><xsl:value-of select="APPROVEDENTRIES"/><xsl:value-of select="$m_editedinguide"/><br/>
<br/>
</blockquote>
...
-->
<xsl:call-template name="HEADER">
<xsl:with-param name="text"><xsl:value-of select="$m_toptwentyupdated"/></xsl:with-param>
</xsl:call-template>
<blockquote>
...
<xsl:call-template name="HEADER">
<xsl:with-param name="text"><xsl:value-of select="$m_toptenupdatedarticles"/></xsl:with-param>
</xsl:call-template>
<blockquote>
...
<xsl:template match="LONGPOST">
<A><xsl:attribute name="HREF"><xsl:value-of select="$root"/>F<xsl:value-of select="FORUMID"/>?thread=<xsl:value-of select="THREADID"/>&amp;post=<xsl:value-of select="POSTID"/>#p<xsl:value-of select="POSTID"/></xsl:attribute><xsl:value-of select="POSTSUBJECT"/></A> by <xsl:value-of select="USERNAME"/> (<xsl:value-of select="TOTALLENGTH"/><xsl:value-of select="$m_letters"/>)<br/>
</xsl:template>
...
<A HREF="{$root}F{FORUMID}?thread={THREADID}&amp;latest=1"><xsl:value-of select="FIRSTSUBJECT"/></A> (<xsl:apply-templates select="DATEPOSTED"/>)<br/>
</xsl:template>

<xsl:template match="RECENTARTICLE">
<xsl:text>A</xsl:text><xsl:value-of select="H2G2ID"/>
&nbsp;
<A HREF="{$root}A{H2G2ID}"><xsl:value-of select="SUBJECT"/></A>
&nbsp;
<xsl:choose>
<xsl:when test="STATUS[.='1']"><xsl:value-of select="$m_edited"/></xsl:when>
<xsl:when test="STATUS[.='3']"><xsl:value-of select="$m_unedited"/></xsl:when>
<xsl:otherwise/>
</xsl:choose>
&nbsp;
...
<xsl:attribute name="SRC">/FFU<xsl:value-of select="@FORUM"/>?thread=<xsl:value-of select="@THREAD"/>&amp;post=<xsl:value-of select="@POST"/>&amp;skip=<xsl:value-of select="@SKIP"/>&amp;show=<xsl:value-of select="@SHOW"/></xsl:attribute>
		...
		<FRAMESET ROWS="25,100%">
			<FRAME><xsl:attribute name="SRC">/FFS<xsl:value-of select="@FORUM"/>?thread=<xsl:value-of select="@THREAD"/>&amp;post=<xsl:value-of select="@POST"/>&amp;skip=<xsl:value-of select="@SKIP"/>&amp;show=<xsl:value-of select="@SHOW"/></xsl:attribute>
	<xsl:attribute name="SCROLLING">no</xsl:attribute>
	</FRAME>
	<FRAME><xsl:attribute name="SRC">/FLR<xsl:value-of select="@FORUM"/>?thread=<xsl:value-of select="@THREAD"/>&amp;<xsl:if test="@POST &gt; 0">post=<xsl:value-of select="@POST"/>&amp;</xsl:if>skip=<xsl:value-of select="@SKIP"/>&amp;show=<xsl:value-of select="@SHOW"/></xsl:attribute>
...
<map name="top_copy">
  <area><xsl:attribute name="shape">rect</xsl:attribute>
...
<TABLE width="100%" CELLPADDING="0" CELLSPACING="0"><form method="GET" action="{$root}Search" target="_top">
<TR><TD>
<span xsl:use-attribute-sets="buttons">
<SPAN STYLE="text-decoration:none;font-size:11px;color:#ffffff">
<input type="hidden" name="searchtype" value="goosearch"/><input type="text" name="searchstring" value=""/>
...
<TR><TD bgcolor="{$topbar}" height="1"/></TR>
<TR><TD bgcolor="{$topbar}" CELLPADDING="0" CELLSPACING="0">
<span xsl:use-attribute-sets="buttons">
<SPAN class="buttons">
<a href="{$root}{$pageui_sitehome}" target="_top"><xsl:value-of select="$m_frontpagebut"/></a> | 
<xsl:choose>
...
<xsl:element name="A"><xsl:attribute name="HREF"><xsl:value-of select="$root"/><xsl:value-of select="$pageui_logout"/></xsl:attribute>
<xsl:attribute name="target">_top</xsl:attribute>
<xsl:value-of select="$alt_logout"/></xsl:element> | 
</xsl:if>
<A href="{$root}Shop" target="_top"><xsl:value-of select="$alt_shop"/></A> | 
<A href="{$root}DontPanic" target="_top"><xsl:value-of select="$alt_help"/></A> | 
<A href="{$root}Askh2g2" target="_top"><xsl:value-of select="$alt_askh2g2"/></A> | 
<A href="{$root}UserEdit" target="_top"><xsl:value-of select="$alt_tellh2g2"/></A> | 
<A href="{$root}Feedback" target="_top">Feedback</A> | 
<A href="{$root}UserDetails" target="_top"><xsl:value-of select="$alt_preferences"/></A> | 
<A href="{$root}AboutUs" target="_top"><xsl:value-of select="$alt_aboutus"/></A>
</SPAN>
</span>
</TD></TR></form></TABLE>
</xsl:template>
...
<span xsl:use-attribute-sets="pullquote"> <B>
<xsl:apply-templates/>
</B></span>
</xsl:element>
</TD></TR>
...
<xsl:attribute name="align"><xsl:value-of select="@EMBED"/></xsl:attribute>
<tr><td rowspan="4" width="5"/><td height="5"/><td rowspan="4" width="5"/></tr>
<tr>
    <td>
  ...
  <tr>
<td align="center" valign="top"><span xsl:use-attribute-sets="captionfont"><xsl:apply-templates/></span></td>
  </tr>
<tr><td height="5"/></tr>
</table>
</xsl:template>
...
<table xsl:use-attribute-sets="picturetable">
<xsl:attribute name="align"><xsl:value-of select="@EMBED"/></xsl:attribute>
	<tr><td rowspan="6" width="5"/><td colspan="3" height="5"/><td rowspan="6" width="5"/></tr>
	<tr> 
	<td rowspan="3" align="left" valign="top" width="{$pictureborderwidth}" bgcolor="{$picturebordercolour}"><img border="0" src="{$imagesource}blank.gif" width="{$pictureborderwidth}"/></td>
	<td align="left" valign="top" height="{$pictureborderwidth}" bgcolor="{$picturebordercolour}"><img border="0" src="{$imagesource}blank.gif" height="{$pictureborderwidth}"/></td>
	<td rowspan="3" align="left" valign="top" width="{$pictureborderwidth}" bgcolor="{$picturebordercolour}"><img border="0" src="{$imagesource}blank.gif" width="{$pictureborderwidth}"/></td>
	</tr>
	<tr>
    <td>
...
<xsl:template match="SMILEY">
	<xsl:choose>
		<xsl:when test="@H2G2|@h2g2|@BIO|@bio|@HREF|@href">
			<xsl:variable name="url"><xsl:value-of select="@H2G2|@h2g2|@BIO|@bio|@HREF|@href"/></xsl:variable>
			<a href="{$root}{$url}">
				<!-- only put in target="_top" when link goes outside current page -->
				<xsl:if test="substring($url, 0, 1) != '#'"><xsl:attribute name="target">_top</xsl:attribute></xsl:if>
			...
			<xsl:choose>
				...
				<xsl:when test="string-length(.) = 0">
					...
					<xsl:choose>
						...
						<xsl:otherwise><xsl:value-of select="$m_researcher"/><xsl:text> </xsl:text><xsl:value-of select="$userid"/>
						</xsl:otherwise>
					</xsl:choose>
				</xsl:when>
				<xsl:otherwise>
...
<xsl:choose>
	<xsl:when test="@POPUP">
		...
		<xsl:if test="@H2G2"><xsl:apply-templates select="@H2G2" mode="applyroot"/></xsl:if>
		<xsl:if test="@DNAID"><xsl:apply-templates select="@DNAID" mode="applyroot"/></xsl:if>
		<xsl:if test="@HREF"><xsl:apply-templates select="@HREF" mode="applyroot"/></xsl:if>
		<xsl:if test="@BIO"><xsl:apply-templates select="@BIO" mode="applyroot"/></xsl:if>
		</xsl:variable>
		<xsl:choose>
		<xsl:when test="@STYLE">
...
<A xsl:use-attribute-sets="mSUGLINK">
	<xsl:attribute name="HREF"><xsl:value-of select="$root"/>A<xsl:value-of select="@H2G2"/></xsl:attribute>A<xsl:value-of select="@H2G2"/></A>: <xsl:apply-templates/><br/>
</xsl:template>
...
<xsl:template match="NOENTRYYET">
<P><xsl:value-of select="$m_noentryyet"/></P>
</xsl:template>
...
<PRE><xsl:value-of select="LINE"/></PRE><br/>
...
<xsl:template match="SUBHEADER">
<div xsl:use-attribute-sets="subheaderfont"><xsl:apply-templates/></div>
</xsl:template>
...
<xsl:when test="number(../../FORUMTHREADHEADERS/@THREADID) = number(THREADID)">
  <TR> 
    <TD bgColor="{$ftbgcoloursel}" colspan="2"><xsl:element name="A">
...
<B><xsl:apply-templates mode="nosubject" select="SUBJECT"/></B>
  ...
  <TR>
    <TD bgColor="{$ftbgcoloursel}" width="69%" colspan="2"><span class="lastposting"><xsl:value-of select="$m_lastposting"/>
		<xsl:element name="A">
...
<xsl:otherwise>
  <TR> 
    <TD colspan="2"><xsl:element name="A">
<xsl:attribute name="HREF"><xsl:value-of select="$root"/><xsl:value-of select="$url"/><xsl:value-of select="../@FORUMID"/>?thread=<xsl:value-of select="THREADID"/>&amp;skip=0&amp;show=20</xsl:attribute>
<xsl:attribute name="TARGET"><xsl:value-of select="$target"/></xsl:attribute>
<B><xsl:apply-templates mode="nosubject" select="SUBJECT"/></B>
</xsl:element>
...
<TR>
	<TD width="69%">
		<span class="lastposting"><xsl:value-of select="$m_lastposting"/>
			<xsl:element name="A">
				<xsl:attribute name="HREF"><xsl:value-of select="$root"/><xsl:value-of select="$url"/><xsl:value-of select="../@FORUMID"/>?thread=<xsl:value-of select="THREADID"/>&amp;latest=1</xsl:attribute>
				<xsl:attribute name="TARGET"><xsl:value-of select="$target"/></xsl:attribute>
				<xsl:apply-templates select="DATEPOSTED"/>
...
<xsl:param name="shownewest"><xsl:value-of select="$m_newest"/></xsl:param>
<xsl:param name="showoldestconv"><xsl:value-of select="$m_oldest"/></xsl:param>
...
<br/><xsl:choose>
	<xsl:when test="$Skip != 0">
		...
		<a href="{$root}{$URL}{$ID}?skip={number($Skip) - number($Show)}&amp;show={$Show}{$ExtraParameters}"><xsl:value-of select="$alt"/></a>
	</xsl:when>
	<xsl:otherwise>
...
<nobr><xsl:value-of select="@DAY"/><xsl:value-of select="$m_ShortDateDelimiter"/><xsl:value-of select="@MONTH"/><xsl:value-of select="$m_ShortDateDelimiter"/><xsl:value-of select="@YEAR"/></nobr>
</xsl:template>
...
<xsl:template match="FORUMTHREADHEADERS/POST" mode="many">
    <TR align="left"> 
      ...
      <TD colspan="2" nowrap="1" valign="top"><span class="fthreadheaders"> 
        <A target="messages" href="{$root}FFM{../@FORUMID}?thread={../@THREADID}&amp;skip={../@SKIPTO}&amp;show={../@COUNT}#p{@POSTID}">
<xsl:value-of select="position() + number(../@SKIPTO)"/></A><xsl:text disable-output-escaping="yes">&amp;nbsp;&amp;nbsp;</xsl:text> 
</span></TD>
      <TD nowrap="1"><DIV class="browse"><xsl:element name="A">
...
<xsl:template name="showtreegadget">
	...
	<TR>
	<TD xsl:use-attribute-sets="cellstyle"><span xsl:use-attribute-sets="gadgetfont">&nbsp;</span></TD>
		...
		<xsl:when test="@INREPLYTO">
			...
			<xsl:choose>
				<xsl:when test="../POST[@POSTID = current()/@INREPLYTO]">
					<A><xsl:attribute name="HREF">#p<xsl:value-of select="@INREPLYTO"/></xsl:attribute><xsl:attribute name="title"><xsl:value-of select="$alt_replyingtothis"/></xsl:attribute><span xsl:use-attribute-sets="gadgetfont">^</span></A>
				</xsl:when>
				<xsl:otherwise>
					<A><xsl:if test="$ptype='frame'"><xsl:attribute name="target">twosides</xsl:attribute></xsl:if><xsl:attribute name="HREF"><xsl:value-of select="$root"/><xsl:choose><xsl:when test="$ptype='frame'">FLR</xsl:when><xsl:otherwise>F</xsl:otherwise></xsl:choose><xsl:value-of select="../@FORUMID"/>?thread=<xsl:value-of select="../@THREADID"/>&amp;post=<xsl:value-of select="@INREPLYTO"/>#p<xsl:value-of select="@INREPLYTO"/></xsl:attribute><xsl:attribute name="title"><xsl:value-of select="$alt_replyingtothis"/></xsl:attribute><span xsl:use-attribute-sets="gadgetfont">^</span></A>
				</xsl:otherwise>
			</xsl:choose>
		</xsl:when>
		<xsl:otherwise>
			<span xsl:use-attribute-sets="gadgetfont"><xsl:text>^</xsl:text></span>
		</xsl:otherwise>
	</xsl:choose>
	</TD>
	<TD xsl:use-attribute-sets="cellstyle"><span xsl:use-attribute-sets="gadgetfont">&nbsp;</span></TD>
		...
		<xsl:when test="@PREVSIBLING">
			...
			<xsl:choose>
				<xsl:when test="../POST[@POSTID = current()/@PREVSIBLING]">
					<A><xsl:attribute name="HREF">#p<xsl:value-of select="@PREVSIBLING"/></xsl:attribute><xsl:attribute name="title"><xsl:value-of select="$alt_prevreply"/></xsl:attribute><span xsl:use-attribute-sets="gadgetfont">&lt;</span></A>
				</xsl:when>
				<xsl:otherwise>
					<A><xsl:if test="$ptype='frame'"><xsl:attribute name="target">_top</xsl:attribute></xsl:if><xsl:attribute name="HREF"><xsl:value-of select="$root"/><xsl:choose><xsl:when test="$ptype='frame'">F</xsl:when><xsl:otherwise>F</xsl:otherwise></xsl:choose><xsl:value-of select="../@FORUMID"/>?thread=<xsl:value-of select="../@THREADID"/>&amp;post=<xsl:value-of select="@PREVSIBLING"/>#p<xsl:value-of select="@PREVSIBLING"/></xsl:attribute><xsl:attribute name="title"><xsl:value-of select="$alt_prevreply"/></xsl:attribute><span xsl:use-attribute-sets="gadgetfont">&lt;</span></A>
				</xsl:otherwise>
			</xsl:choose>
		</xsl:when>
		<xsl:otherwise>
	...
	<TD xsl:use-attribute-sets="cellstyle"><span xsl:use-attribute-sets="gadgetfont">o</span></TD>
	<TD xsl:use-attribute-sets="cellstyle">
	<xsl:choose>
		<xsl:when test="@NEXTSIBLING">
			...
			<xsl:choose>
				<xsl:when test="../POST[@POSTID = current()/@NEXTSIBLING]">
					<A><xsl:attribute name="HREF">#p<xsl:value-of select="@NEXTSIBLING"/></xsl:attribute><xsl:attribute name="title"><xsl:value-of select="$alt_nextreply"/></xsl:attribute><span xsl:use-attribute-sets="gadgetfont">&gt;</span></A>
				</xsl:when>
				<xsl:otherwise>
					<A><xsl:if test="$ptype='frame'"><xsl:attribute name="target">twosides</xsl:attribute></xsl:if><xsl:attribute name="HREF"><xsl:value-of select="$root"/><xsl:choose><xsl:when test="$ptype='frame'">FLR</xsl:when><xsl:otherwise>F</xsl:otherwise></xsl:choose><xsl:value-of select="../@FORUMID"/>?thread=<xsl:value-of select="../@THREADID"/>&amp;post=<xsl:value-of select="@NEXTSIBLING"/>#p<xsl:value-of select="@NEXTSIBLING"/></xsl:attribute><xsl:attribute name="title"><xsl:value-of select="$alt_nextreply"/></xsl:attribute><span xsl:use-attribute-sets="gadgetfont">&gt;</span></A>
				</xsl:otherwise>
			</xsl:choose>
		</xsl:when>
		<xsl:otherwise>
		...
		<xsl:when test="@FIRSTCHILD">
			...
			<xsl:choose>
				<xsl:when test="../POST[@POSTID = current()/@FIRSTCHILD]">
					<A><xsl:attribute name="HREF">#p<xsl:value-of select="@FIRSTCHILD"/></xsl:attribute><xsl:attribute name="title"><xsl:value-of select="$m_firstreplytothis"/></xsl:attribute><span xsl:use-attribute-sets="gadgetfont">V</span></A>
				</xsl:when>
				<xsl:otherwise>
					<A><xsl:if test="$ptype='frame'"><xsl:attribute name="target">twosides</xsl:attribute></xsl:if><xsl:attribute name="HREF"><xsl:value-of select="$root"/><xsl:choose><xsl:when test="$ptype='frame'">FLR</xsl:when><xsl:otherwise>F</xsl:otherwise></xsl:choose><xsl:value-of select="../@FORUMID"/>?thread=<xsl:value-of select="../@THREADID"/>&amp;post=<xsl:value-of select="@FIRSTCHILD"/>#p<xsl:value-of select="@FIRSTCHILD"/></xsl:attribute><xsl:attribute name="title"><xsl:value-of select="$m_firstreplytothis"/></xsl:attribute><span xsl:use-attribute-sets="gadgetfont">V</span></A>
				</xsl:otherwise>
			</xsl:choose>
		</xsl:when>
		<xsl:otherwise>
			<span xsl:use-attribute-sets="gadgetfont"><xsl:text>V</xsl:text></span>
		</xsl:otherwise>
	</xsl:choose>
	</TD>
	<TD xsl:use-attribute-sets="cellstyle"><span xsl:use-attribute-sets="gadgetfont">&nbsp;</span></TD>
...
<xsl:template match="FORUMSOURCE/ARTICLE">
<span xsl:use-attribute-sets="forumsource"><B><xsl:value-of select="$m_thisconvforentry"/> 
...
<xsl:template match="FORUMSOURCE/JOURNAL">
<span xsl:use-attribute-sets="forumsource"><B><xsl:value-of select="$m_thisjournal"/> 
...
<xsl:template match="FORUMSOURCE/USERPAGE">
<span xsl:use-attribute-sets="forumsource"><B><xsl:value-of select="$m_thismessagecentre"/>
...
<xsl:attribute name="TARGET">_top</xsl:attribute>
<span xsl:use-attribute-sets="forumsourcelink"><xsl:value-of select="REVIEWFORUMNAME"/></span>
</a></B></span>
</xsl:template>
...
<xsl:template match="ARTICLE-LIST/ARTICLE">
	...
	<A><xsl:attribute name="HREF"><xsl:value-of select="$root"/>A<xsl:value-of select="H2G2-ID"/></xsl:attribute>A<xsl:value-of select="H2G2-ID"/></A>
	&nbsp;<xsl:value-of select="SUBJECT"/> (<xsl:apply-templates select="DATE-CREATED/DATE"/>) 
	<xsl:choose>
		<xsl:when test="STATUS = 7"><xsl:value-of select="$m_cancelled"/>
			<xsl:if test="($ownerisviewer = 1)">
				(<A><xsl:attribute name="HREF"><xsl:value-of select="$root"/>UserEdit<xsl:value-of select="H2G2-ID"/>?cmd=undelete</xsl:attribute><xsl:value-of select="$m_uncancel"/></A>)
			</xsl:if>
		</xsl:when>
...
<!--	<xsl:if test="($ownerisviewer = 1) and .[STATUS = 3 or STATUS = 4]">-->
	<xsl:if test="($ownerisviewer = 1) and (STATUS = 3 or STATUS = 4) and (EDITOR/USER/USERID = $viewerid)">
		&nbsp;<A><xsl:attribute name="HREF"><xsl:value-of select="$root"/>UserEdit<xsl:value-of select="H2G2-ID"/></xsl:attribute><xsl:value-of select="$m_edit"/></A>
	</xsl:if>
	<BR/>
</xsl:template>
...
<xsl:template match="USERNAME" mode="truncated">
	<xsl:variable name="UserName">
		<xsl:choose>
			<xsl:when test="string-length(.) &gt; 20"><xsl:value-of select="substring(., 1, 17)"/>...</xsl:when>
			<xsl:otherwise><xsl:value-of select="."/></xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:choose>
		<xsl:when test="../USERID &lt; 10000">
			<b><i><xsl:value-of select="$UserName"/></i></b>
		</xsl:when>
...
-->
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr><td><img src="{$imagesource}blank.gif" width="{number($catboxwidth)-16}" height="1"/></td></tr>
					</table>
				</div>
<!--
...
<xsl:template match="CATLINKITEM">
[ <A href="{$root}{@HREF}"><span xsl:use-attribute-sets="catboxotherlink"><xsl:value-of select="."/></span></A> ]<br/>
</xsl:template>
...
<xsl:template match="CATLINK">
<A href="{$root}{@HREF}"><span xsl:use-attribute-sets="catboxotherlink"><xsl:value-of select="."/></span></A>
</xsl:template>
...
<xsl:template match="CATEGORY">
<b><a><xsl:attribute name="HREF"><xsl:value-of select="$root"/>C<xsl:value-of select="CATID"/></xsl:attribute><span xsl:use-attribute-sets="catboxmain"><u><xsl:value-of select="NAME"/></u></span></a></b>
...
<xsl:template match="SUBCATEGORY">
<xsl:if test="position()&gt;1">, </xsl:if><a><xsl:attribute name="HREF"><xsl:value-of select="$root"/>C<xsl:value-of select="CATID"/></xsl:attribute><span xsl:use-attribute-sets="catboxsublink"><xsl:value-of select="NAME"/></span></a>
</xsl:template>
...
<xsl:template match="PASSTHROUGH">
<xsl:variable name="contents"><xsl:value-of select="translate(.,$uppercase,$lowercase)"/></xsl:variable>
<xsl:choose>
...
<A TARGET="_h2g2banner"><xsl:attribute name="HREF"><xsl:value-of select="$root"/>http://ad.uk.doubleclick.net/jump/h2g2.com/frontpage;sec=<xsl:value-of select="@SECTION"/>;sz=468x60;ord=<xsl:value-of select="@SEED"/>?</xsl:attribute><IMG name="Ngui_01_03" height="60" width="468" border="0" vspace="0" hspace="0"><xsl:attribute name="SRC">http://ad.uk.doubleclick.net/ad/h2g2.com/frontpage;sec=<xsl:value-of select="@SECTION"/>;sz=468x60;ord=<xsl:value-of select="@SEED"/>?</xsl:attribute></IMG></A>
</xsl:template>

<xsl:template match="PAGEUI/BANNER">
<xsl:choose>
<xsl:when test="$ripleybanner = 1">
<a target="_top" href="{$bannerurl}"><img src="{$bannersrc}" width="468" height="60" vspace="7" hspace="0" border="0"/></a>
</xsl:when>
<xsl:otherwise>
<A TARGET="_h2g2banner"><xsl:attribute name="HREF"><xsl:value-of select="$root"/>http://ad.uk.doubleclick.net/jump/h2g2.com/frontpage;sec=<xsl:value-of select="@SECTION"/>;sz=468x60;ord=<xsl:value-of select="@SEED"/>?</xsl:attribute><IMG name="Ngui_01_03" height="60" width="468" border="0" vspace="7" hspace="0"><xsl:attribute name="SRC">http://ad.uk.doubleclick.net/ad/h2g2.com/frontpage;sec=<xsl:value-of select="@SECTION"/>;sz=468x60;ord=<xsl:value-of select="@SEED"/>?</xsl:attribute></IMG></A>
</xsl:otherwise>
</xsl:choose>
</xsl:template>
...
<xsl:template match="WHO-IS-ONLINE">
<a href="javascript:popusers('{$root}online');"><xsl:apply-templates/></a>
</xsl:template>
...
<xsl:template match="POPUP">
<a><xsl:attribute name="HREF">javascript:popupwindow('<xsl:value-of select="@HREF"/>','<xsl:value-of select="@TARGET"/>','<xsl:value-of select="@STYLE"/>');</xsl:attribute><xsl:apply-templates/></a>
</xsl:template>
...
<xsl:template match="A">
<xsl:copy use-attribute-sets="mA"><xsl:apply-templates select="*|@HREF|@TARGET|@NAME|text()"/></xsl:copy>
</xsl:template>
...
<xsl:param name="localskinname"><xsl:value-of select="$skinname"/></xsl:param>
<xsl:apply-templates select="msxsl:node-set($skinlist)/*">
<!--<xsl:apply-templates select="$skinlist">-->
<xsl:with-param name="localskinname"><xsl:value-of select="$localskinname"/></xsl:with-param>
</xsl:apply-templates>
<!--
	<xsl:choose>
...
<tr> 
<td bgcolor="{$boxholderleftcolour}"><b><span class="boxholdertitle"><xsl:value-of select="TITLE"/></span></b></td>
<td bgcolor="{$boxholderrightcolour}"><b><span class="boxholdertitle"><xsl:value-of select="../BOX[$pos+1]/TITLE"/></span></b></td>
</tr>
        <tr> 
          ...
          <td valign="top" align="left" width="50%">
		    <p><br/>
			  <xsl:apply-templates select="../BOX[$pos+1]/TEXT"/></p>
          </td>
        </tr>
</table>
</xsl:if>
...
<xsl:template name="forumpostblocks">
	...
	<xsl:param name="target">_top</xsl:param>
	<xsl:param name="ExtraParameters"/>
<xsl:variable name="limit"><xsl:value-of select="number($blocklimit) * $show"/></xsl:variable>
...
<xsl:when test="($skip = 0) and ($skip + $show) &lt; $lower">
	<a><xsl:if test="$target!=''"><xsl:attribute name="target"><xsl:value-of select="$target"/></xsl:attribute></xsl:if><xsl:attribute name="HREF"><xsl:value-of select="$root"/><xsl:value-of select="$url"/><xsl:value-of select="$forum"/><xsl:choose><xsl:when test="$thread!=''">?thread=<xsl:value-of select="$thread"/>&amp;</xsl:when><xsl:otherwise>?</xsl:otherwise></xsl:choose>skip=<xsl:value-of select="$skip"/>&amp;show=<xsl:value-of select="$show"/><xsl:value-of select="$ExtraParameters"/></xsl:attribute>
...
<xsl:param name="PostRange"/>
				<span xsl:use-attribute-sets="forumblockson"><xsl:text> </xsl:text><xsl:value-of select="$blocknumber"/><xsl:text> </xsl:text></span>
</xsl:template>
...
<xsl:param name="objectname"/>
<xsl:param name="PostRange"/>
				<span xsl:use-attribute-sets="forumblocksoff"><xsl:text> </xsl:text><xsl:value-of select="$blocknumber"/><xsl:text> </xsl:text></span>
</xsl:template>
...
<xsl:apply-templates mode="header" select=".">
<xsl:with-param name="title"><xsl:value-of select="$m_h2g2"/></xsl:with-param>
</xsl:apply-templates>
</xsl:template>
...
Failed article: 
<A target="_blank" href="{$root}A{@ID}">A<xsl:value-of select="@ID"/></A>
...
<xsl:apply-templates mode="header" select=".">
<xsl:with-param name="title"><xsl:value-of select="$m_frontpagetitle"/></xsl:with-param>
</xsl:apply-templates>
</xsl:template>
...
<xsl:template name="FRONTPAGE_STRAPLINE">
	<div align="center">
	<b>h2g2 - The Earth Edition of The Hitchhiker's Guide to the Galaxy
</b></div>
</xsl:template>
...
<xsl:apply-templates mode="header" select=".">
<xsl:with-param name="title"><xsl:value-of select="$m_pagetitlestart"/>
	<xsl:choose>
...
<xsl:template name="ARTICLE_MAINBODY">
	...
	<br/>
	<a href="#moderatesection"><xsl:value-of select="$m_jumptomoderate"/></a>
	<br/>
	</xsl:if>
...
<xsl:apply-templates mode="header" select=".">
<xsl:with-param name="title"><xsl:value-of select="$m_pagetitlestart"/><xsl:value-of select="$m_indextitle"/></xsl:with-param>
</xsl:apply-templates>
</xsl:template>	

<xsl:template name="INDEX_SUBJECT">
	<xsl:call-template name="SUBJECTHEADER">
	<xsl:with-param name="text"><xsl:value-of select="$m_indextitle"/></xsl:with-param>
	</xsl:call-template>
</xsl:template>
...
<input type="hidden" name="let"><xsl:attribute name="value"><xsl:value-of select="INDEX/@LETTER"/></xsl:attribute></input>
  <table border="0" cellspacing="0" cellpadding="1">
    <tr> 
      <td valign="top">&nbsp;</td>
      <td valign="top"><span class="indexnavtitle"><xsl:value-of select="$m_show"/></span></td>
    </tr>
    <tr> 
      <td valign="top"> 
        <input type="checkbox" name="official"><xsl:if test="INDEX/@APPROVED"><xsl:attribute name="checked">1</xsl:attribute></xsl:if></input>
      </td>
      <td><b><xsl:value-of select="$m_editedentries"/></b> </td>
    </tr>
    <tr> 
      <td valign="top"> 
        <input type="checkbox" name="submitted"><xsl:if test="INDEX/@SUBMITTED"><xsl:attribute name="checked">1</xsl:attribute></xsl:if></input>
      </td>
      <td><xsl:value-of select="$m_awaitingappr"/></td>
    </tr>
    <tr> 
      <td valign="top"> 
        <input type="checkbox" name="user"><xsl:if test="INDEX/@UNAPPROVED"><xsl:attribute name="checked">1</xsl:attribute></xsl:if></input>
      </td>
      <td><i><xsl:value-of select="$m_guideentries"/></i></td>
    </tr>
    <tr> 
      <td valign="top">&nbsp;</td>
      <td> 
...
<span xsl:use-attribute-sets="forumsource"><B><xsl:value-of select="$m_thisuserstatistics"/> 
<A>
<xsl:attribute name="HREF"><xsl:value-of select="$root"/>U
<xsl:value-of select="USERSTATISTICS/@USERID"/></xsl:attribute>
<xsl:attribute name="TARGET">_top</xsl:attribute>
<span xsl:use-attribute-sets="forumsourcelink">
<xsl:value-of select="USERSTATISTICS/@USERNAME"/></span>
</A></B></span>
</xsl:template>

<xsl:template name="MULTIPOSTS_HEADER">
<xsl:apply-templates mode="header" select=".">
<xsl:with-param name="title"><xsl:value-of select="$m_pagetitlestart"/>A Forum Conversation</xsl:with-param>
</xsl:apply-templates>
</xsl:template>
...
<xsl:choose>				
	<xsl:when test="/H2G2/FORUMTHREADPOSTS/@DEFAULTCANWRITE = 1">
		<xsl:if test="(/H2G2/VIEWING-USER/USER/GROUPS/GROUP/NAME='EDITOR')  or ($superuser = 1)">
			...
			<img src="http://www.bbc.co.uk/dnaimages/boards/images/button_close.gif" alt="Close this thread" width="137" height="23" border="0" vspace="5" hspace="5"/></a>
		</xsl:if>				
	</xsl:when>
...
<a href="{$root}RF{/H2G2/FORUMSOURCE/REVIEWFORUM/@ID}?entry=0"><xsl:value-of select="$m_articlelisttext"/></a>
</xsl:when>
<xsl:otherwise>
<A href="{$root}F{FORUMTHREADPOSTS/@FORUMID}?showthread={FORUMTHREADPOSTS/@THREADID}"><xsl:value-of select="$m_returntothreadspage"/></A><br/>
</xsl:otherwise>
</xsl:choose>
</xsl:template>
...
<xsl:choose>
	<xsl:when test="USERSTATISTICS[@DISPLAYMODE = 'ungrouped']">
		...
		<TR>
		<TD>
		<B><a href="{$root}F{../../@FORUMID}">
		<xsl:apply-templates mode="nosubject" select="../../SUBJECT"/></a></B>
		</TD><TD>
		<B><a href="{$root}F{../../@FORUMID}?thread={../@THREADID}"><xsl:apply-templates mode="nosubject" select="../SUBJECT"/></a></B>
		</TD><TD>
		<B><a href="{$root}F{../../@FORUMID}?thread={../@THREADID}&amp;post={@POSTID}#p{@POSTID}"><xsl:apply-templates mode="nosubject" select="SUBJECT"/></a></B><BR/>
		</TD><TD>
		<span class="statdateposted"><xsl:apply-templates select="DATEPOSTED"/></span>
		</TD>
		</TR>
		</xsl:for-each>
		</TABLE>
	...
	<xsl:otherwise>
		...
		<B><a href="{$root}F{@FORUMID}">
		<xsl:apply-templates mode="nosubject" select="SUBJECT"/></a></B><BR/>
		<xsl:for-each select="THREAD">
		<xsl:text disable-output-escaping="yes">&amp;nbsp;&amp;nbsp;</xsl:text>
		<B><a href="{$root}F{../@FORUMID}?thread={@THREADID}">
		<xsl:apply-templates mode="nosubject" select="SUBJECT"/></a></B><BR/>
		<xsl:for-each select="POST">
		<xsl:text disable-output-escaping="yes">&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;</xsl:text>
		<B><a href="{$root}F{../../@FORUMID}?thread={../@THREADID}&amp;post={@POSTID}#p{@POSTID}">
		<xsl:apply-templates mode="nosubject" select="SUBJECT"/></a></B><BR/>
		<xsl:text disable-output-escaping="yes">&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;</xsl:text>
		<span class="statdateposted"><xsl:value-of select="$m_posted"/><xsl:apply-templates select="DATEPOSTED"/></span><BR/>
		</xsl:for-each>
		</xsl:for-each>
		</xsl:for-each>
	</xsl:otherwise>
...
<xsl:variable name="mymessage">
<xsl:if test="$ownerisviewer=1">
<xsl:value-of select="$m_mymessage"/><xsl:text> </xsl:text>
</xsl:if>
</xsl:variable>
...
<xsl:text> </xsl:text>	</div>
	...
	<xsl:apply-templates select="/H2G2/ARTICLEFORUM/FORUMTHREADS"/>
<br clear="all"/>
<b><span class="spacesectiontitle"><xsl:value-of select="$mymessage"/><xsl:value-of select="$m_journalentries"/></span></b>
            <p><br/>
...
<hr/>
<b><span class="spacesectiontitle"><xsl:value-of select="$mymessage"/><xsl:value-of select="$m_mostrecentconv"/></span></b>
		    <p><br/>
              <xsl:apply-templates select="RECENT-POSTS"/></p>
<br clear="all"/>
<hr/>
<b><span class="spacesectiontitle"><xsl:value-of select="$mymessage"/><xsl:value-of select="$m_recententries"/></span></b>
            <p><br/>
              <xsl:apply-templates select="RECENT-ENTRIES"/><br/><br/>
			  </p>
<hr/>
<b><span class="spacesectiontitle"><xsl:value-of select="$mymessage"/><xsl:value-of select="$m_mostrecentedited"/></span></b>
		    <p><br/>
              <xsl:apply-templates select="RECENT-APPROVALS"/><br/><br/></p>
...
<xsl:apply-templates mode="header" select=".">
<xsl:with-param name="title"><xsl:value-of select="$m_pagetitlestart"/><xsl:value-of select="$m_posttoaforum"/></xsl:with-param>
</xsl:apply-templates>
</xsl:template>
...
<xsl:apply-templates mode="header" select=".">
<xsl:with-param name="title"><xsl:value-of select="$m_pagetitlestart"/><xsl:value-of select="$m_browsetheguide"/></xsl:with-param>
</xsl:apply-templates>
</xsl:template>
...
<xsl:template name="CATEGORY_SUBJECT">
	<xsl:call-template name="SUBJECTHEADER">
	<xsl:with-param name="text"><xsl:value-of select="$m_browsetheguide"/></xsl:with-param>
	</xsl:call-template>
</xsl:template>
...
<xsl:template name="EDITCATEGORY_SUBJECT">
	<xsl:call-template name="SUBJECTHEADER">
	<xsl:with-param name="text"><xsl:value-of select="$m_editcategorisationsubject"/></xsl:with-param>
	</xsl:call-template>
</xsl:template>

<xsl:template name="EDITCATEGORY_HEADER">
<xsl:apply-templates mode="header" select=".">
<xsl:with-param name="title"><xsl:value-of select="$m_pagetitlestart"/><xsl:value-of select="$m_editcategorisationheader"/></xsl:with-param>
</xsl:apply-templates>
</xsl:template>
...
<LI>
<P>
<B><A href="{$root}C{CATID}"><xsl:value-of select="NAME"/></A></B>
...
<A href="{$root}C{@ID}"><xsl:apply-templates/></A>
</xsl:template>
...
<xsl:apply-templates mode="header" select=".">
<xsl:with-param name="title"><xsl:value-of select="$m_pagetitlestart"/><xsl:value-of select="$m_addjournal"/></xsl:with-param>
</xsl:apply-templates>
</xsl:template>
...
<xsl:apply-templates mode="header" select=".">
<xsl:with-param name="title"><xsl:value-of select="$m_pagetitlestart"/><xsl:value-of select="$m_registrationtitle"/></xsl:with-param>
</xsl:apply-templates>
</xsl:template>
...
<xsl:template name="REGISTER_SUBJECT">
	<xsl:call-template name="SUBJECTHEADER">
	<xsl:with-param name="text"><xsl:value-of select="$m_registrationtitle"/></xsl:with-param>
	</xsl:call-template>
</xsl:template>
...
-->
		...
		<xsl:when test="REGISTER[@STATUS='LOGGEDIN']">
			<xsl:choose>
				<xsl:when test="REGISTER[ACTIVE=1]">
					<meta http-equiv="REFRESH"><xsl:attribute name="content">0;url=<xsl:value-of select="$root"/>U<xsl:value-of select="REGISTER/USERID"/></xsl:attribute></meta>
					<xsl:call-template name="m_regwaittransfer"/>
				</xsl:when>
				<xsl:otherwise>
					<meta http-equiv="REFRESH"><xsl:attribute name="content">0;url=<xsl:value-of select="$root"/>Welcome</xsl:attribute></meta>
	...
	<!--<xsl:when test="REGISTER[@STATUS='BADPASSWORD' | STATUS='ASKPASSWORD']">-->
		<xsl:when test="REGISTER[@STATUS='BADPASSWORD']|REGISTER[@STATUS='ASKPASSWORD']">
			<xsl:call-template name="HEADER">
				<xsl:with-param name="text"><xsl:value-of select="$m_enterpassword"/></xsl:with-param>
			</xsl:call-template>
			<blockquote>
			...
			<div class="termsbox"><TEXTAREA READONLY="1" rows="10" cols="60" WRAP="VIRTUAL" NAME="terms">
			...
			<xsl:value-of select="$m_emailaddr"/><INPUT TYPE="TEXT" NAME="email"><xsl:attribute name="value"><xsl:value-of select="REGISTER/EMAILADDRESS"/></xsl:attribute></INPUT><BR/>
		...
		<xsl:when test="REGISTER[@STATUS='NODETAILS'] | REGISTER[@STATUS='BADEMAIL']">
			...
			<xsl:call-template name="HEADER">
				<xsl:with-param name="text"><xsl:value-of select="$m_newusers"/></xsl:with-param>
			</xsl:call-template>
			<blockquote>
			<xsl:call-template name="m_registrationblurb"/>
			<FORM METHOD="POST" action="{$root}register">
			<xsl:value-of select="$m_emailaddr"/><INPUT TYPE="TEXT" NAME="email" value=""/>
			<br/>
			<INPUT TYPE="SUBMIT" NAME="Register" VALUE="{$alt_register}"/>
			</FORM>
			</blockquote>
			<xsl:call-template name="HEADER">
				<xsl:with-param name="text"><xsl:value-of select="$m_existingusers"/></xsl:with-param>
			</xsl:call-template>
			<blockquote>
			...
			<xsl:call-template name="HEADER">
				<xsl:with-param name="text"><xsl:value-of select="$m_confregistration"/></xsl:with-param>
			</xsl:call-template>
			<FORM METHOD="POST" action="{$root}Register">
			...
			<INPUT TYPE="HIDDEN" NAME="email"><xsl:attribute name="value"><xsl:value-of select="REGISTER/EMAILADDRESS"/></xsl:attribute></INPUT>
			<INPUT TYPE="HIDDEN" NAME="userid" VALUE="{REGISTER/USERID}"/>
			<table><tr><td><xsl:value-of select="$m_password"/></td><td><INPUT TYPE="PASSWORD" NAME="password"/></td></tr>
			<tr><td><xsl:value-of select="$m_confirmpassword"/></td><td><INPUT TYPE="PASSWORD" NAME="password1"/></td></tr></table>
			<xsl:choose>
				<xsl:when test="REGISTER[ACTIVE=0]">
					<div class="termsbox"><TEXTAREA READONLY="1" rows="10" cols="60" WRAP="VIRTUAL" NAME="terms">
					<xsl:call-template name="m_terms"/>
					</TEXTAREA></div><br/>
					<INPUT TYPE="SUBMIT" NAME="accept" VALUE="{$m_iaccept}"/> <INPUT TYPE="SUBMIT" NAME="notaccept" VALUE="{$m_idonotaccept}"/> 
				</xsl:when>
				<xsl:otherwise>
					<div class="termsbox"><TEXTAREA READONLY="1" rows="10" cols="60" WRAP="VIRTUAL" NAME="terms">
					<xsl:call-template name="m_terms"/>
		...
		<xsl:when test="REGISTER[@STATUS='REJECTEDTERMS']">
			<xsl:call-template name="HEADER">
				<xsl:with-param name="text"><xsl:value-of select="$m_sorrytermsrejectedtitle"/></xsl:with-param>
			</xsl:call-template>
			<xsl:call-template name="m_sorryrejectedterms"/>
		</xsl:when>
		<xsl:when test="REGISTER[@STATUS='CONFIRMCANCEL']">
			<xsl:call-template name="HEADER">
				<xsl:with-param name="text"><xsl:value-of select="$m_warningcancellingaccount"/></xsl:with-param>
			</xsl:call-template>
			...
			<INPUT TYPE="SUBMIT" NAME="noconfirm" VALUE="{$m_noleaveaccountactive}"/><br/>
			</FORM>
		...
		<xsl:when test="REGISTER[@STATUS='CANCELERROR']">
			<P>
			<xsl:value-of select="$m_problemcancelling"/><xsl:value-of select="REGISTER/CANCELREASON"/>
			</P>
		</xsl:when>
	</xsl:choose>
<br/>
...
<xsl:template name="NEWREGISTER_SUBJECT">
	<xsl:call-template name="SUBJECTHEADER">
	<xsl:with-param name="text"><xsl:value-of select="$m_registrationsubject"/></xsl:with-param>
	</xsl:call-template>
</xsl:template>
...
<xsl:choose>
	...
	<xsl:when test="NEWREGISTER[@STATUS='ASSOCIATED']|NEWREGISTER[@STATUS='LOGGEDIN']">
		<xsl:choose>
			...
			<xsl:when test="NEWREGISTER[FIRSTTIME=0]">
				<meta http-equiv="REFRESH"><xsl:attribute name="content">0;url=<xsl:value-of select="$root"/>U<xsl:value-of select="NEWREGISTER/USERID"/></xsl:attribute></meta>
				<xsl:call-template name="m_regwaittransfer"/>
			</xsl:when>
			<xsl:otherwise>
				<meta http-equiv="REFRESH"><xsl:attribute name="content">0;url=<xsl:value-of select="$root"/>Welcome</xsl:attribute></meta>
...
<TABLE BORDER="0">
<TR>
<TD><xsl:value-of select="$m_loginname"/></TD><TD><INPUT TYPE="TEXT" NAME="loginname" VALUE="{LOGINNAME}"/></TD>
</TR>
<TR>
<TD><xsl:value-of select="$m_bbcpassword"/></TD><TD><INPUT TYPE="password" NAME="password"/></TD>
</TR>
<TR>
<TD><xsl:value-of select="$m_confirmbbcpassword"/></TD><TD><INPUT TYPE="password" NAME="password2"/></TD>
</TR>
<TR><TD COLSPAN="2"><HR/>
...
<TR>
<TD><xsl:value-of select="$m_emailaddr"/></TD><TD><INPUT TYPE="TEXT" NAME="email" VALUE="{EMAIL}"/></TD>
</TR>
<TR>
<TD><xsl:value-of select="$m_h2g2password"/></TD><TD><INPUT TYPE="PASSWORD" NAME="h2g2password"/></TD>
</TR>
<TR>
<TD/><TD><INPUT TYPE="CHECKBOX" NAME="remember" VALUE="1"/><xsl:value-of select="$m_alwaysremember"/></TD>
</TR>
<TR><TD COLSPAN="2">
					<xsl:call-template name="m_terms"/>
</TD></TR>
<TR>
<TD/><TD><INPUT TYPE="CHECKBOX" NAME="terms" VALUE="1"/><xsl:text> </xsl:text><xsl:call-template name="m_agreetoterms"/></TD>
</TR>
<TR>
<TD/><TD><INPUT TYPE="SUBMIT" NAME="submit" VALUE="{$m_newreactivatebutton}"/></TD>
</TR>
</TABLE>
</FORM>
</xsl:template>
...
<xsl:template match="NEWREGISTER[@COMMAND='agreeterms']">
		 ...
		 <br/>
<xsl:call-template name="m_bbcloginblurb"/><br/>
<FORM METHOD="POST" ACTION="{$bbcregscript}">
<INPUT TYPE="HIDDEN" NAME="bbctest" VALUE="1"/>
...
<TR>
<TD/><TD><INPUT TYPE="CHECKBOX" NAME="remember" VALUE="1"/><xsl:text> </xsl:text><xsl:value-of select="$m_alwaysremember"/></TD>
</TR>
<TR><TD COLSPAN="2">
<div class="termsbox">
					<xsl:call-template name="m_terms"/>
...
<TR>
<TD/><TD><INPUT TYPE="SUBMIT" NAME="submit" VALUE="{$m_newloginbutton}"/></TD>
</TR>
</TABLE>
</FORM>
...
<xsl:choose>
	<xsl:when test="PARAM[@NAME='post']=0">
		<A href="{$root}AddThread?forum={PARAM[@NAME='forum']}" xsl:use-attribute-sets="mREGISTER-PASSTHROUGH_completed"><xsl:value-of select="$m_ptclicktostartnewconv"/></A>
	</xsl:when>
	<xsl:otherwise>
		<A href="{$root}AddThread?inreplyto={PARAM[@NAME='post']}" xsl:use-attribute-sets="mREGISTER-PASSTHROUGH_completed"><xsl:value-of select="$m_ptclicktowritereply"/></A>
	</xsl:otherwise>
</xsl:choose>
</xsl:template>
	...
	<xsl:when test="/H2G2/NEWREGISTER/REGISTER-PASSTHROUGH">
		<xsl:attribute name="HREF">
			...
			<xsl:for-each select="/H2G2/NEWREGISTER/REGISTER-PASSTHROUGH">
				<xsl:text>?pa=</xsl:text><xsl:value-of select="@ACTION"/>
...
<xsl:value-of select="$m_badlogin"/><br/>
	</xsl:when>
	<xsl:when test="@STATUS='H2G2ALREADYHASLOGIN'">
	<xsl:value-of select="$m_alreadyhaslogin"/><br/>
	</xsl:when>
	<xsl:when test="@STATUS='BBCLOGINUSEDALREADY'">
	<xsl:value-of select="$m_bbcloginalreadyused"/><br/>
	</xsl:when>
	<xsl:when test="@STATUS='H2G2UNKOWNERROR'">
	<xsl:value-of select="$m_followingproblem"/><xsl:value-of select="MESSAGE"/><br/>
	</xsl:when>
</xsl:choose>
</xsl:template>
...
<xsl:apply-templates mode="header" select=".">
<xsl:with-param name="title"><xsl:value-of select="$m_pagetitlestart"/><xsl:value-of select="$m_interestingfacts"/></xsl:with-param>
</xsl:apply-templates>
</xsl:template>
...
<xsl:template name="INFO_SUBJECT">
	<xsl:call-template name="SUBJECTHEADER">
	<xsl:with-param name="text"><xsl:value-of select="$m_h2g2stats"/></xsl:with-param>
	</xsl:call-template>
</xsl:template>
...
<xsl:apply-templates mode="header" select=".">
<xsl:with-param name="title"><xsl:value-of select="$m_pagetitlestart"/><xsl:value-of select="$m_logoutheader"/></xsl:with-param>
</xsl:apply-templates>
</xsl:template>
...
<xsl:template name="LOGOUT_SUBJECT">
	<xsl:call-template name="SUBJECTHEADER">
	<xsl:with-param name="text"><xsl:value-of select="$m_logoutsubject"/></xsl:with-param>
	</xsl:call-template>
</xsl:template>
...
<blockquote>
<xsl:call-template name="m_logoutblurb"/></blockquote>
</xsl:template>
...
<xsl:apply-templates mode="header" select=".">
<xsl:with-param name="title"><xsl:value-of select="$m_pagetitlestart"/><xsl:value-of select="$m_h2g2journaltitle"/></xsl:with-param>
</xsl:apply-templates>
</xsl:template>
...
<xsl:template name="JOURNAL_SUBJECT">
	<xsl:call-template name="SUBJECTHEADER">
	<xsl:with-param name="text"><xsl:value-of select="$m_journalforresearcher"/><xsl:value-of select="JOURNAL/@USERID"/></xsl:with-param>
	</xsl:call-template>
</xsl:template>
...
<A><xsl:attribute name="HREF"><xsl:value-of select="$root"/>MJ<xsl:value-of select="JOURNAL/@USERID"/>?journal=<xsl:value-of select="JOURNAL/JOURNALPOSTS/@FORUMID"/>&amp;show=<xsl:value-of select="JOURNAL/JOURNALPOSTS/@COUNT"/>&amp;skip=<xsl:value-of select="number(JOURNAL/JOURNALPOSTS/@SKIPTO) - number(JOURNAL/JOURNALPOSTS/@COUNT)"/></xsl:attribute><xsl:copy-of select="$m_newerentries"/></A>
&nbsp;</xsl:if><xsl:if test="JOURNAL/JOURNALPOSTS[@MORE=1]">
<A><xsl:attribute name="HREF"><xsl:value-of select="$root"/>MJ<xsl:value-of select="JOURNAL/@USERID"/>?journal=<xsl:value-of select="JOURNAL/JOURNALPOSTS/@FORUMID"/>&amp;show=<xsl:value-of select="JOURNAL/JOURNALPOSTS/@COUNT"/>&amp;skip=<xsl:value-of select="number(JOURNAL/JOURNALPOSTS/@SKIPTO) + number(JOURNAL/JOURNALPOSTS/@COUNT)"/></xsl:attribute><xsl:copy-of select="$m_olderentries"/></A>
</xsl:if>
<br/>
<A><xsl:attribute name="HREF"><xsl:value-of select="$root"/>U<xsl:value-of select="JOURNAL/@USERID"/></xsl:attribute>
<xsl:value-of select="$m_backtoresearcher"/></A>
</div>
</xsl:template>
...
<xsl:apply-templates mode="header" select=".">
<xsl:with-param name="title"><xsl:value-of select="$m_newemailtitle"/></xsl:with-param>
</xsl:apply-templates>
</xsl:template>
...
<xsl:template name="NEWEMAIL_SUBJECT">
	...
	<xsl:when test="NEWEMAILSTORED"><xsl:value-of select="$m_newemailstored"/></xsl:when>
	<xsl:otherwise><xsl:value-of select="$m_failedtostoreemail"/></xsl:otherwise></xsl:choose><xsl:value-of select="JOURNAL/@USERID"/></xsl:with-param>
	</xsl:call-template>
</xsl:template>
...
<blockquote>
<xsl:choose>
	<xsl:when test="NEWEMAILSTORED"><xsl:value-of select="$m_yournewemailstored"/></xsl:when>
	<xsl:otherwise><xsl:value-of select="$m_unabletostoreemailbecause"/><xsl:value-of select="NEWEMAILFAILED"/>.</xsl:otherwise></xsl:choose>
...
<xsl:apply-templates mode="header" select=".">
<xsl:with-param name="title"><xsl:value-of select="$m_pagetitlestart"/><xsl:value-of select="$m_morepagestitle"/></xsl:with-param>
</xsl:apply-templates>
</xsl:template>
...
<xsl:apply-templates mode="header" select=".">
<xsl:with-param name="title"><xsl:value-of select="$m_errortitle"/></xsl:with-param>
</xsl:apply-templates>
</xsl:template>
...
<xsl:template name="ERROR_SUBJECT">
	<xsl:call-template name="SUBJECTHEADER">
	<xsl:with-param name="text"><xsl:value-of select="$m_errorsubject"/></xsl:with-param>
	</xsl:call-template>
</xsl:template>
...
<xsl:template name="ERROR_MAINBODY">
	...
	<xsl:choose>
		...
		<xsl:otherwise>
			...
			<blockquote>
			<B><xsl:value-of select="$m_followingerror"/></B><xsl:value-of select="ERROR"/>
			<br/>
			<br/>
			<br/>
			</blockquote>
...
<xsl:apply-templates mode="header" select=".">
<xsl:with-param name="title"><xsl:value-of select="$m_pagetitlestart"/><xsl:value-of select="$m_morepoststitle"/></xsl:with-param>
</xsl:apply-templates>
</xsl:template>
...
<xsl:apply-templates mode="header" select=".">
			<xsl:with-param name="title"><xsl:value-of select="$m_articleisinreviewtext"/></xsl:with-param>
		</xsl:apply-templates>
</xsl:when>
<xsl:otherwise>
		<xsl:apply-templates mode="header" select=".">
			<xsl:with-param name="title"><xsl:value-of select="$m_editpagetitle"/></xsl:with-param>
		</xsl:apply-templates>
</xsl:otherwise>
</xsl:choose>
</xsl:template>
...
<xsl:when test="INREVIEW">
	<xsl:call-template name="SUBJECTHEADER">
								<xsl:with-param name="text"><xsl:value-of select="$m_articleisinreviewtext"/></xsl:with-param>
							</xsl:call-template>
</xsl:when>
<xsl:otherwise>
						<A NAME="top"/>
						<xsl:if test="ARTICLE-PREVIEW/ARTICLE/SUBJECT">
							<xsl:call-template name="SUBJECTHEADER">
								<xsl:with-param name="text"><xsl:value-of select="ARTICLE-PREVIEW/ARTICLE/SUBJECT"/></xsl:with-param>
							</xsl:call-template>
							<BR/>
						</xsl:if>
</xsl:otherwise>
...
<xsl:otherwise>
	...
	<xsl:if test="ARTICLE-EDIT-FORM">
						<br/><xsl:call-template name="SUBJECTHEADER">
							<xsl:with-param name="text">
								<xsl:choose>
...
<xsl:template name="USERDETAILS_HEADER">
		<xsl:apply-templates mode="header" select=".">
			<xsl:with-param name="title"><xsl:value-of select="$m_preferencestitle"/></xsl:with-param>
		</xsl:apply-templates>
</xsl:template>
...
<xsl:template name="USERDETAILS_SUBJECT">
	<xsl:call-template name="SUBJECTHEADER">
		<xsl:with-param name="text"><xsl:value-of select="$m_preferencessubject"/></xsl:with-param>
	</xsl:call-template>
</xsl:template>
...
<xsl:template name="REGISTER-CONFIRMATION_HEADER">
		...
		<xsl:apply-templates mode="header" select=".">
			<xsl:with-param name="title"><xsl:value-of select="$m_regconfirm"/></xsl:with-param>
		</xsl:apply-templates>
</xsl:template>
...
<xsl:template name="REGISTER-CONFIRMATION_SUBJECT">
									<xsl:call-template name="SUBJECTHEADER">
										<xsl:with-param name="text"><xsl:value-of select="$m_reginprogress"/></xsl:with-param>
									</xsl:call-template>
</xsl:template>
...
<xsl:template name="NEWUSERS_HEADER">
	<xsl:apply-templates mode="header" select=".">
		<xsl:with-param name="title"><xsl:value-of select="$m_NewUsersPageTitle"/></xsl:with-param>
	</xsl:apply-templates>
</xsl:template>

<xsl:template name="NEWUSERS_SUBJECT">
	<xsl:call-template name="SUBJECTHEADER">
		<xsl:with-param name="text"><xsl:value-of select="$m_NewUsersPageHeader"/></xsl:with-param>
	</xsl:call-template>
</xsl:template>
...
<xsl:template name="NEWUSERS_MAINBODY">
		<blockquote>
			<br/>
			<p><xsl:value-of select="$m_NewUsersPageExplanatory"/></p>
			<form method="get" action="{$root}NewUsers">
				<select name="TimeUnits" title="Number of Time Units">
					<option value="1"><xsl:if test="NEWUSERS-LISTING/@TIMEUNITS='1'"><xsl:attribute name="selected">selected</xsl:attribute></xsl:if>1</option>
					<option value="2"><xsl:if test="NEWUSERS-LISTING/@TIMEUNITS='2'"><xsl:attribute name="selected">selected</xsl:attribute></xsl:if>2</option>
					<option value="3"><xsl:if test="NEWUSERS-LISTING/@TIMEUNITS='3'"><xsl:attribute name="selected">selected</xsl:attribute></xsl:if>3</option>
					<option value="4"><xsl:if test="NEWUSERS-LISTING/@TIMEUNITS='4'"><xsl:attribute name="selected">selected</xsl:attribute></xsl:if>4</option>
					<option value="5"><xsl:if test="NEWUSERS-LISTING/@TIMEUNITS='5'"><xsl:attribute name="selected">selected</xsl:attribute></xsl:if>5</option>
					<option value="6"><xsl:if test="NEWUSERS-LISTING/@TIMEUNITS='6'"><xsl:attribute name="selected">selected</xsl:attribute></xsl:if>6</option>
					<option value="7"><xsl:if test="NEWUSERS-LISTING/@TIMEUNITS='7'"><xsl:attribute name="selected">selected</xsl:attribute></xsl:if>7</option>
					<option value="8"><xsl:if test="NEWUSERS-LISTING/@TIMEUNITS='8'"><xsl:attribute name="selected">selected</xsl:attribute></xsl:if>8</option>
					<option value="9"><xsl:if test="NEWUSERS-LISTING/@TIMEUNITS='9'"><xsl:attribute name="selected">selected</xsl:attribute></xsl:if>9</option>
					<option value="10"><xsl:if test="NEWUSERS-LISTING/@TIMEUNITS='10'"><xsl:attribute name="selected">selected</xsl:attribute></xsl:if>10</option>
					<option value="11"><xsl:if test="NEWUSERS-LISTING/@TIMEUNITS='11'"><xsl:attribute name="selected">selected</xsl:attribute></xsl:if>11</option>
					<option value="12"><xsl:if test="NEWUSERS-LISTING/@TIMEUNITS='12'"><xsl:attribute name="selected">selected</xsl:attribute></xsl:if>12</option>
				</select>
				<xsl:text> </xsl:text>
				<select name="UnitType" title="Type of Time Unit">
					<option value="month"><xsl:if test="NEWUSERS-LISTING/@UNITTYPE='month'"><xsl:attribute name="selected">selected</xsl:attribute></xsl:if>Months</option>
					<option value="week"><xsl:if test="NEWUSERS-LISTING/@UNITTYPE='week'"><xsl:attribute name="selected">selected</xsl:attribute></xsl:if>Weeks</option>
					<option value="day"><xsl:if test="NEWUSERS-LISTING/@UNITTYPE='day'"><xsl:attribute name="selected">selected</xsl:attribute></xsl:if>Days</option>
					<option value="hour"><xsl:if test="NEWUSERS-LISTING/@UNITTYPE='hour'"><xsl:attribute name="selected">selected</xsl:attribute></xsl:if>Hours</option>
				</select>
				<xsl:text> </xsl:text>
...
<xsl:template name="SHAREANDENJOY_HEADER">
	<xsl:apply-templates mode="header" select=".">
		<xsl:with-param name="title"><xsl:value-of select="$m_pagetitlestart"/><xsl:value-of select="$m_shareandenjoytitle"/></xsl:with-param>
	</xsl:apply-templates>
</xsl:template>

<xsl:template name="SHAREANDENJOY_SUBJECT">
	<xsl:call-template name="SUBJECTHEADER">
		<xsl:with-param name="text"><xsl:value-of select="$m_shareandenjoytitle"/></xsl:with-param>
	</xsl:call-template>
</xsl:template>
...
<xsl:value-of select="$m_emailaddress"/><INPUT TYPE="TEXT" NAME="email" VALUE="{SHAREANDENJOY/EMAILADDRESS}"/><br/>
<xsl:value-of select="$m_welcomemessage"/> <br/>
<TEXTAREA ROWS="10" COLS="50" NAME="welcome"><xsl:value-of select="SHAREANDENJOY/MESSAGE"/></TEXTAREA><br/>
...
<xsl:template name="RECOMMEND-ENTRY_HEADER">
	<xsl:apply-templates mode="header" select=".">
		<xsl:with-param name="title"><xsl:value-of select="$m_RecommendEntryPageTitle"/></xsl:with-param>
	</xsl:apply-templates>
</xsl:template>

<xsl:template name="RECOMMEND-ENTRY_SUBJECT">
	<xsl:call-template name="SUBJECTHEADER">
		<xsl:with-param name="text"><xsl:value-of select="$m_RecommendEntryPageHeader"/></xsl:with-param>
	</xsl:call-template>
</xsl:template>
...
<xsl:choose>
	...
	<xsl:otherwise>
		<xsl:apply-templates mode="header" select=".">
		<xsl:with-param name="title"><xsl:value-of select="$m_editreviewtitle"/></xsl:with-param>
	</xsl:apply-templates>
	</xsl:otherwise>
	</xsl:choose>
...
<xsl:value-of select="$m_subscribedtothread"/><br/>
</xsl:when>
<xsl:when test="@TOFORUM">
<xsl:value-of select="$m_subscribedtoforum"/><br/>
</xsl:when>
<xsl:when test="@FROMFORUM">
<xsl:value-of select="$m_unsubbedfromforum"/><br/>
</xsl:when>
...
<xsl:value-of select="$m_journalremoved"/><br/>
</xsl:when>
<xsl:otherwise>
<xsl:value-of select="$m_unsubscribedfromthread"/><br/>
</xsl:otherwise>
</xsl:choose>
</xsl:otherwise>
</xsl:choose>
...
<xsl:template name="popsubscribe">
	<html>
		<head>
			<title><xsl:value-of select="$m_subscriberesult"/></title>
			<META NAME="robots" CONTENT="{$robotsetting}"/>
		</head>
		<body bgcolor="{$bgcolour}" text="{$boxfontcolour}" MARGINHEIGHT="0" MARGINWIDTH="0" TOPMARGIN="0" LEFTMARGIN="0" link="{$linkcolour}" vlink="{$vlinkcolour}" alink="{$alinkcolour}">
<SCRIPT LANGUAGE="JavaScript">
...
function closewin()
{
	return window.close();
		...
		<xsl:apply-templates select="SUBSCRIBE-RESULT"/>
		<a href="{$root}javascript:closewin()"><xsl:value-of select="$m_close"/></a>
		</body>
	</html>
</xsl:template>
...
<xsl:template name="CopyrightNotice">
	<!-- start of copyright notice -->
		<div class="copyrightnotice">
			<br/>
			<b><xsl:call-template name="m_copyright2"/></b>
			<br/>
			<br/>
...
<xsl:copy><xsl:apply-templates select="@*"/><xsl:apply-templates select="*|text()"/></xsl:copy>
</xsl:template>
...
<p>
<!--<form method="POST" action="{$root}Register">-->
<div xsl:use-attribute-sets="registermessage"><xsl:call-template name="m_registerslug"/>
<!--	<table border="0" cellspacing="0" cellpadding="0">
		<tr>
		<td>
...
<xsl:comment><xsl:call-template name="m_scriptremoved"/></xsl:comment>
</xsl:template>
...
<tr>
<td bgcolor="#cccc99">
<div STYLE="COLOR: #333300; FONT-FAMILY: Verdana, Arial, Helvetica, Sans-serif; FONT-SIZE: 12px; FONT-WEIGHT: bold; PADDING-LEFT: 8px"><xsl:apply-templates select="SPEAKER"/></div>
</td>
</tr>
</tbody>
</table>
...
<tr>
<td bgcolor="#cccc99">
<div STYLE="COLOR: #333300; FONT-FAMILY: Verdana, Arial, Helvetica, Sans-serif; FONT-SIZE: 12px; FONT-WEIGHT: bold; PADDING-LEFT: 8px"><b><xsl:value-of select="TITLE"/></b></div>
</td>
</tr>
...
<div STYLE="BACKGROUND: url(/furniture/aro_red_sm2.gif) #ffffcc no-repeat 2px 1px; PADDING-LEFT: 8px"><xsl:value-of select="."/></div>
</xsl:for-each>
</div>
</td>
</tr>
...
<font size="3">
<SAMP><xsl:value-of select="substring(SOURCE,1,number(CHARACTER)-1)"/><b><font color="red">[here]</font></b><xsl:value-of select="substring(SOURCE,number(CHARACTER))"/>
</SAMP>
</font>
</xsl:when>
<xsl:otherwise>
			...
			<div class="ModerationTools">
				...
				<xsl:if test="POST-MODERATION-FORM/MESSAGE">
						<xsl:choose>
							...
							<xsl:otherwise>
								<b><xsl:value-of select="POST-MODERATION-FORM/MESSAGE"/></b>
								<br/>
							</xsl:otherwise>
						</xsl:choose>
				</xsl:if>
							...
							<tbody align="left" vAlign="top">
								<xsl:for-each select="POST-MODERATION-FORM/POST">
									<tr>
										...
										<td align="left" vAlign="top"><xsl:value-of select="SUBJECT"/></td>
										<td align="left" vAlign="top" width="100%"><xsl:apply-templates select="TEXT"/></td>
										<td align="left" vAlign="top">
											<table width="100%" cellpadding="0" cellspacing="0">
												<tr>
													...
													<td align="right"><a target="_blank" href="{$root}ModerationHistory?PostID={POST-ID}">Show History</a></td>
												</tr>
												<tr>
													<td colspan="2">
...
// stop hiding -->
	...
	<form action="{$root}ModerateArticle" method="POST" name="ArticleModerationForm" onSubmit="return checkArticleModerationForm()">
		...
		<input type="hidden" name="SiteID" value="{../ARTICLE/ARTICLEINFO/SITEID}"/>
				...
				<tr>
					<td>
							<xsl:if test="@REFERRALS = 1">Referred by 
								<xsl:choose>
									<xsl:when test="number(ARTICLE/REFERRED-BY/USER/USERID) &gt; 0"><xsl:apply-templates select="ARTICLE/REFERRED-BY/USER"/></xsl:when>
									<xsl:otherwise><span class="moderationformerror">Auto Referral</span></xsl:otherwise>
								</xsl:choose>
								<br/>
							</xsl:if>
							...
							<xsl:if test="@TYPE='COMPLAINTS'">
								...
								<xsl:choose>
									<xsl:when test="string-length(ARTICLE/CORRESPONDENCE-EMAIL) &gt; 0">
										<a href="mailto:{ARTICLE/CORRESPONDENCE-EMAIL}"><xsl:value-of select="ARTICLE/CORRESPONDENCE-EMAIL"/></a>
									</xsl:when>
									<xsl:when test="number(ARTICLE/COMPLAINANT-ID) &gt; 0">Researcher <a href="{$root}U{ARTICLE/COMPLAINANT-ID}">U<xsl:value-of select="ARTICLE/COMPLAINANT-ID"/></a></xsl:when>
									<xsl:otherwise>Anonymous Complainant</xsl:otherwise>
								</xsl:choose>
								<br/>
			...
			Notes<br/>
			<textarea cols="60" name="notes" rows="10" wrap="virtual"><xsl:value-of select="ARTICLE/NOTES"/></textarea>
			<br/>
			<input type="hidden" name="Referrals">
...
// unhide </xsl:comment>
		...
		<body bgColor="lightblue">
			<div class="ModerationTools">
				<h2 align="center">Moderation Home Page for <br/><xsl:apply-templates select="/H2G2/PAGE-OWNER/USER"/></h2>
				<form method="post" action="{$root}Moderate">
					<table border="0" cellPadding="0" cellSpacing="0" width="100%">
						<tr>
							...
							<td align="right">
									<a href="{$root}ModerateStats">Moderation Stats Page</a> <br/>
									<a href="{$root}ModerationBilling">Moderation Billing Page</a> <br/>
							</td>
						</tr>
					</table>
					<br/>
					...
					<table border="1" cellPadding="0" cellSpacing="0" width="100%">
						...
						<tr align="center" vAlign="top">
							<td colspan="6"><b>Moderation</b></td>
						</tr>
						<tr align="center" vAlign="top">
							<td colspan="2"><b>Forums</b></td>
						...
						<tr align="left" vAlign="top">
							...
							-->
							<td>
								<xsl:if test="number(MODERATOR-HOME/MODERATION/FORUMS/NEW/LOCKED) &gt; 0"><xsl:attribute name="bgColor">red</xsl:attribute></xsl:if>
								Locked: <xsl:value-of select="MODERATOR-HOME/MODERATION/FORUMS/NEW/LOCKED"/>
							</td>
							<td>
								<xsl:if test="number(MODERATOR-HOME/MODERATION/FORUMS/COMPLAINTS/LOCKED) &gt; 0"><xsl:attribute name="bgColor">red</xsl:attribute></xsl:if>
							...
							-->
							<td>
								<xsl:if test="number(MODERATOR-HOME/MODERATION/ARTICLES/NEW/LOCKED) &gt; 0"><xsl:attribute name="bgColor">red</xsl:attribute></xsl:if>
								Locked: <xsl:value-of select="MODERATOR-HOME/MODERATION/ARTICLES/NEW/LOCKED"/>
							</td>
							<td>
								<xsl:if test="number(MODERATOR-HOME/MODERATION/ARTICLES/COMPLAINTS/LOCKED) &gt; 0"><xsl:attribute name="bgColor">red</xsl:attribute></xsl:if>
							...
							<tr align="left" vAlign="top">
								...
								<td>Queued: <xsl:value-of select="MODERATOR-HOME/MODERATION/FORUMS/NEW/QUEUED"/></td>
								<td>Queued: <xsl:value-of select="MODERATOR-HOME/MODERATION/FORUMS/COMPLAINTS/QUEUED"/></td>
								<!-- <td>Queued: <xsl:value-of select="MODERATOR-HOME/MODERATION/ARTICLES/LEGACY/QUEUED"/></td> -->
								<td>Queued: <xsl:value-of select="MODERATOR-HOME/MODERATION/ARTICLES/NEW/QUEUED"/></td>
								<td>Queued: <xsl:value-of select="MODERATOR-HOME/MODERATION/ARTICLES/COMPLAINTS/QUEUED"/></td>
							</tr>
						<tr align="center" vAlign="top">
							<td colspan="2" rowspan="2"><input type="submit" name="UnlockForums" value="Unlock Forums" onClick="return confirmUnlockOnOtherUser()"/></td>
							<td colspan="2" rowspan="2"><input type="submit" name="UnlockArticles" value="Unlock Entries" onClick="return confirmUnlockOnOtherUser()"/></td>
						</tr>
					</table>
					<br/>
					...
					<xsl:if test="MODERATOR-HOME/@ISREFEREE = 1 or $superuser = 1">
						...
						<table border="1" cellPadding="0" cellSpacing="0">
							...
							<tr align="center" vAlign="top">
								<td colspan="1">
									<xsl:if test="$ownerisviewer = 0">
										<span class="moderationheader"><b>Nicknames</b></span>
									</xsl:if>
									<xsl:if test="$ownerisviewer = 1">
										<span class="moderationheader"><b><a href="{$root}ModerateNicknames?Next=Process">Nicknames</a></b></span>
									</xsl:if>
								</td>
							</tr>
							<tr align="left" vAlign="top">
								<td>
									<xsl:if test="number(MODERATOR-HOME/MODERATION/NICKNAMES/NEW/LOCKED) &gt; 0"><xsl:attribute name="bgColor">red</xsl:attribute></xsl:if>
									Locked: <xsl:value-of select="MODERATOR-HOME/MODERATION/NICKNAMES/NEW/LOCKED"/>
								</td>
							</tr>
								<tr align="left" vAlign="top">
									<td>Queued: <xsl:value-of select="MODERATOR-HOME/MODERATION/NICKNAMES/NEW/QUEUED"/></td>
								</tr>
							<tr align="center" vAlign="top">
								<td colspan="1" rowspan="1"><input type="submit" name="UnlockNicknames" value="Unlock Nicknames" onClick="return confirmUnlockOnOtherUser()"/></td>
							</tr>
						</table>
						</div>
						</xsl:if>
						...
						<table border="1" cellPadding="0" cellSpacing="0" width="100%">
							<tr align="center" vAlign="top">
								<td colspan="6"><b><span class="moderationheader">Referrals</span></b></td>
							</tr>
							<tr align="center" vAlign="top">
								<td colspan="2"><b>Forums</b></td>
								<td colspan="2"><b>Entries</b></td>
							...
							<tr align="left" vAlign="top">
								...
								-->
								<td>
									<xsl:if test="number(MODERATOR-HOME/REFERRALS/FORUMS/NEW/LOCKED) &gt; 0"><xsl:attribute name="bgColor">red</xsl:attribute></xsl:if>
									Locked: <xsl:value-of select="MODERATOR-HOME/REFERRALS/FORUMS/NEW/LOCKED"/>
								</td>
								<td>
									<xsl:if test="number(MODERATOR-HOME/REFERRALS/FORUMS/COMPLAINTS/LOCKED) &gt; 0"><xsl:attribute name="bgColor">red</xsl:attribute></xsl:if>
								...
								-->
								<td>
									<xsl:if test="number(MODERATOR-HOME/REFERRALS/ARTICLES/NEW/LOCKED) &gt; 0"><xsl:attribute name="bgColor">red</xsl:attribute></xsl:if>
									Locked: <xsl:value-of select="MODERATOR-HOME/REFERRALS/ARTICLES/NEW/LOCKED"/>
								</td>
								<td>
									<xsl:if test="number(MODERATOR-HOME/REFERRALS/ARTICLES/COMPLAINTS/LOCKED) &gt; 0"><xsl:attribute name="bgColor">red</xsl:attribute></xsl:if>
								...
								<tr align="left" vAlign="top">
									...
									<td>Queued: <xsl:value-of select="MODERATOR-HOME/REFERRALS/FORUMS/NEW/QUEUED"/></td>
									<td>Queued: <xsl:value-of select="MODERATOR-HOME/REFERRALS/FORUMS/COMPLAINTS/QUEUED"/></td>
									<!-- <td>Queued: <xsl:value-of select="MODERATOR-HOME/REFERRALS/ARTICLES/LEGACY/QUEUED"/></td> -->
									<td>Queued: <xsl:value-of select="MODERATOR-HOME/REFERRALS/ARTICLES/NEW/QUEUED"/></td>
									<td>Queued: <xsl:value-of select="MODERATOR-HOME/REFERRALS/ARTICLES/COMPLAINTS/QUEUED"/></td>
								</tr>
							<tr align="center" vAlign="top">
								<td colspan="2" rowspan="2"><input type="submit" name="UnlockForumReferrals" value="Unlock Forum Referrals" onClick="return confirmUnlockOnOtherUser()"/></td>
								<td colspan="2" rowspan="2"><input type="submit" name="UnlockArticleReferrals" value="Unlock Entry Referrals" onClick="return confirmUnlockOnOtherUser()"/></td>
							</tr>
						</table>
						<br/>
						<div align="center">
						<table border="1" cellPadding="0" cellSpacing="0" width="50%">
							<tr align="center" vAlign="top">
								<td colspan="2"><b><span class="moderationheader">General Complaints</span></b></td>
							</tr>
							<tr align="center" vAlign="top">
								<td width="50%">
									<xsl:if test="$ownerisviewer = 0">
							...
							<tr align="left" vAlign="top">
								<td>
									<xsl:if test="number(MODERATOR-HOME/MODERATION/GENERAL/COMPLAINTS/LOCKED) &gt; 0"><xsl:attribute name="bgColor">red</xsl:attribute></xsl:if>
									Locked: <xsl:value-of select="MODERATOR-HOME/MODERATION/GENERAL/COMPLAINTS/LOCKED"/>
								</td>
								<td>
									<xsl:if test="number(MODERATOR-HOME/REFERRALS/GENERAL/COMPLAINTS/LOCKED) &gt; 0"><xsl:attribute name="bgColor">red</xsl:attribute></xsl:if>
									Locked: <xsl:value-of select="MODERATOR-HOME/REFERRALS/GENERAL/COMPLAINTS/LOCKED"/>
								</td>
							</tr>
								<tr align="left" vAlign="top">
									<td>Queued: <xsl:value-of select="MODERATOR-HOME/MODERATION/GENERAL/COMPLAINTS/QUEUED"/></td>
									<td>Queued: <xsl:value-of select="MODERATOR-HOME/REFERRALS/GENERAL/COMPLAINTS/QUEUED"/></td>
								</tr>
							<tr align="center" vAlign="top">
								<td><input type="submit" name="UnlockGeneral" value="Unlock General" onClick="return confirmUnlockOnOtherUser()"/></td>
								<td><input type="submit" name="UnlockGeneralReferrals" value="Unlock General Referrals" onClick="return confirmUnlockOnOtherUser()"/></td>
							</tr>
						</table>
						</div>
					</xsl:if>
					...
					<table border="1" cellPadding="0" cellSpacing="0" width="100%">
						<tr>
							<td width="25%" align="center"><b>
								<xsl:value-of select="$m_modsitename"/></b></td>
							<td width="25%" align="center"><b>
								<xsl:value-of select="$m_modnumberqueued"/></b></td>
							<td width="25%" align="center"><b>
								<xsl:value-of select="$m_modnumbercomplaints"/></b></td>
							<td width="25%" align="center"><b>
								<xsl:value-of select="$m_modcurrentlyvisible"/></b></td>
						</tr>
							...
							<tr>
								...
								<xsl:if test="ISMODERATOR = 1">
									<xsl:if test="ISREFEREE = 1">
										<td><xsl:value-of select="NOT-COMPLAINTS"/>(<xsl:value-of select="NOT-COMPLAINTS-REF"/>)</td>
										<td><xsl:value-of select="COMPLAINTS"/>(<xsl:value-of select="COMPLAINTS-REF"/>)</td>
									</xsl:if>
									<xsl:if test="not(ISREFEREE = 1)">
										<td><xsl:value-of select="number(NOT-COMPLAINTS)"/></td>
										<td><xsl:value-of select="number(COMPLAINTS)"/></td>
									</xsl:if>
								</xsl:if>
								...
								<td><xsl:if test="number(ISMODERATOR) = 1">
					...
					<xsl:for-each select="MODERATION-STATS">
						<div align="center">
							<table border="1" cellPadding="4" cellSpacing="0">
								<tr align="center" vAlign="top">
									<td colspan="7"><b><span class="moderationheader">Total Locked/Referred Items per User</span></b></td>
								</tr>
								<tr align="center" vAlign="top">
									<td><b>User</b></td>
									<td><b>Status</b></td>
									...
									<tr align="center" vAlign="top">
										...
										<td>
											<xsl:choose>
												...
												<xsl:otherwise><span class="moderationformerror">Unknown</span></xsl:otherwise>
											</xsl:choose>
										</td>
										<td><xsl:value-of select="TOTAL-ENTRIES"/></td>
										<td><xsl:value-of select="TOTAL-POSTS"/></td>
										<td><xsl:value-of select="TOTAL-NICKNAMES"/></td>
										<td><xsl:value-of select="TOTAL-GENERAL"/></td>
										<td><a href="{$root}ModerateStats?UserID={USERID}&amp;Unlock=1">Unlock All</a></td>
									</tr>
								</xsl:for-each>
							</table>
							<br/><br/>
	...
	<html>
		...
		<body b4gColor="lightblue">
			<div class="ModerationTools">
				...
				<xsl:for-each select="ERROR">
					<xsl:choose>
						<xsl:when test="@TYPE = 'INVALID-H2G2ID'"><b><span class="moderationformerror">The Entry ID supplied was not a valid one.</span></b><br/></xsl:when>
						<xsl:otherwise><b><span class="moderationformerror"><xsl:value-of select="."/></span></b><br/></xsl:otherwise>
					</xsl:choose>
				</xsl:for-each>
				<form method="post" action="{$root}ModerationHistory">
					...
					<br/>
					<xsl:choose>
						<xsl:when test="not(MODERATION-HISTORY)">Enter an Entry ID or Post ID and click 'Fetch History'.<br/></xsl:when>
						<xsl:when test="not(MODERATION-HISTORY/MODERATION)"><b>There is no moderation history for the item specified.</b><br/></xsl:when>
						<xsl:when test="not(number(MODERATION-HISTORY/@H2G2ID) &gt; 0 or number(MODERATION-HISTORY/@POSTID) &gt; 0)">No valid Entry ID or Post ID was provided.<br/></xsl:when>
					</xsl:choose>
					<br/>
								...
								<table border="1" cellPadding="4" cellSpacing="0">
									<tr align="center" vAlign="top">
										<td colspan="13">
											<span class="moderationheader">
												<xsl:choose>
													<xsl:when test="@TYPE='ARTICLE'">Moderation History for Entry A<xsl:value-of select="@H2G2ID"/></xsl:when>
													<xsl:when test="@TYPE='POST'">Moderation History for Post P<xsl:value-of select="@POSTID"/></xsl:when>
									...
									<tr align="center" vAlign="top">
										<td colspan="13">
												<b>Subject</b>: 
												<xsl:choose>
													<xsl:when test="@TYPE='POST'"><a href="{$root}F{@FORUMID}?thread={@THREADID}&amp;post={@POSTID}#p{@POSTID}"><xsl:value-of select="SUBJECT"/></a></xsl:when>
													<xsl:otherwise><a href="{$root}A{@H2G2ID}"><xsl:value-of select="SUBJECT"/></a></xsl:otherwise>
												</xsl:choose>
												<br/>
												<b>
													<xsl:choose>
									...
									<xsl:if test="MODERATION">
										<tr align="center" vAlign="top">
											...
											<td><b>Date Queued</b></td>
											<td><b>Date Locked</b></td>
											<td><b>Date Referred</b></td>
											<td><b>Date Completed</b></td>
											<td><b>Notes<br/><img src="{$imagesource}blank.gif" width="200" height="1"/></b></td>
											<td><b>Complainant</b></td>
											<td><b>Correspondence Email</b></td>
											<td><b><nobr>Complaint Text</nobr><br/><img src="{$imagesource}blank.gif" width="200" height="1"/></b></td>
										</tr>
									</xsl:if>
									<xsl:for-each select="MODERATION">
										<tr align="center" vAlign="top">
											<td><xsl:value-of select="MODERATION-ID"/></td>
											<td>
												<xsl:choose>
													...
													<xsl:otherwise>Invalid Status: <xsl:value-of select="MODERATION-STATUS"/></xsl:otherwise>
												</xsl:choose>
											</td>
											<td>
												<xsl:choose>
											...
											<td>
												<xsl:choose>
													<xsl:when test="LOCKED-BY/USER"><xsl:apply-templates select="LOCKED-BY/USER"/></xsl:when>
													<xsl:otherwise>-</xsl:otherwise>
												</xsl:choose>
											</td>
											<td>
												<xsl:choose>
													<xsl:when test="REFERRED-BY/USER"><xsl:apply-templates select="REFERRED-BY/USER"/></xsl:when>
													<xsl:otherwise>-</xsl:otherwise>
												</xsl:choose>
											</td>
											<td>
												<xsl:choose>
													<xsl:when test="DATE-QUEUED/DATE"><xsl:apply-templates select="DATE-QUEUED/DATE" mode="short"/></xsl:when>
													<xsl:otherwise>-</xsl:otherwise>
												</xsl:choose>
											</td>
											<td>
												<xsl:choose>
													<xsl:when test="DATE-LOCKED/DATE"><xsl:apply-templates select="DATE-LOCKED/DATE" mode="short"/></xsl:when>
													<xsl:otherwise>-</xsl:otherwise>
												</xsl:choose>
											</td>
											<td>
												<xsl:choose>
													<xsl:when test="DATE-REFERRED/DATE"><xsl:apply-templates select="DATE-REFERRED/DATE" mode="short"/></xsl:when>
													<xsl:otherwise>-</xsl:otherwise>
												</xsl:choose>
											</td>
											<td>
												<xsl:choose>
													<xsl:when test="DATE-COMPLETED/DATE"><xsl:apply-templates select="DATE-COMPLETED/DATE" mode="short"/></xsl:when>
													<xsl:otherwise>-</xsl:otherwise>
												</xsl:choose>
											</td>
											<xsl:choose>
												<xsl:when test="string-length(NOTES) &gt; 0">
													<td align="left"><xsl:value-of select="NOTES"/></td>
												</xsl:when>
											...
											<td>
												<xsl:choose>
													...
													<xsl:when test="COMPLAINANT/USER"><xsl:apply-templates select="COMPLAINANT/USER"/></xsl:when>
													<xsl:otherwise>-</xsl:otherwise>
												</xsl:choose>
											</td>
											<td>
												<xsl:choose>
													<xsl:when test="COMPLAINANT/USER/CORRESPONDENCE-EMAIL"><a href="mailto:{COMPLAINANT/USER/CORRESPONDENCE-EMAIL}"><xsl:value-of select="COMPLAINANT/USER/CORRESPONDENCE-EMAIL"/></a></xsl:when>
													<xsl:otherwise>-</xsl:otherwise>
												</xsl:choose>
											</td>
											<xsl:choose>
					...
					<table>
						<tr align="left" valign="center">
							<td>Entry Number:</td>
							<td><input type="text" name="h2g2ID">
									<xsl:if test="number(MODERATION-HISTORY/@H2G2ID) &gt; 0">
										<xsl:attribute name="value"><xsl:value-of select="MODERATION-HISTORY/@H2G2ID"/></xsl:attribute>
									</xsl:if>
								</input>
							</td>
						</tr>
						<tr align="left" valign="center">
							...
							<td><input type="text" name="PostID">
									<xsl:if test="number(MODERATION-HISTORY/@POSTID) &gt; 0">
										<xsl:attribute name="value"><xsl:value-of select="MODERATION-HISTORY/@POSTID"/></xsl:attribute>
									</xsl:if>
								</input>
							</td>
						</tr>
						...
						<tr align="left" valign="center">
							...
							<td><input type="submit" name="Fetch" value="Fetch History"/></td>
						</tr>
					</table>
				</form>
			</div>
        ...
        <xsl:for-each select="POST-EDIT-FORM/MESSAGE">
          <b><xsl:value-of select="."/></b><BR/><BR/>
				...
				<form name="TextForm" method="post" action="{$root}EditPost">
					...
					<xsl:choose>
						<xsl:when test="POST-EDIT-FORM/HIDDEN &gt; 0"> <span class="posthidden">(Post is currently hidden)</span></xsl:when>
						<xsl:otherwise> <span class="posthidden">(Post is currently visible)</span></xsl:otherwise>
					</xsl:choose>
					<br/><br/>
...
<xsl:template match="H2G2[@TYPE='USER-COMPLAINT']">
	<html>
		<head>
			...
			<meta http-equiv="Expires" content="0"/>
			<META NAME="robots" CONTENT="{$robotsetting}"/>
			<title><xsl:value-of select="$m_usercomplaintpopuptitle"/></title>
			<script language="JavaScript">
<xsl:comment> hide this script from non-javascript-enabled browsers
		...
		<body bgColor="white">
                ...
                <xsl:value-of select="USER-COMPLAINT-FORM/ERROR"/>
					...
					<xsl:when test="USER-COMPLAINT-FORM/MESSAGE/@TYPE='SUBMIT-SUCCESSFUL'">
						<b><xsl:value-of select="$m_complaintsuccessfullyregisteredmessage"/></b><br/><br/>
						Your complaint reference number is <b><xsl:value-of select="USER-COMPLAINT-FORM/MODERATION-REFERENCE"/></b><br/><br/>
					</xsl:when>
					...
					<xsl:when test="USER-COMPLAINT-FORM">
						...
						<xsl:choose>
							...
							<xsl:otherwise>
								...
								<xsl:choose>
									<xsl:when test="USER-COMPLAINT-FORM/@TYPE='ARTICLE'"><xsl:call-template name="m_articlecomplaintdescription"/></xsl:when>
									<xsl:when test="USER-COMPLAINT-FORM/@TYPE='POST'"><xsl:call-template name="m_postingcomplaintdescription"/></xsl:when>
									<xsl:when test="USER-COMPLAINT-FORM/@TYPE='GENERAL'"><xsl:call-template name="m_generalcomplaintdescription"/></xsl:when>
									<xsl:otherwise><xsl:call-template name="m_generalcomplaintdescription"/></xsl:otherwise>
								</xsl:choose>
							</xsl:otherwise>
						</xsl:choose>
						<br/><br/>
						<form method="post" action="{$root}UserComplaint" name="UserComplaintForm" id="UserComplaintForm" onSubmit="return checkUserComplaintForm()">
							<input type="hidden" name="Type"><xsl:attribute name="value"><xsl:value-of select="USER-COMPLAINT-FORM/@TYPE"/></xsl:attribute></input>
							<xsl:if test="USER-COMPLAINT-FORM/POST-ID"><input type="hidden" name="PostID"><xsl:attribute name="value"><xsl:value-of select="USER-COMPLAINT-FORM/POST-ID"/></xsl:attribute></input></xsl:if>
							<xsl:if test="USER-COMPLAINT-FORM/H2G2-ID"><input type="hidden" name="h2g2ID"><xsl:attribute name="value"><xsl:value-of select="USER-COMPLAINT-FORM/H2G2-ID"/></xsl:attribute></input></xsl:if>
							<xsl:if test="USER-COMPLAINT-FORM/URL"><input type="hidden" name="URL"><xsl:attribute name="value"><xsl:value-of select="USER-COMPLAINT-FORM/URL"/></xsl:attribute></input></xsl:if>
							<textarea name="ComplaintText" id="ComplaintText" cols="70" rows="15" wrap="virtual"><xsl:value-of select="$m_defaultcomplainttext"/></textarea>
							<br/>
...
<xsl:template name="MONTHSUMMARY_HEADER">
	<xsl:apply-templates mode="header" select=".">
		<xsl:with-param name="title"><xsl:value-of select="$m_pagetitlestart"/><xsl:value-of select="$alt_MonthSummarySub"/></xsl:with-param>
	</xsl:apply-templates>
</xsl:template>

<xsl:template match="MONTHSUMMARY">
	<xsl:call-template name="SUBJECTHEADER">
	<xsl:with-param name="text"><xsl:value-of select="$alt_MonthSummarySub"/></xsl:with-param>
	</xsl:call-template>
...
<xsl:choose>
	...
	<xsl:call-template name="HEADER">
	<xsl:with-param name="text"><xsl:value-of select="concat($currententry/DATE/@DAYNAME,' ',$currententry/DATE/@DAY,' ',$currententry/DATE/@MONTHNAME,' ',$currententry/DATE/@YEAR)"/></xsl:with-param>
	</xsl:call-template>
...
<xsl:with-param name="groupname"><xsl:value-of select="@NAME"/></xsl:with-param>
</xsl:call-template>
</xsl:template>
...
<TR>
<TD ALIGN="center">
<SELECT NAME="{$groupname}"><xsl:attribute name="SIZE"><xsl:value-of select="@LENGTH"/></xsl:attribute>
...
<xsl:template name="INTERNAL-TOOLS-NAVIGATION">
	...
	<table border="0" width="100%" cellpadding="2" cellspacing="4">
		<tr>
			<td>&nbsp;</td>
			<td><nobr><b>Tools Available:</b></nobr></td>
		</tr>
		<xsl:if test="/H2G2/VIEWING-USER/USER/GROUPS/GROUP/NAME='EDITOR'">
			<tr colspan="2"><td>&nbsp;</td></tr>
			<tr>
				<td>&nbsp;</td>
				<td><nobr><b>Editor Tools</b></nobr></td>
			</tr>
			<xsl:if test="/H2G2/@TYPE!='INSPECT-USER'">
				<tr>
					<td>&nbsp;</td>
					<td><nobr><a href="{$root}InspectUser" target="_top">Inspect User</a></nobr></td>
				</tr>
			</xsl:if>
			<xsl:if test="/H2G2/@TYPE!='GROUP-MANAGEMENT'">
				<tr>
					<td>&nbsp;</td>
					<td><nobr><a href="{$root}ManageGroups" target="_top">Group Management</a></nobr></td>
				</tr>
			</xsl:if>
			<tr>
				<td>&nbsp;</td>
				<td><nobr><a href="{$root}editor.cgi" target="_top">Entry Editor</a></nobr></td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td><nobr><a href="{$root}edithome.cgi" target="_top">Editor Homepage</a></nobr></td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td><nobr><a href="{$root}editqueue.cgi" target="_top">Waiting to Go Live</a></nobr></td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td><nobr><a href="{$root}editfrontpageraw.cgi" target="_top">Edit Front Page</a></nobr></td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td><nobr><a href="{$root}catpage.cgi" target="_top">Categorisation</a></nobr></td>
			</tr>
			<tr colspan="2"><td>&nbsp;</td></tr>
			<tr>
				<td>&nbsp;</td>
				<td><nobr><b>Peer Review</b></nobr></td>
			</tr>
			<xsl:if test="/H2G2/@TYPE!='SCOUT-RECOMMENDATIONS'">
				<tr>
					<td>&nbsp;</td>
					<td><nobr><a href="{$root}ScoutRecommendations" target="_top">Scout Recommendations</a></nobr></td>
				</tr>
			</xsl:if>
			<xsl:if test="/H2G2/@TYPE!='SUB-ALLOCATION'">
				<tr>
					<td>&nbsp;</td>
					<td><nobr><a href="{$root}AllocateSubs" target="_top">Allocate Subs</a></nobr></td>
				</tr>
			</xsl:if>
			<tr colspan="2"><td>&nbsp;</td></tr>
			<tr>
				<td>&nbsp;</td>
				<td><nobr><b>Moderation</b></nobr></td>
			</tr>
			<xsl:if test="/H2G2/@TYPE!='MODERATE-HOME'">
				<tr>
					<td>&nbsp;</td>
					<td><nobr><a href="{$root}Moderate" target="_top">Moderation Home Page</a></nobr></td>
				</tr>
			</xsl:if>
			<xsl:if test="/H2G2/@TYPE!='MODERATE-STATS'">
				<tr>
					<td>&nbsp;</td>
					<td><nobr><a href="{$root}ModerateStats" target="_top">Moderation Stats Page</a></nobr></td>
				</tr>
			</xsl:if>
				<tr>
					<td>&nbsp;</td>
					<td><nobr><a href="{$root}ModerationHistory" target="_top">Moderation History</a></nobr></td>
				</tr>
			<tr colspan="2"><td>&nbsp;</td></tr>
			<tr>
				<td>&nbsp;</td>
				<td><nobr><b>Miscellaneous</b></nobr></td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td><nobr><a href="{$root}MoveThread" target="_top">Move Thread</a></nobr></td>
			</tr>
		</xsl:if>
		<tr>
			<td>&nbsp;</td>
			<td><nobr><a href="{$root}RandomEntry" target="_top">Random Entry</a></nobr></td>
		</tr>
		<tr>
			<td>&nbsp;</td>
			<td><nobr><a href="{$root}RandomNormalEntry" target="_top">Random Normal Entry</a></nobr></td>
		</tr>
		<tr>
			<td>&nbsp;</td>
			<td><nobr><a href="{$root}RandomRecommendedEntry" target="_top">Random Recommended Entry</a></nobr></td>
		</tr>
		<tr>
			<td>&nbsp;</td>
			<td><nobr><a href="{$root}RandomEditedEntry" target="_top">Random Edited Entry</a></nobr></td>
		</tr>
	</table>
</xsl:template>
...
<xsl:template name="SUB-ALLOCATION_HEADER">
	<xsl:apply-templates mode="header" select=".">
		<xsl:with-param name="title"><xsl:value-of select="$m_pagetitlestart"/>Sub Editor Allocation</xsl:with-param>
	</xsl:apply-templates>
</xsl:template>
				...
				<tr valign="top">
					...
					<td width="100">
							<table border="0" cellspacing="2" cellpadding="0">
								...
								<tr>
									<td colspan="7" align="center"><span class="subheaderfont"><b>Sub Editors</b></span></td>
								</tr>
							...
							<tr>
								<td>
										<table border="0" cellspacing="2" cellpadding="0">
											<!-- put the heading in it's own row -->
											<tr>
												<td colspan="7" align="center"><span class="subheaderfont"><b>Recommendations Awaiting Allocation</b></span></td>
											</tr>
							...
							<tr>
								<td>
										<table border="0" cellspacing="2" cellpadding="0">
											<!-- put the heading in it's own row -->
											<tr>
												<td colspan="11" align="center"><span class="subheaderfont"><b>Allocations Waiting to be Returned</b></span></td>
											</tr>
											<!-- and put a nice gap after it -->
											<tr>
												<td colspan="11">&nbsp;</td>
											...
											<xsl:for-each select="ALLOCATED-RECOMMENDATIONS/ARTICLE-LIST/ARTICLE">
												<tr valign="top">
													...
													<td>&nbsp;</td>
													<td>
														<xsl:choose><xsl:when test="NOTIFIED/text() = 1">Yes</xsl:when><xsl:otherwise>No</xsl:otherwise></xsl:choose>
													</td>
													<td>&nbsp;</td>
													<td>
...
<xsl:template name="SCOUT-RECOMMENDATIONS_HEADER">
	<xsl:apply-templates mode="header" select=".">
		<xsl:with-param name="title"><xsl:value-of select="$m_pagetitlestart"/>Scout Recommendations</xsl:with-param>
	</xsl:apply-templates>
</xsl:template>
		...
		<xsl:attribute name="name">MoveThreadForm<xsl:value-of select="THREAD-ID"/></xsl:attribute>
			...
			<xsl:choose>
				<xsl:when test="SUCCESS='1'">
					<b>Thread moved successfully!</b><br/>
				...
				<xsl:when test="SUCCESS='0'">
					<b><span xsl:use-attribute-sets="WarningMessageFont">Move failed!</span></b>
				</xsl:when>
			</xsl:choose>
			<br/>
			...
			<table width="100%" cellpadding="0" cellspacing="0" border="0">
				<tr valign="center">
					...
					<td>&nbsp;</td>
					<td width="100%">
						<xsl:if test="string-length(THREAD-SUBJECT) &gt; 0"><nobr>'<xsl:value-of select="THREAD-SUBJECT"/>'</nobr></xsl:if>
					</td>
				</tr>
				<tr valign="center">
					...
					<td>&nbsp;</td>
					<td width="100%">
						<xsl:if test="string-length(NEW-FORUM-TITLE) &gt; 0">'<xsl:value-of select="NEW-FORUM-TITLE"/>'</xsl:if>
					</td>
				</tr>
	...
	<form name="InspectUserForm" method="post" action="{$root}InspectUser">
		<input type="hidden" name="UserID" value="{USER/USERID}"/>
			<table width="100%" cellpadding="0" cellspacing="0" border="0">
				...
				<tr align="center"><td colspan="5"><span class="inspecttitle">Inspecting U<xsl:value-of select="USER/USERID"/> : <xsl:apply-templates select="USER"/></span></td></tr>
				<tr><td colspan="5">&nbsp;</td></tr>
				<tr valign="top">
					<td colspan="2">
					...
					<td colspan="3"><b>Date Joined: </b><xsl:apply-templates select="USER/DATE-JOINED/DATE" mode="absolute"/></td>
				</tr>
				<tr valign="top">
					<td colspan="5">
				...
				<tr valign="top">
					...
					<td>&nbsp;</td>
					<td><b>LoginName:</b> <br/><input type="text" name="LoginName" value="{USER/LOGIN-NAME}" disabled="disabled"/></td>
				</tr>
				<tr valign="top">
					<td><b>First Names:</b> <br/><input type="text" name="FirstNames" value="{USER/FIRST-NAMES}"/></td>
					<td>&nbsp;</td>
					<td><b>Last Name:</b> <br/><input type="text" name="LastName" value="{USER/LAST-NAME}"/></td>
					<td>&nbsp;</td>
					<td><b>BBC User ID:</b> <br/><input type="text" name="BBCUID" value="{USER/BBCUID}" disabled="disabled"/></td>
				</tr>
				<tr valign="top">
					<td>
						<b>Status:</b> <br/>
					...
					<td>&nbsp;</td>
					<td><b>Password:</b> <br/><input type="text" name="Password" value="{USER/PASSWORD}"/></td>
					<td>&nbsp;</td>
					<td>
			...
			<table cellpadding="0" cellspacing="0" border="0">
				<tr valign="top"><td colspan="5"><b>Group Membership:</b></td></tr>
...
<xsl:template name="GROUP-MANAGEMENT_HEADER">
	<xsl:apply-templates mode="header" select=".">
		<xsl:with-param name="title"><xsl:value-of select="$m_pagetitlestart"/>Manage Groups</xsl:with-param>
	</xsl:apply-templates>
</xsl:template>
...
<xsl:variable name="uindex"><xsl:value-of select="@UINDEX"/></xsl:variable>
...
<xsl:choose>
<xsl:when test="@BUTTON"><xsl:value-of select="@BUTTON"/></xsl:when>
...
<TEXTAREA WRAP="VIRTUAL" ROWS="{$rows}" COLS="{$cols}" NAME="body"><xsl:value-of select="."/></TEXTAREA><br/>
...
<TR>
<TD ALIGN="center">
<SELECT NAME="{@NAME}"><xsl:attribute name="SIZE"><xsl:value-of select="@LENGTH"/></xsl:attribute>
<OPTION value="0"><xsl:choose><xsl:when test="FIRSTITEM"><xsl:value-of select="FIRSTITEM"/></xsl:when><xsl:otherwise><xsl:value-of select="$m_dropdownpleasechooseone"/></xsl:otherwise></xsl:choose></OPTION>
<OPTION value="0">-----------------</OPTION>
<xsl:for-each select="ITEM">
<OPTION value="{@H2G2|@BIO|@HREF}"><xsl:value-of select="."/></OPTION>
</xsl:for-each>
</SELECT>&nbsp;
    <xsl:choose>
        <xsl:when test="@TYPE='command'">
...
<xsl:template name="COMING-UP_SUBJECT">
	<xsl:call-template name="SUBJECTHEADER">
	<xsl:with-param name="text"><xsl:value-of select="$m_whatscomingupheader"/></xsl:with-param>
	</xsl:call-template>
</xsl:template>
...
<xsl:if test="RECOMMENDATION[ACCEPTEDSTATUS = 1 and GUIDESTATUS = 4]">
	<xsl:call-template name="HEADER">
	<xsl:with-param name="text"><xsl:value-of select="$m_cominguprecheader"/></xsl:with-param>
	</xsl:call-template>
<xsl:call-template name="m_cominguprecintro"/><TABLE BORDER="0" CELLPADDING="2">
<TR>
<TD><xsl:value-of select="$m_comingupid"/></TD>
<TD><xsl:value-of select="$m_comingupsubject"/></TD>
</TR>
...
<xsl:if test="RECOMMENDATION[ACCEPTEDSTATUS = 2 and GUIDESTATUS = 4]">
	<xsl:call-template name="HEADER">
	<xsl:with-param name="text"><xsl:value-of select="$m_comingupwitheditorheader"/></xsl:with-param>
	</xsl:call-template>
<xsl:call-template name="m_comingupwitheditorintro"/><TABLE BORDER="0" CELLPADDING="2">
<TR>
<TD><xsl:value-of select="$m_comingupid"/></TD>
<TD><xsl:value-of select="$m_comingupsubject"/></TD>
</TR>
...
<xsl:if test="RECOMMENDATION[ACCEPTEDSTATUS = 3 and (GUIDESTATUS = 6 or GUIDESTATUS = 13)]">
	<xsl:call-template name="HEADER">
	<xsl:with-param name="text"><xsl:value-of select="$m_comingupreturnheader"/></xsl:with-param>
	</xsl:call-template>
<xsl:call-template name="m_comingupreturnintro"/><TABLE BORDER="0" CELLPADDING="2">
<TR>
<TD><xsl:value-of select="$m_comingupid"/></TD>
<TD><xsl:value-of select="$m_comingupsubject"/></TD>
</TR>
...
<TR>
<TD>A<xsl:value-of select="ORIGINAL/H2G2ID"/></TD>
<TD><A href="{$root}A{ORIGINAL/H2G2ID}"><xsl:value-of select="SUBJECT"/></A></TD>
</TR>
</xsl:template>
...
<TR>
<TD>A<xsl:value-of select="EDITED/H2G2ID"/></TD>
<TD><A href="{$root}A{EDITED/H2G2ID}"><xsl:value-of select="SUBJECT"/></A></TD>
</TR>
...
<xsl:apply-templates mode="header" select=".">
<xsl:with-param name="title"><xsl:value-of select="$m_pagetitlestart"/><xsl:value-of select="$m_submitreviewforumheader"/></xsl:with-param>
</xsl:apply-templates>
</xsl:template>
...
<xsl:call-template name="SUBJECTHEADER">
<xsl:with-param name="text"><xsl:value-of select="$m_removefromreviewforumsubject"/></xsl:with-param>
</xsl:call-template>
</xsl:when>
<xsl:when test="SUBMIT-REVIEW-FORUM/NEW-THREAD">
<xsl:call-template name="SUBJECTHEADER">
<xsl:with-param name="text"><xsl:value-of select="$m_entrysubmittoreviewforumsubject"/></xsl:with-param>
</xsl:call-template>
</xsl:when>

<xsl:otherwise>
<xsl:call-template name="SUBJECTHEADER">
<xsl:with-param name="text"><xsl:value-of select="$m_submitreviewforumsubject"/></xsl:with-param>
</xsl:call-template>	
</xsl:otherwise>
</xsl:choose>
<br/>
...
<option value="{$DefaultRFID}"><xsl:value-of select="$m_dropdownpleasechooseone"/></option>
...
<xsl:param name="Message"><xsl:value-of select="MESSAGE"/></xsl:param>
<xsl:param name="LinkBody"><xsl:value-of select="LINK"/></xsl:param>
<xsl:param name="LinkHref"><xsl:value-of select="LINK/@HREF"/></xsl:param>

	<!-- default style for all other error messages -->
	<blockquote>
	<span xsl:use-attribute-sets="xmlerrorfont"><B><xsl:value-of select="$m_followingerror"/></B><xsl:value-of select="$Message"/></span>
	<br/>
	<br/>
	<span class="subheaderfont"><B>Return To: </B><A href="{$root}{$LinkHref}"><xsl:value-of select="$LinkBody"/></A></span>
	<br/>
	</blockquote>
</xsl:template>
...
<xsl:template match="SITEID" mode="showfrom">
		...
		<xsl:value-of select="$m_fromsite"/><xsl:text> </xsl:text><xsl:value-of select="/H2G2/SITE-LIST/SITE[@ID=number($thissiteid)]/SHORTNAME"/>
</xsl:template>
...
-->
<xsl:template name="ONEYES">
	<xsl:if test=".!='1'"><xsl:value-of select="$m_oneyes_no"/></xsl:if>
	<xsl:if test=".='1'"><xsl:value-of select="$m_oneyes_yes"/></xsl:if>
</xsl:template>
...
-->
<xsl:template match="PREMODERATION">
	<xsl:value-of select="$m_premoderation"/><xsl:text> </xsl:text>
...
-->
<xsl:template match="OFFSITELINKS">
	<xsl:value-of select="$m_offsiteallowed"/><xsl:text> </xsl:text>
	<xsl:call-template name="ONEYES"/>
</xsl:template>
...
<font size="1">From <xsl:value-of select="@FROM"/><br/>to <xsl:value-of select="@TO"/></font><br/>
<xsl:apply-templates select="."/>
</xsl:for-each>
</td></tr></table>
</xsl:template>
...
<tr>
	<td rowspan="2"><img src="communicate_files/tiny.gif" width="5" height="87" alt=""/></td>
	<td colspan="2" valign="top">
	<img src="communicate_files/tiny.gif" width="245" height="3" alt=""/><br/>
	<font size="2">
	<b><a href="/dna/h2g2/">h2g2</a></b><br/>
	</font>
	<font size="1">
	The guide to <b><a href="/dna/h2g2/C72">life</a></b>, the <b><a href="/dna/h2g2/C73">universe</a></b> and <b><a href="/dna/h2g2/C74">everything</a></b> written by you.<br/>
	</font>	
	<img src="communicate_files/tiny.gif" width="1" height="6" alt=""/><br/>
	</td>	
</tr>	
<tr>
	<td valign="top">
	<img src="communicate_files/tiny.gif" width="55" height="1" alt=""/><br/>
	<!-- image reference -->
	<a href="/dna/h2g2/"><img src="{@IMG}" width="48" height="44" alt="h2g2" hspace="0" vspace="0" border="0"/></a><br/>
	</td>
	<td valign="top">
	<img src="communicate_files/tiny.gif" width="190" height="1" alt=""/><br/>
	<font size="2">
	<b>
	Today's new entries:
	</b>
...
<xsl:apply-templates select="ENTRY"/>
		...
		<font size="1">
		<img src="communicate_files/tiny.gif" width="1" height="6" alt=""/><br/>
		<img src="communicate_files/bullet.gif" width="3" height="3" hspace="0" vspace="4" border="0" alt="" align="top"/><img src="communicate_files/tiny.gif" width="5" height="1" alt="" border="0" align="top"/><a href="/dna/h2g2/C0">Full list of entries</a><br clear="all"/>
		</font>
	</font>	
	<img src="communicate_files/tiny.gif" width="1" height="6" alt=""/><br/>
	</td>	
...
<tr>
	<td bgcolor="#ffffff" colspan="3"><img src="communicate_files/tiny.gif" width="1" height="5" alt=""/></td>
</tr>	
</table>
</xsl:template>
...
<tr>
	<td valign="top" width="7"><img src="communicate_files/bullet.gif" width="3" height="3" alt="" hspace="0" vspace="6" border="0"/></td>			
	<td>
	<font size="1">
	<a HREF="/dna/h2g2/{@H2G2}"><xsl:apply-templates/></a>
	</font>
	</td>
</tr>
...
<xsl:template match="ARTICLEINFO/SUBMITTABLE">
	<xsl:param name="delimiter"><BR/><BR/></xsl:param>
...
<xsl:choose>
	...
	<a><xsl:attribute name="HREF"><xsl:value-of select="$root"/>SubmitReviewForum?action=submitrequest&amp;h2g2id=<xsl:value-of select="/H2G2/ARTICLE/ARTICLEINFO/H2G2ID"/></xsl:attribute>
	...
	<a><xsl:attribute name="HREF"><xsl:value-of select="$root"/>F<xsl:value-of select="FORUM/@ID"/>?thread=<xsl:value-of select="THREAD/@ID"/></xsl:attribute>
...
<a><xsl:attribute name="HREF">javascript:popupwindow('<xsl:value-of select="$root"/>RecommendEntry?h2g2ID=<xsl:value-of select="/H2G2/ARTICLE/ARTICLEINFO/H2G2ID"/>&amp;mode=POPUP','RecommendEntry','resizable=1,scrollbars=1,width=375,height=300');</xsl:attribute>
...
<tr><td> Review Forum Data<br/></td></tr>
<tr>
<td bgcolor="{$horizdividers}"><img src="{$imagesource}blank.gif" width="1" height="1"/></td></tr>
</table>
<table border="0" width="100%" cellpadding="3" cellspacing="0">
<tr><td>Name: <xsl:value-of select="REVIEWFORUM/FORUMNAME"/></td></tr>
<tr><td>URL: <xsl:value-of select="REVIEWFORUM/URLFRIENDLYNAME"/></td></tr> 
<xsl:choose>
	<xsl:when test="REVIEWFORUM/RECOMMENDABLE=1"><tr><td>Recommendable:Yes</td></tr>
	<tr><td>Incubate period: <xsl:value-of select="REVIEWFORUM/INCUBATETIME"/> days</td></tr>
	</xsl:when>
	<xsl:otherwise><tr><td>Recommendable:No</td></tr></xsl:otherwise>
</xsl:choose>
...
<tr><td>
<a><xsl:attribute name="HREF"><xsl:value-of select="$root"/>EditReview?id=<xsl:value-of select="REVIEWFORUM/@ID"/></xsl:attribute><xsl:value-of select="$m_reviewforumdata_edit"/></a>
</td></tr>
</xsl:if>
</table>
<br/><br/><br/>
...
<xsl:apply-templates mode="header" select=".">
<xsl:with-param name="title"><xsl:value-of select="$m_pagetitlestart"/><xsl:value-of select="REVIEWFORUM/FORUMNAME"/></xsl:with-param>
</xsl:apply-templates>
</xsl:template>
...
<xsl:call-template name="HEADER">
				<xsl:with-param name="text"><xsl:value-of select="$m_rft_articlesinreviewheader"/></xsl:with-param>
</xsl:call-template>
...
<A><xsl:attribute name="HREF"><xsl:value-of select="$root"/>RF<xsl:value-of select="../@ID"/>?skip=<xsl:value-of select="@SKIPTO"/>&amp;show=<xsl:value-of select="@COUNT"/>&amp;order=entry<xsl:if test="/H2G2/NOGUIDE">&amp;entry=0</xsl:if>&amp;dir=<xsl:value-of select="$op_dir"/>#<xsl:value-of select="$m_reviewforum_entrytarget"/></xsl:attribute><xsl:call-template name="m_rft_selecth2g2id"/></A> 
</xsl:when>
<xsl:otherwise>
<A><xsl:attribute name="HREF"><xsl:value-of select="$root"/>RF<xsl:value-of select="../@ID"/>?skip=<xsl:value-of select="@SKIPTO"/>&amp;show=<xsl:value-of select="@COUNT"/>&amp;order=entry<xsl:if test="/H2G2/NOGUIDE">&amp;entry=0</xsl:if>&amp;dir=0#<xsl:value-of select="$m_reviewforum_entrytarget"/></xsl:attribute><xsl:call-template name="m_rft_h2g2id"/></A> 
</xsl:otherwise>
</xsl:choose>
</span>
</th>
...
<xsl:otherwise>
<A><xsl:attribute name="HREF"><xsl:value-of select="$root"/>RF<xsl:value-of select="../@ID"/>?skip=<xsl:value-of select="@SKIPTO"/>&amp;show=<xsl:value-of select="@COUNT"/>&amp;order=subject<xsl:if test="/H2G2/NOGUIDE">&amp;entry=0</xsl:if>&amp;dir=0#<xsl:value-of select="$m_reviewforum_entrytarget"/></xsl:attribute><xsl:call-template name="m_rft_subject"/></A> 
</xsl:otherwise>
</xsl:choose>
</span>
</th>
...
<xsl:otherwise>
<A><xsl:attribute name="HREF"><xsl:value-of select="$root"/>RF<xsl:value-of select="../@ID"/>?skip=<xsl:value-of select="@SKIPTO"/>&amp;show=<xsl:value-of select="@COUNT"/>&amp;order=authorname<xsl:if test="/H2G2/NOGUIDE">&amp;entry=0</xsl:if>&amp;dir=0#<xsl:value-of select="$m_reviewforum_entrytarget"/></xsl:attribute><xsl:call-template name="m_rft_author"/></A> 
</xsl:otherwise>
</xsl:choose>
</span>
</th>
...
<xsl:otherwise>
<A><xsl:attribute name="HREF"><xsl:value-of select="$root"/>RF<xsl:value-of select="../@ID"/>?skip=<xsl:value-of select="@SKIPTO"/>&amp;show=<xsl:value-of select="@COUNT"/>&amp;order=authorid<xsl:if test="/H2G2/NOGUIDE">&amp;entry=0</xsl:if>&amp;dir=0#<xsl:value-of select="$m_reviewforum_entrytarget"/></xsl:attribute><xsl:call-template name="m_rft_authorid"/></A> 
</xsl:otherwise>
</xsl:choose>
</span>
</th>
...
<td>
<span xsl:use-attribute-sets="reviewforumlistentry">
<A><xsl:attribute name="HREF">F<xsl:value-of select="../@FORUMID"/>?thread=<xsl:value-of select="THREADID"/></xsl:attribute>
...
<xsl:apply-templates select="DATEPOSTED"/></A>
</span>
</td> 
...
<td>
<span xsl:use-attribute-sets="reviewforumlistentry">
<A><xsl:attribute name="HREF"><xsl:value-of select="$root"/>SubmitReviewForum?action=removethread&amp;rfid=<xsl:value-of select="../../@ID"/>&amp;h2g2id=<xsl:value-of select="H2G2ID"/></xsl:attribute><xsl:attribute name="onclick">return window.confirm('Remove entry from Review Forum?');</xsl:attribute><xsl:call-template name="m_removefromreviewforum"/></A>
</span>
</td>
</xsl:when>
</xsl:choose>
...
<xsl:if test="not(/H2G2/NOGUIDE)">
	...
	<br/>
	<center>
	<A><xsl:attribute name="HREF"><xsl:value-of select="$root"/>RF<xsl:value-of select="../@ID"/>?entry=0&amp;skip=0&amp;show=25&amp;order=<xsl:value-of select="$var_orderby"/>&amp;dir=<xsl:value-of select="@DIR"/></xsl:attribute><xsl:value-of select="$m_clickmorereviewentries"/></A><br/>
	</center>
	</xsl:if>
</xsl:if>
...
<input type="checkbox" name="removename" value="{NAME}"/><a href="{$root}{NAME}"><xsl:value-of select="NAME"/></a> (<a href="{$root}UserEdit{H2G2ID}">edit</a>)<br/>
</xsl:template>
...
<span class="warningmessagefont"><b>Error: <xsl:value-of select="."/></b></span><br/>
</xsl:template>
...
<xsl:for-each select="LIST">
	<a href="{$root}TopFiveEditor?editgroup={GROUPNAME}&amp;type={TYPE}&amp;fetch=1"><xsl:value-of select="GROUPNAME"/></a><br/>
</xsl:for-each>
</xsl:template>

<xsl:template name="SITEADMIN-EDITOR_SUBJECT">
	<xsl:call-template name="SUBJECTHEADER">
	<xsl:with-param name="text">DNA Site Admin for <xsl:value-of select="SITEADMIN/URLNAME"/></xsl:with-param>
	</xsl:call-template>
</xsl:template>
...
<xsl:sort select="@ID" order="ascending" data-type="number"/>
 [ <a href="/dna/{NAME}/SiteAdmin"><xsl:value-of select="SHORTNAME"/></a> ] 
</xsl:for-each>
<br/>
</xsl:if>
...
<form method="post" action="SiteAdmin">
	...
	<td><input type="text" name="shortname" value="{SHORTNAME}"/></td></tr>
...
<tr><td>Default Skin: </td><td><input type="text" name="defaultskin"/></td></tr>
<tr><td>Skin description: </td><td><input type="text" name="skindescription"/></td></tr>
<tr><td>File to upload: </td><td><input align="center" type="file" name="file" size="60" maxlength="255"/></td></tr>
<tr><td>Leafname: </td><td><input type="text" name="leafname" value="HTMLOutput.xsl"/></td></tr>
...
<tr><td/><td><input type="submit" name="newsite" value="Create Site"/></td></tr>
</table>
</form>
</xsl:if>
...
<PRE><xsl:value-of select="PARSE-ERROR/SRCTEXT"/></PRE><br/>
</xsl:when>
<xsl:otherwise>
...
<textarea cols="70" rows="20" wrap="virtual" name="bodytext"><xsl:value-of select="BODY"/></textarea>
<br/>
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0" WIDTH="192">
  <TR> 
    <TD WIDTH="192" VALIGN="TOP" ALIGN="CENTER" COLSPAN="2">This 
      clip should play automatically after a few minutes.</TD>
  </TR>
  <TR> 
    <TD WIDTH="192" VALIGN="TOP" ALIGN="CENTER" COLSPAN="2">&nbsp;</TD>
  </TR>
  <TR> 
    <TD WIDTH="192" VALIGN="TOP" ALIGN="CENTER" BGCOLOR="#000000" COLSPAN="2"> <object id="REALVIDEO" classid="CLSID:CFCDAA03-8BE4-11CF-B84B-0020AFBBCCFA" align="baseline" width="192" height="144" border="0">
        <!-- RAM FILE -->
  ...
  <TR> 
    <TD HEIGHT="25" WIDTH="96" ALIGN="CENTER"> <A HREF="{$realmediadir}{@SRC}"><FONT SIZE="-2">Non-embedded 
      player</FONT></A></TD>
    <TD HEIGHT="25" WIDTH="96" ALIGN="CENTER"><A href="http://www.bbc.co.uk/webwise/categories/plug/real/real.shtml?intro"><FONT SIZE="-2">Download 
      RealPlayer</FONT></A></TD>
  </TR>
</TABLE>
</xsl:when>
<xsl:otherwise>
<P>This clip should play automatically after a few seconds. If not <a href="{$realmediadir}{@SRC}">click 
here</a>.</P>
...
<xsl:when test="@NEWCONVERSATION=1">
	<A href="{$root}F{@FORUM}">Click here to 
	return to the Conversation list</A>
</xsl:when>
<xsl:otherwise>
	<A href="{$root}F{@FORUM}?thread={@THREAD}&amp;post={@POST}#p{@POST}">Click here to 
	return to the Conversation</A>
</xsl:otherwise>
</xsl:choose>
<BR/><BR/>		
	</xsl:template>
...
<xsl:variable name="shortlength" select="$maxlength - 3"/>
	<xsl:choose>
		<xsl:when test="string-length($longtext) &gt; $maxlength"><xsl:value-of select="substring($longtext, 1, $shortlength)"/>...</xsl:when>
		<xsl:otherwise><xsl:value-of select="$longtext"/></xsl:otherwise>
	</xsl:choose>
</xsl:template>
...
<xsl:param name="crumbtrail_divider"> <br/> </xsl:param>
<xsl:for-each select="ANCESTOR">
<a><xsl:attribute name="href">C<xsl:value-of select="NODEID"/></xsl:attribute>
	<xsl:call-template name="TRUNCATE">
		<xsl:with-param name="longtext"><xsl:value-of select="NAME"/></xsl:with-param>
	</xsl:call-template>
</a>
...
<ul>
<xsl:for-each select="ANCESTOR">
<li><a href="{$root}C{NODEID}"><xsl:value-of select="NAME"/></a></li>
</xsl:for-each>
</ul>
</xsl:for-each>
</xsl:template>
...
<xsl:variable name="thislevel"><xsl:value-of select="TREELEVEL"/></xsl:variable>
<xsl:variable name="thisnode"><xsl:value-of select="NODEID"/></xsl:variable>
Scanning set:<br/>
...
<table border="0" cellpadding="0" cellspacing="0" width="428" height="94">
  <tr>
    <td valign="top" rowspan="2" bgcolor="#ffffff"><a href="#" onClick="toggelState()"><img src="http://www.tivocommunity.com/tivo-vb/images/on.gif" width="25" height="31" border="0" alt="Click To Start/Stop Ticker" id="timage" name="timage"/></a><br/><img src="http://www.tivocommunity.com/tivo-vb/images/space.gif" width="1" height="4" border="0"/><br/><a href="#" onMouseDown="fastScrollOn('down')" onMouseUp="fastScrollOff()"><img src="http://www.tivocommunity.com/tivo-vb/images/tup.gif" width="25" height="20" border="0" id="tupimg" name="tupimg" alt="Hold to scroll down"/></a><br/><a href="#" onClick="pausePlay()"><img src="http://www.tivocommunity.com/tivo-vb/images/tpause.gif" width="25" height="20" border="0" id="tpauseimg" name="tpauseimg" alt="Click To Pause/Play Ticker"/></a><br/><a href="#" onMouseDown="fastScrollOn('up')" onMouseUp="fastScrollOff()"><img src="http://www.tivocommunity.com/tivo-vb/images/tdown.gif" width="25" height="20" border="0" id="tdownimg" name="tdownimg" alt="Hold to scroll up"/></a></td>
    <td valign="middle" bgcolor="#ff9900" width="403" height="23">&nbsp;<font size="1" face="Verdana, Arial, sans-serif, Helvetica, Times" color="#000000"><b>Latest
    topics on <a href="http://www.tivocommunity.com/tivo-vb" target="_NEWWINDOW">TiVo Community Forum</a></b></font></td>
    <td bgcolor="#ff9900"><img src="http://www.tivocommunity.com/tivo-vb/images/space.gif" width="1" height="23" border="0"/></td>
  </tr>
  <tr>
    <td bgcolor="#ff9900" width="403" height="68" colspan="2">
      <table border="0" cellpadding="0" cellspacing="2" width="403" height="68">
        <tr>
          <td bgcolor="#ffffff"><img src="http://www.tivocommunity.com/tivo-vb/images/space.gif" width="399" height="68"/></td>
        </tr>
      </table>
    </td>
  </tr>
...
<div id="offline" style="position:absolute; visibility:hidden; height:68px; width:399px; background:white; z-index:200;">
  <table border="0" cellpadding="0" cellspacing="0" width="399" height="68">
    <tr>
      <td valign="middle" align="center"><font size="1" face="Verdana, Arial, sans-serif, Helvetica, Times"><b>Ticker off.</b> Click image to reactivate.</font></td>
    </tr>
  </table>
</div>
</div>
...
<xsl:template name="NOTFOUND_SUBJECT">
	<xsl:call-template name="SUBJECTHEADER">
	<xsl:with-param name="text"><xsl:value-of select="$m_notfoundsubject"/></xsl:with-param>
	</xsl:call-template>
</xsl:template>
...
<table border="1">
<tr>
<td rowspan="3">Site</td><td colspan="5" align="center"><span class="modbillingthread">Threads</span></td>
</tr>
<tr><td colspan="5" align="center"><span class="modbillingarticle">Articles</span></td></tr>
<tr><td colspan="5" align="center"><span class="modbillinggeneral">General</span></td></tr>
<tr>
<td/>
<td><span class="modbilling">Total</span></td>
<td><span class="modbilling">Passed</span></td>
<td><span class="modbilling">Failed</span></td>
<td><span class="modbilling">Referred</span></td>
<td><span class="modbilling">Complaints</span></td>
</tr>
...
<tr>
<td rowspan="3"><xsl:apply-templates select="SITEID" mode="showfrom"/></td>

<td><span class="modbillingthread"><xsl:value-of select="THREADTOTAL"/>
<xsl:choose>
...
<td><span class="modbillingthread"><xsl:apply-templates select="THREADPASSED"/></span></td>
<td><span class="modbillingthread"><xsl:apply-templates select="THREADFAILED"/></span></td>
<td><span class="modbillingthread"><xsl:apply-templates select="THREADREFERRED"/></span></td>
<td><span class="modbillingthread"><xsl:apply-templates select="THREADCOMPLAINT"/></span></td>
</tr>
<tr>
<td><span class="modbillingarticle"><xsl:value-of select="ARTICLETOTAL"/>
<xsl:choose>
...
<td><span class="modbillingarticle"><xsl:apply-templates select="ARTICLEPASSED"/></span></td>
<td><span class="modbillingarticle"><xsl:apply-templates select="ARTICLEFAILED"/></span></td>
<td><span class="modbillingarticle"><xsl:apply-templates select="ARTICLEREFERRED"/></span></td>
<td><span class="modbillingarticle"><xsl:apply-templates select="ARTICLECOMPLAINT"/></span></td>
</tr>
<tr>
<td><span class="modbillinggeneral"><xsl:value-of select="GENERALTOTAL"/>
<xsl:choose>
...
<td><span class="modbillinggeneral"><xsl:apply-templates select="GENERALPASSED"/></span></td>
<td><span class="modbillinggeneral"><xsl:apply-templates select="GENERALFAILED"/></span></td>
<td><span class="modbillinggeneral"><xsl:apply-templates select="GENERALREFERRED"/></span></td>
</tr>
...
<!-- ******************************************************************************************** -->
	...
	<xsl:choose>
	<xsl:when test="number(NODECOUNT)+number(ARTICLECOUNT)+number(ALIASCOUNT) = 0">
		<a xsl:use-attribute-sets="catfontemptysubject"><xsl:attribute name="HREF"><xsl:value-of select="$root"/><xsl:value-of select="$linkto"/></xsl:attribute><span xsl:use-attribute-sets="catfontemptysubject"><xsl:value-of select="NAME"/></span></a> <span xsl:use-attribute-sets="catfontmember"><nobr> [<xsl:value-of select="$m_nomembers"/>]</nobr></span>
	</xsl:when>
	<xsl:when test="number(NODECOUNT)+number(ARTICLECOUNT)+number(ALIASCOUNT) = 1">
		<a xsl:use-attribute-sets="catfontfullsubject"><xsl:attribute name="HREF"><xsl:value-of select="$root"/><xsl:value-of select="$linkto"/></xsl:attribute><span xsl:use-attribute-sets="catfontfullsubject"><xsl:value-of select="NAME"/></span></a> <span xsl:use-attribute-sets="catfontmember"><nobr> [1<xsl:value-of select="$m_member"/>]</nobr></span>
	</xsl:when>
	<xsl:otherwise>
		<a xsl:use-attribute-sets="catfontfullsubject"><xsl:attribute name="HREF"><xsl:value-of select="$root"/><xsl:value-of select="$linkto"/></xsl:attribute><span xsl:use-attribute-sets="catfontfullsubject"><xsl:value-of select="NAME"/></span></a> <span xsl:use-attribute-sets="catfontmember"><nobr> [<xsl:value-of select="number(NODECOUNT)+number(ARTICLECOUNT)+number(ALIASCOUNT)"/><xsl:value-of select="$m_members"/>]</nobr></span>
	</xsl:otherwise>
	</xsl:choose>
	...
	<xsl:choose>
	<xsl:when test="string-length(SECTION) &gt; 0">
		<A><xsl:attribute name="HREF"><xsl:value-of select="$root"/>A<xsl:value-of select="H2G2ID"/>?section=<xsl:value-of select="SECTION"/></xsl:attribute><span xsl:use-attribute-sets="catfontarticle"><xsl:value-of select="NAME"/> (<xsl:value-of select="SECTIONDESCRIPTION"/>)</span></A>
	</xsl:when>
	<xsl:otherwise>
		<A><xsl:attribute name="HREF"><xsl:value-of select="$root"/>A<xsl:value-of select="H2G2ID"/></xsl:attribute><span xsl:use-attribute-sets="catfontarticle"><xsl:value-of select="NAME"/></span></A>
	</xsl:otherwise>
	</xsl:choose>
	...
	<xsl:choose>
	<xsl:when test="number(NODECOUNT)+number(ARTICLECOUNT)+number(ALIASCOUNT) = 0">
		<a><xsl:attribute name="HREF"><xsl:value-of select="$root"/><xsl:value-of select="$linkto"/></xsl:attribute><span xsl:use-attribute-sets="catfontemptysubject"><xsl:value-of select="NAME"/></span></a> <span xsl:use-attribute-sets="catfontmember"><nobr> [<xsl:value-of select="$m_nomembers"/>]</nobr></span>
	</xsl:when>
	<xsl:when test="number(NODECOUNT)+number(ARTICLECOUNT)+number(ALIASCOUNT) = 1">
		<a><xsl:attribute name="HREF"><xsl:value-of select="$root"/><xsl:value-of select="$linkto"/></xsl:attribute><span xsl:use-attribute-sets="catfontfullsubject"><xsl:value-of select="NAME"/></span></a> <span xsl:use-attribute-sets="catfontmember"><nobr> [1<xsl:value-of select="$m_member"/>]</nobr></span>
	</xsl:when>
	<xsl:otherwise>
		<a><xsl:attribute name="HREF"><xsl:value-of select="$root"/><xsl:value-of select="$linkto"/></xsl:attribute><span xsl:use-attribute-sets="catfontfullsubject"><xsl:value-of select="NAME"/></span></a> <span xsl:use-attribute-sets="catfontmember"><nobr> [<xsl:value-of select="number(NODECOUNT)+number(ARTICLECOUNT)+number(ALIASCOUNT)"/><xsl:value-of select="$m_members"/>]</nobr></span>
	</xsl:otherwise>
	</xsl:choose>
	...
	-->
	<xsl:template match="RESEARCHERS">
		<xsl:param name="delimiter"><BR/></xsl:param>
		<xsl:for-each select="USER">
	...
	<xsl:template match="DATE" mode="MorePosts">
		...
		<a xsl:use-attribute-sets="mDATE_MorePosts">
			<xsl:attribute name="href"><xsl:value-of select="$root"/>MP<xsl:value-of select="$userid"/>?<xsl:value-of select="$skipparams"/>s_type=pop&amp;s_target=<xsl:value-of select="$target"/>
			...
			<xsl:otherwise>
			<xsl:text>&amp;s_upto=</xsl:text><xsl:value-of select="$datestring"/>
			</xsl:otherwise>
			</xsl:choose>
			</xsl:attribute>
...
-->
		...
		<A xsl:use-attribute-sets="mDATE_LatestPost">
			...
			<xsl:attribute name="HREF"><xsl:value-of select="$root"/>F<xsl:value-of select="../../@FORUMID"/>?thread=<xsl:value-of select="../../@THREADID"/>
					...
					<xsl:when test="/H2G2/PARAMS/PARAM[NAME='s_t' and (substring-before(VALUE, '|') = string($thread))]">
						<xsl:text>&amp;date=</xsl:text><xsl:value-of select="substring-after(/H2G2/PARAMS/PARAM[NAME='s_t' and substring-before(VALUE, '|') = string($thread)]/VALUE,'|')"/>
					</xsl:when>
					<xsl:otherwise>
	...
	<xsl:template match="@FORUMID" mode="AddThread">
		<xsl:param name="attributes"/>
		<xsl:param name="img"><xsl:value-of select="$alt_discussthis"/></xsl:param>
	...
	<xsl:template match="POST-LIST" mode="MorePosts">
		...
		<A xsl:use-attribute-sets="mPOST-LIST_MorePosts">
			<xsl:attribute name="HREF">
				...
				</xsl:choose>&amp;s_type=pop&amp;s_upto=<xsl:value-of select="/H2G2/PARAMS/PARAM[NAME='s_upto']/VALUE"/>&amp;s_target=<xsl:value-of select="$target"/></xsl:attribute>
			<xsl:copy-of select="$linkText"/>
		</A>
	</xsl:template>
	...
	<xsl:template match="FUNCTIONS/DELETE" mode="Form">
		<FORM METHOD="post" action="{$root}Edit" ONSUBMIT="return confirm('{$m_ConfirmDeleteEntry}')">
			<INPUT TYPE="hidden" NAME="id"><xsl:attribute name="VALUE"><xsl:value-of select="/H2G2/ARTICLE-EDIT-FORM/H2G2ID"/></xsl:attribute></INPUT>
			<INPUT TYPE="hidden" NAME="masthead"><xsl:attribute name="VALUE"><xsl:value-of select="/H2G2/ARTICLE-EDIT-FORM/MASTHEAD"/></xsl:attribute></INPUT>
...
-->
<xsl:template match="@FORUMID" mode="THREADS_MAINBODY">
	<xsl:param name="img"><xsl:value-of select="$alt_newconversation"/></xsl:param>
...
-->
<xsl:template match="FOOTNOTE" mode="display">
	<xsl:param name="endcode"><br/></xsl:param>
	<a>
...
-->
<xsl:template match="@USERID" mode="NewerPostings">
	<xsl:param name="img">&lt;&lt;<xsl:value-of select="$m_newerpostings"/></xsl:param>
...
-->
<xsl:template match="@USERID" mode="OlderPostings">
	<xsl:param name="img"><xsl:value-of select="$m_olderpostings"/> &gt;&gt;</xsl:param>
...
-->
<xsl:template match="@USERID" mode="ShowEditedEntries">
	<xsl:param name="content"><xsl:copy-of select="$m_showeditedentries"/></xsl:param>
...
-->
<xsl:template match="@USERID" mode="ShowGuideEntries">
	<xsl:param name="content"><xsl:copy-of select="$m_showguideentries"/></xsl:param>
...
-->
<xsl:template match="@USERID" mode="ShowCancelledEntries">
	<xsl:param name="content"><xsl:copy-of select="$m_showcancelledentries"/></xsl:param>
...
-->
<xsl:template match="@USERID" mode="OlderEntries">
	<xsl:param name="content"><xsl:copy-of select="$m_olderentries"/></xsl:param>
...
-->
<xsl:template match="@USERID" mode="NewerEntries">
	<xsl:param name="content"><xsl:copy-of select="$m_newerentries"/></xsl:param>
...
<xsl:template match="USERRESULT">
	...
	-->
	<xsl:template match="H2G2ID" mode="notLinkTextBold">
		<B><xsl:value-of select="$m_idcolon"/></B>
...
-->
	...
	-->
	<xsl:template match="PAGEAUTHOR">
		<xsl:param name="delimiter"><B><BR/></B></xsl:param>
		<xsl:param name="researchersDelimiter"><BR/></xsl:param>
		<xsl:param name="authorDelimiter"><BR/></xsl:param>
		<xsl:param name="listItemDelimiter"><BR/></xsl:param>
...
-->
	<xsl:template match="ARTICLEINFO">
		...
		<table border="0" width="100%" cellpadding="3" cellspacing="0">
			<tr><td><xsl:value-of select="$m_entrydata"/><br/></td></tr>
			<tr valign="top"> 
				<td align="left">
					<span xsl:use-attribute-sets="pageauthorsfont">
	...
	<xsl:template match="POST" mode="NewPosts">
		<xsl:param name="attributes"/>
			...
			<xsl:call-template name="ApplyAttributes"><xsl:with-param name="attributes" select="$attributes"/></xsl:call-template>
				...
				<xsl:otherwise><xsl:value-of select="(number(@COUNTPOSTS) - number(@LASTPOSTCOUNTREAD))"/> new posts</xsl:otherwise>
				</xsl:choose>
			</A>,
			</xsl:if>
	</xsl:template>
	...
	<xsl:template name="popupconversations">
		...
		<xsl:variable name="userid"><xsl:value-of select="POSTS/@USERID"/></xsl:variable>
		<html>
			<head>
				<title><xsl:value-of select="$m_myconversationstitle"/></title>
				...
				<div class="conversationpopup">
					...
					<xsl:if test="POSTS/POST-LIST[@MORE=1]">
						<xsl:apply-templates select="POSTS/POST-LIST" mode="MorePosts">
							<xsl:with-param name="userid" select="$userid"/>
							<xsl:with-param name="target" select="$target"/>
							<xsl:with-param name="linkText"><xsl:value-of select="$m_olderpostings"/> &gt;&gt;</xsl:with-param>
						</xsl:apply-templates>
					</xsl:if>
					<br/>
				</div>
	...
	<xsl:template match="POST" mode="shownew">
		<xsl:variable name="thread"><xsl:value-of select="THREAD/@THREADID"/></xsl:variable>
	...
	<xsl:template name="popupconversations2">
		...
		<html>
			<head>
				<title><xsl:if test="/H2G2/POSTS/POST-LIST/POST[@PRIVATE=0][@LASTPOSTCOUNTREAD &lt; @COUNTPOSTS]">*</xsl:if><xsl:value-of select="$m_myconversationstitle"/></title>
				<meta http-equiv="REFRESH">
				<xsl:attribute name="content">120;url=MP<xsl:value-of select="$userid"/>?<xsl:value-of select="$skipparams"/>s_type=pop<xsl:apply-templates select="/H2G2/PARAMS/PARAM[NAME='s_t']" mode="ThreadRead"/>&amp;s_target=<xsl:value-of select="$target"/>
				</xsl:attribute>
				</meta>
				<xsl:call-template name="insert-headelements"/>
			</head>
	...
	<xsl:template match="ARTICLE-EDIT-FORM">
		<FORM METHOD="POST" action="{$root}Edit" ONSUBMIT="return runSubmit()" TITLE="Article Editing Form">
			...
			<xsl:if test="$test_ShowResearchers">
				...
				<p><span class="subheaderfont"><xsl:value-of select="$m_edittheresearcherlisttext"/></span></p>
				<P>
		...
		<xsl:if test="FUNCTIONS/DELETE">
			<P><span class="subheaderfont"><xsl:value-of select="$m_deletethisentry"/></span></P>
		...
		<xsl:if test="MASTHEAD[. != '1']">
			<P><span class="subheaderfont"><xsl:value-of select="$m_recommendtitle"/></span></P>
...
<xsl:template name="PostYouArePremoderated">
	<p>
		<b><xsl:value-of select="$m_PleaseNoteCS"/></b>
...
<xsl:template match="POSTTHREADFORM" mode="Preview">
	...
	<xsl:if test="$test_HasPreviewBody">
		<B><xsl:value-of select="$m_whatpostlooklike"/></B>
		<BR/>
		<TABLE WIDTH="100%">
			<TR>
				<TD width="100%"><HR/></TD>
...
<xsl:template name="THREADS_MAINBODY">
	...
	<xsl:for-each select="FORUMTHREADS/THREAD">
		...
		<span class="threadlastposting">
			<xsl:value-of select="$m_LastPost"/><xsl:text> </xsl:text>
...
<xsl:template match="@SKIP" mode="index">
	...
	<xsl:param name="previous"><xsl:value-of select="$m_previous"/></xsl:param>
	<xsl:param name="next"><xsl:value-of select="$m_nextspace"/></xsl:param>
	<xsl:param name="entries"><xsl:value-of select="$m_entries"/></xsl:param>
	<xsl:param name="nopreventries"><xsl:value-of select="$m_nopreventries"/></xsl:param>
	<xsl:param name="nomoreentries"><xsl:value-of select="$m_nomoreentries"/></xsl:param>
	<xsl:choose>
	...
	<xsl:otherwise>
		<xsl:copy-of select="$lessthan"/> <xsl:copy-of select="$nopreventries"/>
	</xsl:otherwise>
	</xsl:choose>
...
<xsl:template match="INDEXENTRY">
	...
	&nbsp;<span class="indexnormal"><xsl:value-of select="SUBJECT"/></span><br/>
</xsl:template>
...
<xsl:template match="INDEXENTRY[STATUS='APPROVED']">
	<xsl:apply-templates select="H2G2ID" mode="indexentry"/>
	&nbsp;<span class="indexapproved"><xsl:value-of select="SUBJECT"/></span><br/>
</xsl:template>
...
<xsl:template match="INDEXENTRY[STATUS='SUBMITTED']">
	<xsl:apply-templates select="H2G2ID" mode="indexentry"/>
	&nbsp;<span class="indexsubmitted"><xsl:value-of select="SUBJECT"/></span><br/>
</xsl:template>
...
<xsl:template match="H2G2ID" mode="indexentry">
	<xsl:param name="subject">A<xsl:value-of select="."/></xsl:param>
...
<xsl:for-each select="DISC">
	<li><b>Disc <xsl:value-of select="@NUMBER"/></b></li>
	<ul>
	<xsl:for-each select="TITLE">
	<li><xsl:value-of select="NAME"/>
	<xsl:if test="STORYNAME">
	- <i><xsl:value-of select="STORYNAME"/></i>
	</xsl:if>
	</li>
	</xsl:for-each>
	</ul>
...
<p><xsl:copy-of select="$m_someusersdeleted"/>
</p>
</xsl:when>
...
<a href="watch{/H2G2/PAGE-OWNER/USER/USERID}?full=1" xsl:use-attribute-sets="mWATCHED-USER-LIST_FullList"><xsl:copy-of select="$m_journalentriesbyfriends"/></a> 
</xsl:if>
</td>
</tr>
</table>
...
<xsl:if test="not($test_DeleteLotsOfFriends) and USER"><xsl:apply-templates select="@USERID" mode="WatchUserBigDelete"/><br/></xsl:if>
</xsl:template>
...
<xsl:param name="linkcontent"><xsl:copy-of select="$m_deletemultiplefriends"/></xsl:param>
<a xsl:use-attribute-sets="maUSERID_WatchUserBigDelete" href="{$root}Watch{.}?s_bd=yes">
<xsl:copy-of select="$linkcontent"/></a>
</xsl:template>

<xsl:template match="USERID" mode="WatchUserPS">
<xsl:param name="linkcontent"><xsl:copy-of select="$m_personalspace"/></xsl:param>
<a xsl:use-attribute-sets="mUSERID_WatchUserPS" href="{$root}U{.}">
<xsl:copy-of select="$linkcontent"/></a>
</xsl:template>

<xsl:template match="USER" mode="WatchUserJournal">
<xsl:param name="linkcontent"><xsl:copy-of select="$m_journalpostings"/></xsl:param>
...
<xsl:param name="linkcontent"><xsl:apply-templates select="USERNAME"/></xsl:param>
<a xsl:use-attribute-sets="mUSER_WatchUserPosted" href="{$root}U{USERID}">
<xsl:copy-of select="$linkcontent"/></a>
</xsl:template>

<xsl:template match="USERID" mode="WatchUserDelete">
<xsl:param name="linkcontent"><xsl:copy-of select="$m_delete"/></xsl:param>
...
<xsl:choose>
<xsl:when test="$test_DeleteLotsOfFriends"> | <input type="CHECKBOX" name="duser" value="{USERID}"/><xsl:copy-of select="$m_deletethisfriend"/></xsl:when>
<xsl:otherwise>
...
<a xsl:use-attribute-sets="mWATCH-USER-POSTS_Back" href="{$root}Watch{@USERID}"><xsl:copy-of select="$m_friendslist"/></a><br/>
</td>
</tr>
</table>
<xsl:apply-templates select="WATCHED-USER-POST"/>
<xsl:if test="not(WATCHED-USER-POST)">
<xsl:copy-of select="$m_noentriestodisplay"/><br/>
</xsl:if>
</xsl:template>

<xsl:template match="WATCHED-USER-POST">
<xsl:copy-of select="$m_postedby"/><xsl:apply-templates select="USER" mode="WatchUserPosted"/><xsl:copy-of select="$m_on"/><xsl:apply-templates select="DATEPOSTED/DATE" mode="absolute"/><br/>
<xsl:copy-of select="$m_fsubject"/><xsl:apply-templates select="SUBJECT" mode="watchedpost"/><br/>
<xsl:apply-templates select="BODY"/>
<br/>
<br/>
<xsl:choose>
<xsl:when test="number(POSTCOUNT) &gt; 2">
<a xsl:use-attribute-sets="mWATCH-USER-POSTS_Replies" href="F{@FORUMID}?thread={@THREADID}"><xsl:value-of select="number(POSTCOUNT)-1"/><xsl:copy-of select="$m_replies"/></a><xsl:text> </xsl:text><xsl:copy-of select="$m_latestreply"/><a xsl:use-attribute-sets="mWATCH-USER-POSTS_LastReply" href="F{@FORUMID}?thread={@THREADID}&amp;latest=1"><xsl:apply-templates select="LASTPOSTED/DATE"/></a><br/>
</xsl:when>
<xsl:when test="number(POSTCOUNT) = 2">
<xsl:copy-of select="$m_onereplyposted"/><a xsl:use-attribute-sets="mWATCH-USER-POSTS_LastReply" href="F{@FORUMID}?thread={@THREADID}"><xsl:apply-templates select="LASTPOSTED/DATE"/></a><br/>
</xsl:when>
<xsl:otherwise>
...
<br/><b>
<a href="{$root}F{@FORUMID}?thread={@THREADID}" xsl:use-attribute-sets="mTHREAD_PreviousThread">&lt;&lt; <xsl:value-of select="SUBJECT"/></a></b>
</xsl:template>

<xsl:template match="THREAD" mode="NextThread">
<br/><b>
<a href="{$root}F{@FORUMID}?thread={@THREADID}" xsl:use-attribute-sets="mTHREAD_NextThread"><xsl:value-of select="SUBJECT"/> &gt;&gt;</a></b>
</xsl:template>
...
<xsl:param name="symbol"><span class="onlinemarker">*</span></xsl:param>
<xsl:if test="./USERID=/H2G2/ONLINEUSERS/ONLINEUSER/USER/USERID or ./USERID=/H2G2/VIEWING-USER/USER/USERID"><xsl:copy-of select="$symbol"/></xsl:if>
</xsl:template>
...
<xsl:variable name="v_moderatorviewtype"><xsl:value-of select="/H2G2/MODERATOR-VIEW/@VIEWTYPE"/></xsl:variable>
<xsl:variable name="v_moderatorviewid"><xsl:value-of select="/H2G2/MODERATOR-VIEW/@VIEWID"/></xsl:variable>
...
<xsl:variable name="currentviewtype"><xsl:value-of select="$v_moderatorviewtype"/></xsl:variable>
<xsl:variable name="currentviewid"><xsl:value-of select="$v_moderatorviewid"/></xsl:variable>
...
<xsl:choose>
<xsl:when test="$v_moderatorviewtype = 'class'">
<H2>Viewing class: <xsl:value-of select="/H2G2/MODERATION-CLASSES/MODERATION-CLASS[@CLASSID=$v_moderatorclassid]/NAME"/></H2>
</xsl:when>
<xsl:when test="$v_moderatorviewtype = 'site'">
<H2>Viewing site: <xsl:value-of select="/H2G2/SITE-LIST/SITE[@ID=$v_moderatorsiteid]/SHORTNAME"/></H2>
</xsl:when>
</xsl:choose>
<a href="{$root}moderatormanagement">Show All</a><br/>
...
<xsl:for-each select="/H2G2/MODERATION-CLASSES/MODERATION-CLASS">
<OPTION value="class{@CLASSID}">Class: <xsl:value-of select="NAME"/></OPTION>
</xsl:for-each>
<xsl:for-each select="/H2G2/SITE-LIST/SITE">
<OPTION value="site{@ID}">Site: <xsl:value-of select="SHORTNAME"/></OPTION>
</xsl:for-each>
</SELECT><input type="submit" name="giveaccess" value="Grant Access" OnClick="javascript:return(confirm('Are you sure?'))"/>
...
<xsl:if test="@CLASSID=$v_moderatorclassid"><xsl:attribute name="selected">selected</xsl:attribute></xsl:if>
...
<xsl:with-param name="showaccessthrough"><xsl:value-of select="$v_moderatorsiteid"/></xsl:with-param>
<xsl:with-param name="showsitecount">0</xsl:with-param>
<xsl:with-param name="showclasses">0</xsl:with-param>
<xsl:with-param name="showdirectsites">0</xsl:with-param>
</xsl:apply-templates>
...
<xsl:call-template name="confirmjavascript"><xsl:with-param name="message">Remove the selected moderators' access privileges for site <xsl:value-of select="/H2G2/SITE-LIST/SITE[@ID=$v_moderatorsiteid]/SHORTNAME"/></xsl:with-param></xsl:call-template>
</input>
</form>
</xsl:template>
...
<td>
	...
	<xsl:variable name="classforaccess"><xsl:value-of select="SITES/SITE[@SITEID=$showaccessthrough]/@CLASSID"/></xsl:variable>
...
<xsl:if test="$showsitecount=1">
	<td><xsl:value-of select="count(SITES/SITE)"/></td>
</xsl:if>
</tr>
</xsl:template>
...
<table>
<tr>
<td>Class level access</td><td>Direct access</td>
</tr>
<tr>
<td><xsl:for-each select="/H2G2/MODERATION-CLASSES/MODERATION-CLASS">
<input type="checkbox" name="toclass" value="{@CLASSID}">
<xsl:variable name="thisclassid"><xsl:value-of select="@CLASSID"/></xsl:variable>
...
<xsl:variable name="thissiteid"><xsl:value-of select="@ID"/></xsl:variable>
...
<B>No users were found matching that email address</B><br/>
</xsl:if>
<xsl:if test="ERROR/@TYPE=2">
<B>You must select at least one class</B><br/>
</xsl:if>
<xsl:if test="ERROR/@TYPE=3">
<B>You must select one of the listed users</B><br/>
</xsl:if>
...
<table>
<tr valign="top">
<td><xsl:apply-templates select="/H2G2/MODERATION-CLASSES/MODERATION-CLASS" mode="addmoderatorcheckboxes"/>
</td>
<td><xsl:apply-templates select="/H2G2/SITE-LIST/SITE" mode="addmoderatorcheckboxes"/>
</td>
</tr>
</table>
<!--
...
<input type="checkbox" name="toclass" value="{@CLASSID}">
<xsl:variable name="tmp_classid"><xsl:value-of select="@CLASSID"/></xsl:variable>
...
<input type="checkbox" name="tosite" value="{@ID}">
<xsl:variable name="tmp_siteid"><xsl:value-of select="@ID"/></xsl:variable>
<xsl:if test="/H2G2/LASTACTION/ADDMODERATOR/ADDTO/ADDTOSITES[SITE=$tmp_siteid]">
<xsl:attribute name="CHECKED">CHECKED</xsl:attribute>
</xsl:if>
</input> <xsl:value-of select="SHORTNAME"/><br/>
</xsl:template>
...
<xsl:attribute name="OnClick">javascript:return(confirm('<xsl:value-of select="$message"/>'))</xsl:attribute>
</xsl:template>
...
<body>
<h1>Statistics for <xsl:value-of select="/H2G2/SERVERNAME"/></h1>
...
<tr>
<td><xsl:value-of select="@INTERVALSTARTTIME"/></td>
<td><xsl:value-of select="RAWREQUESTS"/></td>
<td><xsl:value-of select="SERVERBUSYCOUNT"/></td>
<td><xsl:value-of select="CACHEHITS"/></td>
<td><xsl:value-of select="CACHEMISSES"/></td>
<td><xsl:value-of select="NONSSOREQUESTS"/></td>
<td><xsl:value-of select="HTMLCACHEHITS"/></td>
<td><xsl:value-of select="HTMLCACHEMISSES"/></td>
  <td>
