...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:doc="http://www.bbc.co.uk/dna/documentation" xmlns:comment-feeds="http://www.bbc.co.uk/blogs/comment-feeds"  exclude-result-prefixes="doc comment-feeds" xmlns:dna="http://www.bbc.co.uk/dna">
    ...
    <xsl:template match="/H2G2[@TYPE = 'FRONTPAGE'][/H2G2/PARAMS/PARAM[NAME = 's_dynamiclist']/VALUE]" mode="page">
      <xsl:apply-templates select="DYNAMIC-LISTS/LIST[@LISTNAME = /H2G2/PARAMS/PARAM[NAME = 's_dynamiclist']/VALUE]" mode="object_list" />
    </xsl:template>
    ...
    <xsl:template match="COMMENTFORUMLIST">
        ...
        <ttl>30</ttl>
        <pubDate><xsl:apply-templates select="/H2G2/DATE/LOCAL | /H2G2/DATE" mode="formatted" /></pubDate>
