...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:doc="http://www.bbc.co.uk/dna/documentation"  exclude-result-prefixes="doc">
    ...
    <xsl:template match="USER-COMPLAINT-FORM[/H2G2/PARAMS/PARAM[NAME = 's_start'][VALUE = 1]] | USERCOMPLAINT[/H2G2/PARAMS/PARAM[NAME = 's_start'][VALUE = 1]]" mode="input_user-complaint-form">
        <div class="content">
            ...
            <p>आपने जिस कमेंट के बारे में शिकायत की है उसे हमारी टीम का एक सदस्य पढ़ेगा और तय करेगा कि कमेंट हमारे <a href="http://www.bbc.co.uk/hindi/institutional/2011/09/000001_forum_rules.shtml">हाउस रुल्स</a> तोड़ता है या नहीं. हमारे फ़ैसले की सूचना आपको ई-मेल से दी जाएगी.</p>
            <p class="action">
              <xsl:choose>
        ...
        <form action="UserComplaintPage" method="post" id="complaintForm"> 
            <div class="content">
              ...
              <input type="hidden" name="s_ptrt" value="{/H2G2/PARAMS/PARAM[NAME = 's_ptrt']/VALUE}"/>
            	...
            	<p>आपकी राय में हमारे <a href="http://www.bbc.co.uk/hindi/institutional/2011/09/000001_forum_rules.shtml">हाउस रूल्स</a> में कौन सा रूल तोड़ा गया है. <!-- <xsl:call-template name="item_name"/> --> यदि आपको लगता है कि एक से अधिक रूल तोड़े गए हैं तो कृपया उस चूक को चुनें जो सबसे अधिक गंभीर है.</p>
            </div>
              ...
              <p>
                ...
                <p class="options">
                	<p class="options">
                		...
                		<input type="radio" id="dnaacs-cq-4" value="कानून तोड़ता है या गैर कानूनी गतिविधियों को बढ़ावा देता है या अदालत की अवमानना" name="s_complaintText"/><label for="dnaacs-cq-4">कानून तोड़ता है या गैर कानूनी गतिविधियों को बढ़ावा देता है या <a href="http://www.bbc.co.uk/hindi/institutional/2011/09/000001_terms.shtml">कॉपीराइट</a> या अदालत की अवमानना</label>
                		...
                		<input type="radio" id="dnaacs-cq-7" value="किसी जानेमाने व्यक्ति की राय दिखाने की कोशिश करता है" name="s_complaintText"/><label for="dnaacs-cq-7">किसी जानेमाने व्यक्ति की राय दिखाने की कोशिश करता है</label>
              ...
              <xsl:choose>
                ...
                <xsl:if test="(/H2G2/VIEWING-USER/USER/GROUPS/EDITOR) or (/H2G2/VIEWING-USER/USER/STATUS = 2) or (/H2G2/VIEWING-USER/USER/GROUPS/GROUP[NAME='EDITOR'])">
                    <p>
                        ...
                        <label for="hidePost"> इस कंटेट को <xsl:call-template name="item_name"/> छिपाएँ</label>.
                    </p>
                </xsl:if>
      ...
      <div class="content">
        ...
        <xsl:choose>
          ...
          <xsl:when test="@TYPE = 'InvalidVerificationCode'">
            <p>
              पुष्टि करने का कोड मान्य नहीं है
            </p>
          </xsl:when>
          <xsl:when test="@TYPE = 'AlreadyModerated'">
            <p>
              इस पोस्ट को पहले ही मॉडरेट करके निकाला जा चुका है.
            </p>
          </xsl:when>
          <xsl:when test ="@TYPE = 'COMPLAINTTEXT'">
            <p>
              शिकायत का कोई टेक्स्ट नहीं
            </p>
          </xsl:when>
          ...
          <xsl:when test="@TYPE = 'HIDEPOST'">
            <p>
              इस पोस्ट को छिपाना संभव नहीं है
            </p>
            
          </xsl:when>
          <xsl:when test="@TYPE = 'URL'">
            <p>
             गलत यूआरएल बताया गया 
            </p>
          </xsl:when>
        </xsl:choose>
  ...
  <xsl:template match="USER-COMPLAINT-FORM[MESSAGE/@TYPE = 'SUBMIT-SUCCESSFUL'] | USERCOMPLAINT[@MODID]" mode="input_user-complaint-form">
    <div class="content">
      ...
      <p>
		आपकी शिकायत हमें मिल गई है और हमारी टीम को भेज दी गई है. वे इस बारे में निर्णय करेंगे कि क्या <a href="http://www.bbc.co.uk/hindi/institutional/2011/09/000001_forum_rules.shtml">हाउस रूल्स</a> तोड़े गए हैं और आपको ई-मेल के जरिए सूचित किया जाएगा.
      </p>
      <p>
