...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:doc="http://www.bbc.co.uk/dna/documentation"  exclude-result-prefixes="doc">
    ...
    <xsl:template match="USER-COMPLAINT-FORM[/H2G2/PARAMS/PARAM[NAME = 's_start']/VALUE]" mode="input_user-complaint-form">
        <div class="content">
            ...
            <p>This form is only to be used for serious complaints about specific content that breaks the <a href="{$houserulesurl}">House Rules</a>, such as unlawful, harassing, abusive, threatening, obscene, sexually explicit, racially offensive, or otherwise objectionable material.</p>
            <p>If you have a general comment or question please do not use this form, post a message to the discussion.</p>
            <p>The message you complain about will be sent to a moderator, who will decide whether it breaks the <a href="{$houserulesurl}">House Rules</a>. You will be informed of their decision by email. </p>
            <p class="action">
    ...
    <xsl:template match="USER-COMPLAINT-FORM" mode="input_user-complaint-form">
        <form id="UserComplaintForm" action="{$root}/UserComplaint" method="post"> 
            ...
            <div class="content">
                ...
                <h2>Complain about a message</h2>
                <p>This form is only for serious complaints about specific content that breaks the site's <a href="{$houserulesurl}">House Rules</a>, such as unlawful, harassing, defamatory, abusive, threatening, harmful, obscene, profane, sexually oriented, racially offensive, or otherwise objectionable material.</p>
            ...
            <div class="content">
                ...
                <h3 style="display:none;">I believe this post may break one of the <a href="{$houserulesurl}">House Rules</a> because it:</h3>
                <p class="options">
    ...
    <xsl:template match="USER-COMPLAINT-FORM[MESSAGE/@TYPE = 'SUBMIT-SUCCESSFUL']" mode="input_user-complaint-form">
        <div class="content">
            ...
            <p>Your complaint has successfully been collected and forwarded onto the Moderation team. They will decide whether the <a href="{$houserulesurl}">House Rules</a> have been broken and will update you via your email address.</p>
