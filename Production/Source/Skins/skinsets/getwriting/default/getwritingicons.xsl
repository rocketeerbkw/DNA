...
<xsl:variable name="next.arrow"><img src="{$graphics}icons/next_arrow.gif" width="9" height="8" alt="" border="0" /></xsl:variable>
<xsl:variable name="previous.arrow"><img src="{$graphics}icons/previous_arrow.gif" width="9" height="8" alt="" border="0" /></xsl:variable>

<!-- arrows -->
	<xsl:variable name="arrow.right"><img src="{$graphics}icons/arrow_right.gif" width="9" height="15" alt="" border="0" /></xsl:variable>
	...
	<xsl:variable name="arrow.first"><img src="{$graphics}icons/arrow_first.gif" width="8" height="7" alt="" border="0" /></xsl:variable> 
	<xsl:variable name="arrow.previous"><img src="{$graphics}icons/arrow_previous.gif" width="4" height="7" alt="" border="0" /></xsl:variable>
	<xsl:variable name="arrow.next"><img src="{$graphics}icons/arrow_next.gif" width="4" height="7" alt="" border="0" /></xsl:variable>
	<xsl:variable name="arrow.latest"><img src="{$graphics}icons/arrow_latest.gif" width="8" height="7" alt="" border="0" /></xsl:variable>
