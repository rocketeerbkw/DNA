      ...
      <div>
        ...
        <xsl:call-template name="library_userstate_editor">
            <xsl:with-param name="loggedin">
                <p>As an editor, you can <a href="InspectUser?userid={PAGE-OWNER/USER/USERID}">inspect this user</a>.</p>
            </xsl:with-param>
            <xsl:with-param name="loggedout">
                ...
                <p>
                  You can instead <a href="MP{PAGE-OWNER/USER/USERID}">view a list of this user's posts</a>.
                </p>
            </xsl:with-param>
        </xsl:call-template>
