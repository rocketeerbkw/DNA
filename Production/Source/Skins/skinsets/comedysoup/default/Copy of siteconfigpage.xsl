...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:local="#local-functions" xmlns:s="urn:schemas-microsoft-com:xml-data" xmlns:dt="urn:schemas-microsoft-com:datatypes" exclude-result-prefixes="msxsl local s dt">
	...
	<xsl:variable name="configfields"><![CDATA[<MULTI-INPUT>
						<ELEMENT NAME='BBCTHREE'></ELEMENT>
						<ELEMENT NAME='PROGRAMMECHALLENGESCONFIG'></ELEMENT>
						<ELEMENT NAME='EMBEDEDVIDEOCONFIG'></ELEMENT>
						<ELEMENT NAME='RSSCONFIG'></ELEMENT>
						<ELEMENT NAME='POPULARCHALLENGES'></ELEMENT>
						<ELEMENT NAME='SOUPDEJOUR'></ELEMENT>
						<ELEMENT NAME='OTHERPROGRAMMECHALLENGES'></ELEMENT>
						<ELEMENT NAME='PROGRAMMECHALLENGESPROMO1'></ELEMENT>
						<ELEMENT NAME='PROGRAMMECHALLENGESPROMO2'></ELEMENT>
						<ELEMENT NAME='PROGRAMMECHALLENGESPROMO3'></ELEMENT>
						<ELEMENT NAME='ASSETLIBRARYHELP'></ELEMENT>
						<ELEMENT NAME='POPULARRAWMATERIAL'></ELEMENT>
