...
namespace FunctionalTests.Services.Comments
{
    ...
    public class RatingsComments_V1
    {
        ...
        public void CreateThreadedRatingHtml()
        {
            ...
            // Setup the request url
            string url = String.Format("https://" + _secureserver + "/dna/api/comments/ReviewService.svc/V1/site/{0}/reviewforum/{1}/thread/create.htm?format=XML", _sitename, ratingForum.Id);
            // now get the response
        ...
        public void CreateThreadedRating_JSONReturn()
        {
            ...
            // Setup the request url
            string url = String.Format("https://" + _secureserver + "/dna/api/comments/ReviewService.svc/V1/site/{0}/reviewforum/{1}/thread?format=JSON", _sitename, ratingForum.Id);
            // now get the response
            request.RequestPageWithFullURL(url, ratingForumXml, "text/xml");
        ...
        public void ViewUsersRating()
        {
            ...
            url = String.Format("http://" + _server + "/dna/api/comments/ReviewService.svc/V1/site/{0}/reviewforum/{1}/user/{2}/", _sitename, ratingForum.Id, TestUserAccounts.GetNormalUserAccount.IdentityId);
            ...
            url = String.Format("http://" + _server + "/dna/api/comments/ReviewService.svc/V1/site/{0}/reviewforum/{1}/user/{2}/", _sitename, ratingForum.Id, TestUserAccounts.GetModeratorAccount.IdentityId);
            try
            {
