...
namespace FunctionalTests.Services.Comments.contactFormTests
{
    public class ContactFormUtils
    {
        ...
        public static void AssertResponseContainsGivenErrorTypeDetailAndCode(string response, ErrorType errorType)
        {
            ...
            AssertOutputContains(response, errorCode);
            AssertOutputContains(response, errorDetail);
        }
